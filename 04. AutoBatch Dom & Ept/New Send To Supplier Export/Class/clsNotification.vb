...
Public Class clsNotification
    ...
    Public Shared Function GetNotification(ByVal pNotificationCode As String, Optional ByVal pUrl As String = "", _
                                     ...
                                     Optional ByVal pSuratJalanNo As String = "", Optional ByVal pPORevision As String = "", Optional ByVal pPOMarking As String = "") As String
        ...
        Using sqlConn As New SqlConnection(cfg.ConnectionString)
            ...
            For xyz = 0 To 7
                ...
                If ls_Cls(xyz) <> "05" Then
                    ...
                    '=================================EXPORT========================================='
                    If ls_Cls(xyz) = "10" Then
                        ls_BodyMessage = ls_BodyMessage & vbCrLf
                        If pNotificationCode = "25" Then
                            ls_BodyMessage = ls_BodyMessage & "ForwarderID: " & pPONo & vbCrLf
                        Else
                            ls_BodyMessage = ls_BodyMessage & "INVOICE NO: " & pPONo & vbCrLf
                        End If
                    End If
                End If
            Next
