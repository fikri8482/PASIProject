<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="SummaryForecast.aspx.vb" Inherits="PASISystem.SummaryForecast" %>
                                            ...
                                            <tr>
                                                <td align="left" valign="middle" height="25px" width="120px">
                                                    <dx:ASPxComboBox ID="cboAffiliate" runat="server" 
                                                        ...
                                                        Font-Size="8pt" 
                                                        Font-Names="Verdana" TextFormatString="{0}" DropDownStyle="DropDown">
            ...
            <td colspan="2" align="left" valign="top" height="220">
                <dx:ASPxGridView ID="grid" runat="server" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="4" Caption="AFFILIATE" FieldName="AffiliateID" Width="90px" HeaderStyle-HorizontalAlign="Center">
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="5" Caption="SUPPLIER" FieldName="SupplierID" Width="90px" HeaderStyle-HorizontalAlign="Center">
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="6" Caption="MOQ" FieldName="MOQ" Width="50px" HeaderStyle-HorizontalAlign="Center">
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                            <PropertiesTextEdit DisplayFormatString="{0:n0}">                            
                            </PropertiesTextEdit>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="7" Caption="PROJECT" FieldName="Project" Width="150px" HeaderStyle-HorizontalAlign="Center">
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="8" Caption="PO NO." FieldName="PONo" Width="100px" HeaderStyle-HorizontalAlign="Center">
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewBandColumn Caption="PO" VisibleIndex="9">
                            <Columns>
                                <dx:GridViewDataTextColumn VisibleIndex="5" Caption="WK1" Width="90px"
                        ...
                        <dx:GridViewBandColumn Caption="FC1" VisibleIndex="10">
                            <Columns>
                                <dx:GridViewDataTextColumn VisibleIndex="5" Caption="WK2" Width="90px"
                        ...
                        <dx:GridViewBandColumn Caption="FC2" VisibleIndex="11">
                            <Columns>
                                <dx:GridViewDataTextColumn VisibleIndex="5" Caption="WK3" Width="90px"
                        ...
                        <dx:GridViewBandColumn Caption="FC3" VisibleIndex="12">
                            <Columns>
                                <dx:GridViewDataTextColumn VisibleIndex="5" Caption="WK4" Width="90px"
                    ...
                    <SettingsPager Visible="True" Position="Top" PageSize="200">
