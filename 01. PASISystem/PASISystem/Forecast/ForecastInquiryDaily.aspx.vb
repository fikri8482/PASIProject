            ...
            With ws
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    For i = 0 To ds.Tables(0).Rows.Count - 1
                        ...
                        .Cells("C" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("AffiliateID").ToString())
                        .Cells("D" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("SupplierID").ToString())
                        .Cells("E" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("PartNo").ToString())
                        .Cells("F" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("PartName").ToString())
                        .Cells("G" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("Project").ToString())
                        .Cells("H" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("MPQ"))
                        .Cells("I" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("ForecastQty1"))
                        .Cells("J" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("ForecastQty2"))
                        .Cells("K" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("ForecastQty3"))
                        .Cells("L" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("ForecastQty4"))
                        .Cells("M" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F1"))
                        .Cells("N" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F2"))
                        .Cells("O" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F3"))
                        .Cells("P" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F4"))
                        .Cells("Q" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F5"))
                        .Cells("R" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F6"))
                        .Cells("S" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F7"))
                        .Cells("T" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F8"))
                        .Cells("U" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F9"))
                        .Cells("V" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F10"))
                        .Cells("W" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F11"))
                        .Cells("X" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F12"))
                        .Cells("Y" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F13"))
                        .Cells("Z" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F14"))
                        .Cells("AA" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F15"))
                        .Cells("AB" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F16"))
                        .Cells("AC" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F17"))
                        .Cells("AD" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F18"))
                        .Cells("AE" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F19"))
                        .Cells("AF" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F20"))
                        .Cells("AG" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F21"))
                        .Cells("AH" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F22"))
                        .Cells("AI" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F23"))
                        .Cells("AJ" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F24"))
                        .Cells("AK" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F25"))
                        .Cells("AL" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F26"))
                        .Cells("AM" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F27"))
                        .Cells("AN" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F28"))
                        .Cells("AO" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F29"))
                        .Cells("AP" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F30"))
                        .Cells("AQ" & i + 10).Value = CInt(ds.Tables(0).Rows(i)("F31"))
