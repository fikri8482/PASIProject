<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master"
    CodeBehind="SummaryOutstandingDanDeliveryPasiToAff.aspx.vb" Inherits="PASISystem.SummaryOutstandingDanDeliveryPasiToAff" %>
            ...
            <td colspan="3" align="left" valign="top" height="220">
                ...
                <dx:ASPxGridView ID="grid" runat="server" Width="100%" Font-Names="Tahoma" KeyFieldName="colNo"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="17" Caption="PASI DELIVERY DATE" FieldName="PASIDeliveryDate"
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="18" Caption="PASI SURAT JALAN NO." FieldName="PASISuratJalanNo"
                            Width="100px" HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="20" Caption="PASI INVOICE DATE" FieldName="PASIInvoiceDate"
                            Width="110px" HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
                            <PropertiesTextEdit DisplayFormatString="dd MMM yyyy">
                            </PropertiesTextEdit>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="21" Caption="AFFILIATE RECEIVE DATE" FieldName="AffiliateReceiveDate"
                            Width="110px" HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
                            <PropertiesTextEdit DisplayFormatString="dd MMM yyyy">
                            </PropertiesTextEdit>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="22" Caption="AFFILIATE RECEIVE QTY" FieldName="AffiliateReceiveQty"
                            Width="80px" HeaderStyle-HorizontalAlign="Center">
                            <PropertiesTextEdit DisplayFormatString="{0:n0}">
                            </PropertiesTextEdit>
                            <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="23" Caption="REMAINING" FieldName="Remaining"
                            Width="80px" HeaderStyle-HorizontalAlign="Center">
                            <PropertiesTextEdit DisplayFormatString="{0:n0}">
                            </PropertiesTextEdit>
                            <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="28" Caption="STATUS PO" FieldName="StatusPO"
                            Width="80px" HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
                            <PropertiesTextEdit DisplayFormatString="dd MMM yyyy">
                            </PropertiesTextEdit>
