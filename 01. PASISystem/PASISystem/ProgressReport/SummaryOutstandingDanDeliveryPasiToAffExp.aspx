<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master"
    CodeBehind="SummaryOutstandingDanDeliveryPasiToAffExp.aspx.vb" Inherits="PASISystem.SummaryOutstandingDanDeliveryPasiToAffExp" %>
        ...
        <tr>
            <td colspan="3" align="left" valign="top" height="220">
                ...
                <dx:ASPxGridView ID="grid" runat="server" Width="100%" Font-Names="Tahoma" KeyFieldName="colNo"
                    ...
                    <ClientSideEvents Init="OnInit" CallbackError="function(s, e) {e.handled = true;}" BatchEditEndEditing="OnBatchEditEndEditing"
                        EndCallback="function(s, e) {
                        var pMsg = s.cpMessage;
                        
                        if (pMsg && pMsg !== 'undefined' && pMsg !== '') {
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="17" Caption="SUPPLIER DELIVERY DATE" FieldName="PASIDeliveryDate"
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="18" Caption="SUPPLIER SURAT JALAN NO." FieldName="PASISuratJalanNo"
                            Width="100px" HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
