    ...
    Private Function isExist(ByVal pUserID As String) As String
        ...
        Try
            ...
            Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
                ...
                sqlstring = "SELECT Password FROM dbo.SC_UserSetup WHERE UserID = '" & pUserID & "' and UserCls = '1'"
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            Using sqlTran As SqlTransaction = sqlConn.BeginTransaction("ChangePassword")
                If pIsUpdate = True Then
                    ls_SQL = "UPDATE dbo.SC_UserSetup SET Password='" & clsDESEncryption.EncryptData(txtNewPassword.Text) & "' WHERE UserID='" & Session("UserID") & "' and UserCls = '1'"
                    ls_MsgID = "1002"
                End If
