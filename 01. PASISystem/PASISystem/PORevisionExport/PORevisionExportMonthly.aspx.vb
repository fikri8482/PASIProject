...
Public Class PORevisionExportMonthly
            ...
            If (Not IsPostBack) AndAlso (Not IsCallback) Then
                ...
                Else
                    If pStatus = False Then
                        ...
                        pAffiliateCode = Split(param, "|")(0)
                        pAffiliateName = Split(param, "|")(1)
                        pSupplierCode = Split(param, "|")(2)
                        pSupplierName = Split(param, "|")(3)
                        pDeliveryCode = Split(param, "|")(4)
                        pDeliveryName = Split(param, "|")(5)
                        pCommercial = Split(param, "|")(6)
                        pPOEmergency = Split(param, "|")(7)
                        pShipBy = Split(param, "|")(8)
                        ...
                        pStatus = True
                        Call bindDataHeader(pPeriod, pPOEmergency, pAffiliateCode, pSupplierCode, pDeliveryCode)
                        Call InitializeComponent(pPeriod, pPOEmergency, pAffiliateCode, pSupplierCode, pDeliveryCode)
...
#Region "PROCEDURE"
    ...
    Private Sub bindDataHeader(ByVal pDate As Date, ByVal pPOEmergency As String, ByVal pAffCode As String, ByVal pSupplierID As String, ByVal pDelivery As String)
        Dim ls_SQL As String = ""

        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            sqlConn.Open()

            ls_SQL = " SELECT DISTINCT POM.OrderNo1,POM.OrderNo2,POM.OrderNo3,POM.OrderNo4,POM.OrderNo5 " & vbCrLf & _
                  ...
                  " ,POM.ETAPort1 AS ETAPortOld1,POM.ETAPort2 AS ETAPortOld2,POM.ETAPort3 AS ETAPortOld3,POM.ETAPort4 AS ETAPortOld4,POM.ETAPort5 AS ETAPortOld5 " & vbCrLf & _
            ...
            ls_SQL = ls_SQL + " AND POM.SupplierID = PORM.SupplierID " & vbCrLf & _
                              " WHERE MONTH(POM.Period) = MONTH('" & pDate & "') AND YEAR(POM.Period) = YEAR('" & pDate & "')" & vbCrLf & _
                              " AND POM.EmergencyCls='" & Trim(pPOEmergency) & "' --AND POM.ForwarderID='" & Trim(pDelivery) & "' AND POM.AffiliateID ='" & Trim(pAffCode) & "' AND POM.SupplierID='" & Trim(pSupplierID) & "' "
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                grid.JSProperties("cpETDVendorOld1") = If(IsDBNull(ds.Tables(0).Rows(0)("ETDVendorOld1")), "", Format(ds.Tables(0).Rows(0)("ETDVendorOld1"), "dd-MM-yyyy"))
                grid.JSProperties("cpETDVendorOld2") = If(IsDBNull(ds.Tables(0).Rows(0)("ETDVendorOld2")), "", Format(ds.Tables(0).Rows(0)("ETDVendorOld1"), "dd-MM-yyyy"))
                grid.JSProperties("cpETDVendorOld3") = If(IsDBNull(ds.Tables(0).Rows(0)("ETDVendorOld3")), "", Format(ds.Tables(0).Rows(0)("ETDVendorOld1"), "dd-MM-yyyy"))
                grid.JSProperties("cpETDVendorOld4") = If(IsDBNull(ds.Tables(0).Rows(0)("ETDVendorOld4")), "", Format(ds.Tables(0).Rows(0)("ETDVendorOld1"), "dd-MM-yyyy"))
                grid.JSProperties("cpETDVendorOld5") = If(IsDBNull(ds.Tables(0).Rows(0)("ETDVendorOld5")), "", Format(ds.Tables(0).Rows(0)("ETDVendorOld1"), "dd-MM-yyyy"))

                grid.JSProperties("cpETDVendor1") = If(IsDBNull(ds.Tables(0).Rows(0)("ETDVendor1")), "", Format(ds.Tables(0).Rows(0)("ETDVendor1"), "dd-MM-yyyy"))
                grid.JSProperties("cpETDVendor2") = If(IsDBNull(ds.Tables(0).Rows(0)("ETDVendor2")), "", Format(ds.Tables(0).Rows(0)("ETDVendor2"), "dd-MM-yyyy"))
                grid.JSProperties("cpETDVendor3") = If(IsDBNull(ds.Tables(0).Rows(0)("ETDVendor3")), "", Format(ds.Tables(0).Rows(0)("ETDVendor3"), "dd-MM-yyyy"))
                grid.JSProperties("cpETDVendor4") = If(IsDBNull(ds.Tables(0).Rows(0)("ETDVendor4")), "", Format(ds.Tables(0).Rows(0)("ETDVendor4"), "dd-MM-yyyy"))
                grid.JSProperties("cpETDVendor5") = If(IsDBNull(ds.Tables(0).Rows(0)("ETDVendor5")), "", Format(ds.Tables(0).Rows(0)("ETDVendor5"), "dd-MM-yyyy"))

                grid.JSProperties("cpETDPortOld1") = If(IsDBNull(ds.Tables(0).Rows(0)("ETDPortOld1")), "", Format(ds.Tables(0).Rows(0)("ETDPortOld1"), "dd-MM-yyyy"))
                grid.JSProperties("cpETDPortOld2") = If(IsDBNull(ds.Tables(0).Rows(0)("ETDPortOld2")), "", Format(ds.Tables(0).Rows(0)("ETDPortOld2"), "dd-MM-yyyy"))
                grid.JSProperties("cpETDPortOld3") = If(IsDBNull(ds.Tables(0).Rows(0)("ETDPortOld3")), "", Format(ds.Tables(0).Rows(0)("ETDPortOld3"), "dd-MM-yyyy"))
                grid.JSProperties("cpETDPortOld4") = If(IsDBNull(ds.Tables(0).Rows(0)("ETDPortOld4")), "", Format(ds.Tables(0).Rows(0)("ETDPortOld4"), "dd-MM-yyyy"))
                grid.JSProperties("cpETDPortOld5") = If(IsDBNull(ds.Tables(0).Rows(0)("ETDPortOld5")), "", Format(ds.Tables(0).Rows(0)("ETDPortOld5"), "dd-MM-yyyy"))

                grid.JSProperties("cpETDPort1") = If(IsDBNull(ds.Tables(0).Rows(0)("ETDPort1")), "", Format(ds.Tables(0).Rows(0)("ETDPort1"), "dd-MM-yyyy"))
                grid.JSProperties("cpETDPort2") = If(IsDBNull(ds.Tables(0).Rows(0)("ETDPort2")), "", Format(ds.Tables(0).Rows(0)("ETDPort2"), "dd-MM-yyyy"))
                grid.JSProperties("cpETDPort3") = If(IsDBNull(ds.Tables(0).Rows(0)("ETDPort3")), "", Format(ds.Tables(0).Rows(0)("ETDPort3"), "dd-MM-yyyy"))
                grid.JSProperties("cpETDPort4") = If(IsDBNull(ds.Tables(0).Rows(0)("ETDPort4")), "", Format(ds.Tables(0).Rows(0)("ETDPort4"), "dd-MM-yyyy"))
                grid.JSProperties("cpETDPort5") = If(IsDBNull(ds.Tables(0).Rows(0)("ETDPort5")), "", Format(ds.Tables(0).Rows(0)("ETDPort5"), "dd-MM-yyyy"))

                grid.JSProperties("cpETAPortOld1") = If(IsDBNull(ds.Tables(0).Rows(0)("ETAPortOld1")), "", Format(ds.Tables(0).Rows(0)("ETAPortOld1"), "dd-MM-yyyy"))
                grid.JSProperties("cpETAPortOld2") = If(IsDBNull(ds.Tables(0).Rows(0)("ETAPortOld2")), "", Format(ds.Tables(0).Rows(0)("ETAPortOld2"), "dd-MM-yyyy"))
                grid.JSProperties("cpETAPortOld3") = If(IsDBNull(ds.Tables(0).Rows(0)("ETAPortOld3")), "", Format(ds.Tables(0).Rows(0)("ETAPortOld3"), "dd-MM-yyyy"))
                grid.JSProperties("cpETAPortOld4") = If(IsDBNull(ds.Tables(0).Rows(0)("ETAPortOld4")), "", Format(ds.Tables(0).Rows(0)("ETAPortOld4"), "dd-MM-yyyy"))
                grid.JSProperties("cpETAPortOld5") = If(IsDBNull(ds.Tables(0).Rows(0)("ETAPortOld5")), "", Format(ds.Tables(0).Rows(0)("ETAPortOld5"), "dd-MM-yyyy"))

                grid.JSProperties("cpETAPort1") = If(IsDBNull(ds.Tables(0).Rows(0)("ETAPort1")), "", Format(ds.Tables(0).Rows(0)("ETAPort1"), "dd-MM-yyyy"))
                grid.JSProperties("cpETAPort2") = If(IsDBNull(ds.Tables(0).Rows(0)("ETAPort2")), "", Format(ds.Tables(0).Rows(0)("ETAPort2"), "dd-MM-yyyy"))
                grid.JSProperties("cpETAPort3") = If(IsDBNull(ds.Tables(0).Rows(0)("ETAPort3")), "", Format(ds.Tables(0).Rows(0)("ETAPort3"), "dd-MM-yyyy"))
                grid.JSProperties("cpETAPort4") = If(IsDBNull(ds.Tables(0).Rows(0)("ETAPort4")), "", Format(ds.Tables(0).Rows(0)("ETAPort4"), "dd-MM-yyyy"))
                grid.JSProperties("cpETAPort5") = If(IsDBNull(ds.Tables(0).Rows(0)("ETAPort5")), "", Format(ds.Tables(0).Rows(0)("ETAPort5"), "dd-MM-yyyy"))


                grid.JSProperties("cpETAFactoryOld1") = If(IsDBNull(ds.Tables(0).Rows(0)("ETAFactoryOld1")), "", Format(ds.Tables(0).Rows(0)("ETAFactoryOld1"), "dd-MM-yyyy"))
                grid.JSProperties("cpETAFactoryOld2") = If(IsDBNull(ds.Tables(0).Rows(0)("ETAFactoryOld2")), "", Format(ds.Tables(0).Rows(0)("ETAFactoryOld2"), "dd-MM-yyyy"))
                grid.JSProperties("cpETAFactoryOld3") = If(IsDBNull(ds.Tables(0).Rows(0)("ETAFactoryOld3")), "", Format(ds.Tables(0).Rows(0)("ETAFactoryOld3"), "dd-MM-yyyy"))
                grid.JSProperties("cpETAFactoryOld4") = If(IsDBNull(ds.Tables(0).Rows(0)("ETAFactoryOld4")), "", Format(ds.Tables(0).Rows(0)("ETAFactoryOld4"), "dd-MM-yyyy"))
                grid.JSProperties("cpETAFactoryOld5") = If(IsDBNull(ds.Tables(0).Rows(0)("ETAFactoryOld5")), "", Format(ds.Tables(0).Rows(0)("ETAFactoryOld5"), "dd-MM-yyyy"))

                grid.JSProperties("cpETAFactory1") = If(IsDBNull(ds.Tables(0).Rows(0)("ETAFactory1")), "", Format(ds.Tables(0).Rows(0)("ETAFactory1"), "dd-MM-yyyy"))
                grid.JSProperties("cpETAFactory2") = If(IsDBNull(ds.Tables(0).Rows(0)("ETAFactory2")), "", Format(ds.Tables(0).Rows(0)("ETAFactory2"), "dd-MM-yyyy"))
                grid.JSProperties("cpETAFactory3") = If(IsDBNull(ds.Tables(0).Rows(0)("ETAFactory3")), "", Format(ds.Tables(0).Rows(0)("ETAFactory3"), "dd-MM-yyyy"))
                grid.JSProperties("cpETAFactory4") = If(IsDBNull(ds.Tables(0).Rows(0)("ETAFactory4")), "", Format(ds.Tables(0).Rows(0)("ETAFactory4"), "dd-MM-yyyy"))
                grid.JSProperties("cpETAFactory5") = If(IsDBNull(ds.Tables(0).Rows(0)("ETAFactory5")), "", Format(ds.Tables(0).Rows(0)("ETAFactory5"), "dd-MM-yyyy"))
    ...
    Private Sub InitializeComponent(ByVal pDate As Date, ByVal pPOEmergency As String, ByVal pAffCode As String, ByVal pSupplierID As String, ByVal pDelivery As String)
        Dim ls_SQL As String = ""
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                jsScript = " txtOrderNoWeek1.SetText('" & ds.Tables(0).Rows(0).Item("OrderNo1") & "'); " & vbCrLf & _
                           " txtOrderNoWeek2.SetText('" & ds.Tables(0).Rows(0).Item("OrderNo2") & "'); " & vbCrLf & _
                           " txtOrderNoWeek3.SetText('" & ds.Tables(0).Rows(0).Item("OrderNo3") & "'); " & vbCrLf & _
                           " txtOrderNoWeek4.SetText('" & ds.Tables(0).Rows(0).Item("OrderNo4") & "'); " & vbCrLf & _
                           " txtOrderNoWeek5.SetText('" & ds.Tables(0).Rows(0).Item("OrderNo5") & "'); " & vbCrLf & _
                           " dtWeekETDVendorOld1.SetText('" & ds.Tables(0).Rows(0).Item("ETDVendorOld1") & "'); " & vbCrLf & _
                           " dtWeekETDVendorOld2.SetText('" & ds.Tables(0).Rows(0).Item("ETDVendorOld2") & "'); " & vbCrLf & _
                           " dtWeekETDVendorOld3.SetText('" & ds.Tables(0).Rows(0).Item("ETDVendorOld3") & "'); " & vbCrLf & _
                           " dtWeekETDVendorOld4.SetText('" & ds.Tables(0).Rows(0).Item("ETDVendorOld4") & "'); " & vbCrLf & _
                           " dtWeekETDVendorOld5.SetText('" & ds.Tables(0).Rows(0).Item("ETDVendorOld5") & "'); " & vbCrLf & _
                           " dtWeekETDVendor1.SetText('" & ds.Tables(0).Rows(0).Item("ETDVendor1") & "'); " & vbCrLf & _
                           " dtWeekETDVendor2.SetText('" & ds.Tables(0).Rows(0).Item("ETDVendor2") & "'); " & vbCrLf & _
                           " dtWeekETDVendor3.SetText('" & ds.Tables(0).Rows(0).Item("ETDVendor3") & "'); " & vbCrLf & _
                           " dtWeekETDVendor4.SetText('" & ds.Tables(0).Rows(0).Item("ETDVendor4") & "'); " & vbCrLf & _
                           " dtWeekETDVendor5.SetText('" & ds.Tables(0).Rows(0).Item("ETDVendor5") & "'); " & vbCrLf & _
                           " dtWeekETDPortOld1.SetText('" & ds.Tables(0).Rows(0).Item("ETDPortOld1") & "'); " & vbCrLf & _
                           " dtWeekETDPortOld2.SetText('" & ds.Tables(0).Rows(0).Item("ETDPortOld2") & "'); " & vbCrLf & _
                           " dtWeekETDPortOld3.SetText('" & ds.Tables(0).Rows(0).Item("ETDPortOld3") & "'); " & vbCrLf & _
                           " dtWeekETDPortOld4.SetText('" & ds.Tables(0).Rows(0).Item("ETDPortOld4") & "'); " & vbCrLf & _
                           " dtWeekETDPortOld5.SetText('" & ds.Tables(0).Rows(0).Item("ETDPortOld5") & "'); " & vbCrLf & _
                           " dtWeekETDPort1.SetText('" & ds.Tables(0).Rows(0).Item("ETDPort1") & "'); " & vbCrLf & _
                           " dtWeekETDPort2.SetText('" & ds.Tables(0).Rows(0).Item("ETDPort2") & "'); " & vbCrLf & _
                           " dtWeekETDPort3.SetText('" & ds.Tables(0).Rows(0).Item("ETDPort3") & "'); " & vbCrLf & _
                           " dtWeekETDPort4.SetText('" & ds.Tables(0).Rows(0).Item("ETDPort4") & "'); " & vbCrLf & _
                           " dtWeekETDPort5.SetText('" & ds.Tables(0).Rows(0).Item("ETDPort5") & "'); " & vbCrLf & _
                           " dtWeekETAPortOld1.SetText('" & ds.Tables(0).Rows(0).Item("ETAPortOld1") & "'); " & vbCrLf & _
                           " dtWeekETAPortOld2.SetText('" & ds.Tables(0).Rows(0).Item("ETAPortOld2") & "'); " & vbCrLf & _
                           " dtWeekETAPortOld3.SetText('" & ds.Tables(0).Rows(0).Item("ETAPortOld3") & "'); " & vbCrLf & _
                           " dtWeekETAPortOld4.SetText('" & ds.Tables(0).Rows(0).Item("ETAPortOld4") & "'); " & vbCrLf & _
                           " dtWeekETAPortOld5.SetText('" & ds.Tables(0).Rows(0).Item("ETAPortOld5") & "'); " & vbCrLf & _
                           " dtWeekETAPort1.SetText('" & ds.Tables(0).Rows(0).Item("ETAPort1") & "'); " & vbCrLf & _
                           " dtWeekETAPort2.SetText('" & ds.Tables(0).Rows(0).Item("ETAPort2") & "'); " & vbCrLf & _
                           " dtWeekETAPort3.SetText('" & ds.Tables(0).Rows(0).Item("ETAPort3") & "'); " & vbCrLf & _
                           " dtWeekETAPort4.SetText('" & ds.Tables(0).Rows(0).Item("ETAPort4") & "'); " & vbCrLf & _
                           " dtWeekETAPort5.SetText('" & ds.Tables(0).Rows(0).Item("ETAPort5") & "'); " & vbCrLf & _
                           " dtETAFactWeekOld1.SetText('" & ds.Tables(0).Rows(0).Item("ETAFactoryOld1") & "'); " & vbCrLf & _
                           " dtETAFactWeekOld2.SetText('" & ds.Tables(0).Rows(0).Item("ETAFactoryOld2") & "'); " & vbCrLf & _
                           " dtETAFactWeekOld3.SetText('" & ds.Tables(0).Rows(0).Item("ETAFactoryOld3") & "'); " & vbCrLf & _
                           " dtETAFactWeekOld4.SetText('" & ds.Tables(0).Rows(0).Item("ETAFactoryOld4") & "'); " & vbCrLf & _
                           " dtETAFactWeekOld5.SetText('" & ds.Tables(0).Rows(0).Item("ETAFactoryOld5") & "'); " & vbCrLf & _
                           " dtETAFactWeek1.SetText('" & ds.Tables(0).Rows(0).Item("ETAFactory1") & "'); " & vbCrLf & _
                           " dtETAFactWeek2.SetText('" & ds.Tables(0).Rows(0).Item("ETAFactory2") & "'); " & vbCrLf & _
                           " dtETAFactWeek3.SetText('" & ds.Tables(0).Rows(0).Item("ETAFactory3") & "'); " & vbCrLf & _
                           " dtETAFactWeek4.SetText('" & ds.Tables(0).Rows(0).Item("ETAFactory4") & "'); " & vbCrLf & _
                           " dtETAFactWeek5.SetText('" & ds.Tables(0).Rows(0).Item("ETAFactory5") & "'); " & vbCrLf

                ScriptManager.RegisterStartupScript(txtPOEmergency, txtPOEmergency.GetType(), "scriptKey", jsScript, True)
            End If
        End Using
