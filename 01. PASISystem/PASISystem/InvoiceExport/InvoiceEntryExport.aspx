<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master"
    CodeBehind="InvoiceEntryExport.aspx.vb" Inherits="PASISystem.InvoiceEntryExport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    ...
    <table style="width: 100%;" width="100%">
        ...
        <tr>
            <td align="left">
                <dx:ASPxGridView ID="Grid" runat="server" AutoGenerateColumns="False" KeyFieldName="no"
...
e.handled = true;
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="ORDER NO." FieldName="orderno" Name="pono" VisibleIndex="1"
                            Width="100px">
                        ...
                        <dx:GridViewDataTextColumn Caption="UOM" FieldName="uom" Name="uom"
                            VisibleIndex="4" Width="60px">
                            <HeaderStyle Font-Names="Verdana" Font-Size="8pt" Wrap="True" HorizontalAlign="Center" />
                            <CellStyle Font-Names="Verdana" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="QTY/BOX" FieldName="qtybox" Name="qtybox" VisibleIndex="5"
                            Width="70px">
                            <PropertiesTextEdit DisplayFormatString="{0:n0}">
                                <MaskSettings ErrorText="Please input valid value !" 
                                    IncludeLiterals="DecimalSymbol" Mask="&lt;0..9999999999999g&gt;" />
                            </PropertiesTextEdit>
                            <HeaderStyle Font-Names="Verdana" Font-Size="8pt" Wrap="True" HorizontalAlign="Center" />
                        ...
                        <dx:GridViewDataTextColumn Caption="SUPPLIER DELIVERY QTY" 
                            FieldName="suppdelqty" Name="supplierqty"
                        ...
                        <dx:GridViewDataTextColumn Caption="GOOD RECEIVING QTY" FieldName="goodrecqty" 
                        ...
                        <dx:GridViewDataTextColumn Caption="DIFFERENCE QTY" FieldName="diffqty"
                            Name="diffqty" VisibleIndex="9" Width="100px">
                            <PropertiesTextEdit DisplayFormatString="{0:n0}">
                                <MaskSettings ErrorText="Please input valid value !" Mask="<0..9999999999999g>"
                                    IncludeLiterals="DecimalSymbol" />
                            </PropertiesTextEdit>
                        ...
                        <dx:GridViewDataTextColumn Caption="DELIVERY QTY (BOX)" FieldName="delqty"
                            Name="delqty" VisibleIndex="10" Width="100px">
                            <PropertiesTextEdit DisplayFormatString="{0:n0}">
                                <MaskSettings ErrorText="Please input valid value !" Mask="<0..9999999999999g>"
                                    IncludeLiterals="DecimalSymbol" />
                            </PropertiesTextEdit>
                        ...
                        <dx:GridViewBandColumn Caption="SUPPLIER INVOICE " VisibleIndex="11">
                            <Columns>
	...
	Grid.PerformCallback('gridload');
                            ...
                            <dx1:ASPxButton ID="btnsubmit" runat="server" Width="90px" Font-Names="Tahoma" Font-Size="8pt"
                                Text="SUBMIT" ClientInstanceName="btnsubmit" AutoPostBack="False">
                                <ClientSideEvents Click="function(s, e) {
	Grid.UpdateEdit();
