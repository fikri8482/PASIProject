<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="InvFromSuppListExport.aspx.vb" Inherits="PASISystem.InvFromSuppListExport" %>
...
<ClientSideEvents RowClick="function(s, e) {
                    ...
                    <Columns>
                        <dx:GridViewDataHyperLinkColumn Caption=" " 
                            FieldName="coldetail" VisibleIndex="0" 
                            Width="50px">
                        ...
                        <dx:GridViewDataTextColumn Caption="ORDER NO." FieldName="orderno" 
                        ...
                        <dx:GridViewDataTextColumn Caption="SUPPLIER INVOICE DATE" FieldName="suppinvdate" 
                        ...
                        <dx:GridViewDataTextColumn Caption="FORWARDER RECEIVE DATE" 
                            FieldName="forwarderreceivedate" VisibleIndex="13">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" HorizontalAlign="Center"/>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="SUPPLIER INVOICE NO" FieldName="supinvno" 
                            VisibleIndex="14">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" HorizontalAlign="Center"/>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewBandColumn Caption="SUPPLIER INVOICE" VisibleIndex="24">
                            <Columns>
                                <dx:GridViewDataTextColumn Caption="CURR" FieldName="curr" 
                                    VisibleIndex="1">
                                    <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" HorizontalAlign="Center" />
