<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="InvFromPASIListExport.aspx.vb" Inherits="PASISystem.InvFromPASIListExport" %>
        ...
        <tr>
            <td align="left" class="style1">
                <dx:ASPxGridView ID="grid" runat="server" AutoGenerateColumns="False" 
                    Width="100%" KeyFieldName="sortPONo;KanbanNo;PartNo;SupplierCode" ClientInstanceName="grid">
...
<ClientSideEvents RowClick="function(s, e) {
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="AFFILIATE RECEIVING QTY" FieldName="affrecqty" 
                        ...
                        <dx:GridViewDataTextColumn Caption="AFFILIATE RECEIVE DATE" 
                            FieldName="affrecdate" VisibleIndex="21" 
                            Width="70px">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" Font-Underline="False" 
                                Wrap="True" HorizontalAlign="Center"/>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt" HorizontalAlign="Center">
                        ...
                        <dx:GridViewDataTextColumn Caption="AFFILIATE RECEIVE BY" 
                            FieldName="affrecby" VisibleIndex="22" Width="80px">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" Font-Underline="False" 
                                Wrap="True" HorizontalAlign="Center"/>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        ...
                        <dx:GridViewDataTextColumn Caption="PASI INVOICE NO" 
                            FieldName="pasiinvno" VisibleIndex="23" Width="80px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn 
                            FieldName="affremrecqty" 
                            VisibleIndex="20" Width="70px" Caption="AFFILIATE REMAINING RECEIVING QTY">
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="PASI SURAT JALAN NO" 
                            FieldName="pasisj" VisibleIndex="14">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" HorizontalAlign="Center" />
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        
                        <dx:GridViewDataTextColumn FieldName="sortpono" VisibleIndex="27" Width="0px">
                        </dx:GridViewDataTextColumn>
