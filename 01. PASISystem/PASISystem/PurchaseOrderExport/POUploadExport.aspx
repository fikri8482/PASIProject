<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="POUploadExport.aspx.vb" Inherits="PASISystem.POUploadExport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    <table style="width:100%;">
        ...
        <tr>
            <td colspan="3" align="left" valign="top" height="220">
                <dx:ASPxGridView ID="grid" runat="server" Width="100%"
                    Font-Names="Tahoma" KeyFieldName="NoUrut;PONo"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="2" Caption="AFFILIATE" FieldName="AffiliateID" Width="110px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="2" Caption="SUPPLIER" FieldName="SupplierID" Width="110px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="3" Caption="PO MONTHLY / EMERGENCY" FieldName="EmergencyCls" Width="100px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="4" Caption="SHIP BY BOAT / AIR" FieldName="ShipCls" Width="100px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="5" Caption="ORDER NO." FieldName="PONo" Width="90px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="6" Caption="PERIOD" FieldName="Period" Width="60px">
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="7" Caption="ETD VENDOR" FieldName="ETDVendor1" Width="80px">
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="8" Caption="ETD PORT" FieldName="ETDPort1" Width="80px">
                            <PropertiesTextEdit DisplayFormatString="yyyy-MM-dd">
                            </PropertiesTextEdit>
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="9" Caption="ETA PORT" FieldName="ETAPort1" Width="80px">
                            <PropertiesTextEdit DisplayFormatString="yyyy-MM-dd">
                            </PropertiesTextEdit>
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="10" Caption="ETA FACTORY" FieldName="ETAFactory1" Width="80px">
                            <PropertiesTextEdit DisplayFormatString="yyyy-MM-dd">
                            </PropertiesTextEdit>
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="11" Caption="Remarks" FieldName="ErrorCls" Width="0px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="11" Caption="REMARKS" FieldName="ErrorDesc" Width="300px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
        ...
        <tr>
            ...
            <td valign="top" align="right" style="width: 50px;">
                <dx:ASPxButton ID="btnApprove" runat="server" Text="SAVE" ClientInstanceName="btnApprove"
                    Font-Names="Tahoma" Width="85px" AutoPostBack="False" Font-Size="8pt" >
                </dx:ASPxButton>
            </td>
            <td valign="top" align="right" style="width: 50px;">
                <dx:ASPxButton ID="btnSave" runat="server" Text="TO PO STATUS INQUIRY" ClientInstanceName="btnSave"
                    Font-Names="Tahoma" Width="85px" AutoPostBack="False" Font-Size="8pt" >                    
                </dx:ASPxButton>
            </td>
        </tr>
    ...
    <dx:ASPxPopupControl ID="popUp2" runat="server" CloseAction="CloseButton" Modal="True"
        PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" ClientInstanceName="popUp2" 
        HeaderText="[I01] UPLOAD PO CONFIRMATION" AllowDragging="True" 
        PopupAnimationType="None" EnableViewState="False" Width="600px" 
        HeaderStyle-BackColor="#255FDC" HeaderStyle-ForeColor="White" headerstyle-Font-Names="Verdana" 
        Border-BorderColor="#255FDC" BackColor="#96C8FF">
        <ClientSideEvents Init="function(s, e) {}" />
        <HeaderStyle BackColor="#255FDC" Font-Names="Verdana" ForeColor="White" 
                    HorizontalAlign="Left"></HeaderStyle>
        <ContentCollection>
        <dx:popupcontrolcontentcontrol ID="PopupControlContentControl2" runat="server">
        <dx:aspxpanel ID="Aspxpanel1" runat="server" DefaultButton="btOK" Width="100%">
        <PanelCollection>
        ...
        <table style="width:100%">
            <tr>
                <td align="left" >
                    <dx:aspxlabel ID="ASPxLabel28" runat="server" Text="Order No Already exists, Do you want to continued (replace)?" Font-Names="Verdana" Width="100%" Font-Size="8pt" >
                    </dx:aspxlabel>
                </td>
                <td align="right">
                </td>
            ...
            <tr>
                <td align="right">
                    <dx:aspxbutton ID="BtnCancelPU2" runat="server" Text="REJECT" Font-Names="Tahoma"
                        Width="85px" Font-Size="8pt" TabIndex="2" AutoPostBack="False" 
                        UseSubmitBehavior="False" ClientInstanceName="BtnCancelPU2" >
                          <ClientSideEvents Click="function(s, e) {
                        popUp2.Hide();
                        grid.PerformCallback('kosong');   
                        lblInfo.SetText('[99] Reject Process Upload Successfull');
                        }" />
                    </dx:aspxbutton>
                </td>
                <td align="right">
                 <dx:ASPxButton ID="BtnDeleteUp2" runat="server" Text="ACCEPT" Font-Names="Tahoma"
                    Width="85px" Font-Size="8pt" TabIndex="2" AutoPostBack="False" UseSubmitBehavior="False" ClientInstanceName="BtnDeleteUp2" >
                      <ClientSideEvents Click="function(s, e) {
                      popUp2.Hide();
