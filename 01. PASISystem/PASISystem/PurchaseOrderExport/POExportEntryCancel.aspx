<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="POExportEntryCancel.aspx.vb" Inherits="PASISystem.POExportEntryCancel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td align="right" width="85px">
                <dx:ASPxButton ID="btnApprove" runat="server" Text="SAVE CANCEL PO"
                    Font-Names="Tahoma"
