<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="POExportFinalApproval.aspx.vb" Inherits="PASISystem.POExportFinalApproval" %>
                ...
                <table style="border-width: 1pt thin thin thin; border-style: ridge; border-color:#9598A1; width:100%; height: 70px;">
                    <tr>
                        <td colspan="8" height="20">
                            <table id="Table1">
                                <tr>
                                    <td align="left" valign="middle" height="20px" class="style2">
                                        <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="PERIOD"
                                            Font-Names="Tahoma" Font-Size="8pt">
                                        </dx:ASPxLabel>
                                    </td>
                                    <td align="left" valign="middle" height="20px" Width="140px">
                                        <dx:ASPxTimeEdit ID="dtPeriodFrom" runat="server" ClientInstanceName="dtPeriodFrom" 
                                            ...
                                            EditFormatString="MMM yyyy" Font-Names="Tahoma" Font-Size="8pt" Width="140px">
                                    ...
                                    <td class="style1"></td>
                                    <td align="left" valign="middle" width="130px">
                                        <dx:ASPxLabel ID="ASPxLabel20" runat="server" Text="DELIVERY LOCATION"
                                            Font-Names="Tahoma" Font-Size="8pt">
                                        </dx:ASPxLabel>
                                    </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <table style="width:100%;">
                                                        <tr>
                                                            <td>
                                        <dx:ASPxTextBox ID="txtDelLoc" runat="server" Width="100px" 
                                            ...
                                            <readonlystyle backcolor="#CCCCCC">
                                                            ...
                                                            <td>
                                        <dx:ASPxTextBox ID="txtDelLocName" runat="server" Width="190px" 
                                            ClientInstanceName="txtDelLocName" Font-Names="Tahoma" Font-Size="8pt"
                                            MaxLength="25" onkeypress="return singlequote(event)" Height="20px" ReadOnly="True">
                                            <readonlystyle backcolor="#CCCCCC">
                                            </readonlystyle>
                                        </dx:ASPxTextBox>
                                ...
                                <tr>
                                    ...
                                    <td align="left" valign="middle" class="style3">
                                        <dx:ASPxLabel ID="ASPxLabel7" runat="server" Text="PO EMERGENCY"
                                            Font-Names="Tahoma" Font-Size="8pt">
                                        </dx:ASPxLabel>
                                    </td>
                                    <td align="left" valign="middle" height="20px" width="180px">
                                        <dx:ASPxTextBox ID="txtPOEmergency" runat="server" Width="180px" 
                                ...
                                <tr>
                                    <td align="left" valign="middle" height="20px" width="140px">
                                        <dx:ASPxLabel ID="ASPxLabel9" runat="server" Text="SUPPLIER CODE/NAME"
                                            Font-Names="Tahoma" Font-Size="8pt">
                                        </dx:ASPxLabel>
                                    </td>
                                    <td align="left" valign="middle" height="20px" class="style4">
                                        <table style="width:100%;">
                                            <tr>
                                                <td>
                                        <dx:ASPxTextBox ID="txtSupplierCode" runat="server" Width="110px" 
                                            ClientInstanceName="txtSupplierCode" Font-Names="Tahoma" Font-Size="8pt"
                                            MaxLength="25" onkeypress="return singlequote(event)" Height="20px" ReadOnly="True">
                                            <readonlystyle backcolor="#CCCCCC">
                                            </readonlystyle>
                                        </dx:ASPxTextBox>
                                                ...
                                                <td>
                                        <dx:ASPxTextBox ID="txtSupplierName" runat="server" Width="200px" 
                                    ...
                                    <td align="left" valign="middle" height="20px" width="180px" rowspan ="3">
                                        <table>
                                            <tr>
                                                <td>
                                        <dx:ASPxMemo ID="txtRemarks" ClientInstanceName="txtRemarks" 
                                            Font-Names="Tahoma" Font-Size="8" MaxLength="200" runat="server" Height="60px" 
                                ...
                                <tr>
                                    <td align="left" valign="middle" height="20px" width="140px">
                                        <dx:ASPxLabel ID="ASPxLabel21" runat="server" Text="AFFILIATE CODE/NAME"
                                            Font-Names="Tahoma" Font-Size="8pt">
                                        </dx:ASPxLabel>
                                    </td>
                                    <td align="left" valign="middle" height="20px" class="style4">
                                        <table style="width:100%;">
                                            <tr>
                                                <td>
                                        <dx:ASPxTextBox ID="txtAffiliateCode" runat="server" Width="110px" 
                                            ClientInstanceName="txtAffiliateCode" Font-Names="Tahoma" Font-Size="8pt"
                                            MaxLength="25" onkeypress="return singlequote(event)" Height="20px" ReadOnly="True">
                                            <readonlystyle backcolor="#CCCCCC">
                                            </readonlystyle>
                                        </dx:ASPxTextBox>
                                                ...
                                                <td>
                                        <dx:ASPxTextBox ID="txtAffiliateName" runat="server" Width="200px" 
                                            ClientInstanceName="txtAffiliateName" Font-Names="Tahoma" Font-Size="8pt"
                                            MaxLength="25" onkeypress="return singlequote(event)" Height="20px" ReadOnly="True">
                                            <readonlystyle backcolor="#CCCCCC">
                                            </readonlystyle>
                                        </dx:ASPxTextBox>
                                ...
                                <tr>
                                    ...
                                    <td align="left" valign="middle" height="20px" class="style4">
                                        <table style="width:100%;">
                                            <tr>
                                                <td>
                                        <dx:ASPxTextBox ID="txtCommercial" runat="server" Width="110px" 
                                            ...
                                            <readonlystyle backcolor="#CCCCCC">
                                                ...
                                                <td>
                                        <dx:ASPxLabel ID="ASPxLabel19" runat="server" Text="SHIP BY"
                                            Font-Names="Tahoma" Font-Size="8pt">
                                        </dx:ASPxLabel>
                                                </td>
                                                <td>
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="4" Caption="UOM" FieldName="UnitDesc" 
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="7" Caption=" " 
                            FieldName="AffiliateName" Width="80px" HeaderStyle-HorizontalAlign="Center">
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="13" Caption="TOTAL FIRM QTY" 
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="14" Caption="FORECAST N" 
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="22" Caption="CURR" 
                            FieldName="CurrDesc" Width="45px" HeaderStyle-HorizontalAlign="Center" 
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="15" Caption="VARIANCE" 
                            FieldName="Price" Width="80px" HeaderStyle-HorizontalAlign="Center">
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="16" Caption="VARIANCE (%)" 
                            FieldName="Amount" Width="110px" HeaderStyle-HorizontalAlign="Center">
                            <PropertiesTextEdit DisplayFormatString="{0:n2}">
                            </PropertiesTextEdit>
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="17" Caption="FORECAST N+1" 
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="18" Caption="FORECAST N+2" 
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="19" Caption="FORECAST N+3" 
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        ...
                        <dx:GridViewBandColumn Caption="E.T.A SCHEDULE (BASED ON FIRM ORDER)" 
                            VisibleIndex="25" HeaderStyle-HorizontalAlign="Center" Visible="False">
                            <Columns>
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="8" Caption="WEEK 1 FIRM QTY" 
                            HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Center">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="9" Caption="WEEK 2 FIRM QTY" 
                            HeaderStyle-HorizontalAlign="Center">
                        </dx:GridViewDataTextColumn>

                        <dx:GridViewDataTextColumn Caption="WEEK 3 FIRM QTY" VisibleIndex="10">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="WEEK 4 FIRM QTY" VisibleIndex="11">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="WEEK 5 FIRM QTY" VisibleIndex="12">
                        </dx:GridViewDataTextColumn>
                    </Columns>
