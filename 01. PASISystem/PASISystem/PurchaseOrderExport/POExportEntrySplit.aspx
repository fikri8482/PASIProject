<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="POExportEntrySplit.aspx.vb" Inherits="PASISystem.POExportEntrySplit" %>
    ...
    <script type="text/javascript">
        ...
        function OnBatchEditStartEditing(s, e) {
            ...
            if (currentColumnName == "NoUrut" || currentColumnName == "PartNo" || currentColumnName == "PartName" || currentColumnName == "UnitCls"
                || currentColumnName == "MOQ" || currentColumnName == "PONo" || currentColumnName == "QtyBox" || currentColumnName == "SplitReffQty"
            ...
            <td colspan="16" align="left" valign="top" height="220">
                ...
                <dx:ASPxGridView ID="grid" runat="server" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="9" Caption="SPLIT QTY *" 
                        ...
                        <dx:GridViewDataTextColumn Caption="ORIGINAL QTY" FieldName="SplitReffQty" 
                            VisibleIndex="8" Width="75px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <PropertiesTextEdit DisplayFormatString="{0:n0}" MaxLength="18">
                            </PropertiesTextEdit>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="ORIGINAL PO" FieldName="SplitReffPONo" 
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td align="right" width="85px">
                <dx:ASPxButton ID="btnApprove" runat="server" Text="SAVE SPLIT PO"
                    Font-Names="Tahoma"
