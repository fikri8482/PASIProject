<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="POExportList.aspx.vb" Inherits="PASISystem.POExportList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
            ...
            View="GroupBox" Width="100%" Height="50px">
            ...
            <td align="left" class="style6" colspan="5">
                ...
                <dx:ASPxGridView ID="grid" runat="server" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewBandColumn Caption="PO STATUS" VisibleIndex="12">
                            <Columns>                       
                       ...
                       <dx:GridViewDataHyperLinkColumn Caption="8" FieldName="GOTOPOStatus8" Name="GOTOPOStatus8"
                        ...
                        <dx:GridViewDataTextColumn Caption="SPLIT ORDER NO." FieldName="OrderNo" 
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td align="right">
                ...
                runat="server" Text="SEND PO TO SUPPLIER"
