<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="PackingListCreate.aspx.vb" Inherits="PASISystem.PackingListCreate" %>
        ...
        <tr>
            <td align="left" class="style1" colspan="2">
                <dx:ASPxGridView ID="grid" runat="server" AutoGenerateColumns="False" 
                    Width="100%" KeyFieldName="colpono;colsuppliercode;colpartno;H_KANBANORDER;H_POORDER;H_AFFILIATEORDER;HSupSJ;HPasiSJ;coldeliveryqty" ClientInstanceName="grid">
	...
	e.handled = true;
                    ...
                    <Columns>   
                        ...
                        <dx:GridViewDataTextColumn Caption="DELIVERY LOCATION CODE" 
                            FieldName="coldeliverylocationcode" Name="coldeliverylocationcode" VisibleIndex="7" 
                            Width="0px">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" Font-Underline="False" 
                                Wrap="True" HorizontalAlign="Center"/>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                        ...
                        <dx:GridViewDataTextColumn Caption="DELIVERY LOCATION NAME" 
                            FieldName="coldeliverylocationname" Name="coldeliverylocationname" VisibleIndex="8" 
                            Width="0px">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" Font-Underline="False" 
                                Wrap="True" HorizontalAlign="Center"/>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                        ...
                        <dx:GridViewDataTextColumn Caption="SUPPLIER CODE" FieldName="colsuppliercode" 
                            Name="colsuppliercode" VisibleIndex="11" Width="70px">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" Font-Underline="False" 
                                Wrap="True" HorizontalAlign="Center"/>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        ...
                        <dx:GridViewDataTextColumn Caption="SUPPLIER NAME" FieldName="colsuppliername" 
                            Name="colsuppliername" VisibleIndex="10" Width="0px">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" Font-Underline="False" 
                                Wrap="True" HorizontalAlign="Center"/>
                        ...
                        <dx:GridViewDataTextColumn Caption="KANBAN NO." FieldName="colkanbanno" 
                            Name="colkanbanno" VisibleIndex="13" Width="80px">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" Font-Underline="False" 
                                Wrap="True" HorizontalAlign="Center"/>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt" HorizontalAlign="Center">
                            </CellStyle>
                        ...
                        <dx:GridViewDataTextColumn Caption="SUPPLIER PLAN DELIVERY DATE" 
                            FieldName="colplandeldate" Name="colplandeldate" VisibleIndex="14" 
                            Width="0px">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" Font-Underline="False" 
                                Wrap="True" HorizontalAlign="Center"/>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt" HorizontalAlign="Center">
                        ...
                        <dx:GridViewDataTextColumn Caption="SUPPLIER DELIVERY DATE" 
                            FieldName="coldeldate" Name="coldeldate" VisibleIndex="15" Width="0px">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" Font-Underline="False" 
                                Wrap="True" HorizontalAlign="Center"/>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        ...
                        <dx:GridViewDataTextColumn Caption="SUPPLIER SURAT JALAN NO." FieldName="colsj" 
                            Name="colsj" VisibleIndex="16" Width="0px">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" Font-Underline="False" 
                                Wrap="True" HorizontalAlign="Center"/>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        ...
                        <dx:GridViewDataTextColumn Caption="PASI SURAT JALAN NO." FieldName="colpasisj" 
                            Name="colpasisj" VisibleIndex="18" Width="100px">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" Font-Underline="False" 
                                Wrap="True" HorizontalAlign="Center"/>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        ...
                        <dx:GridViewDataTextColumn Caption="PASI REMAINING RECEIVE QTY" 
                            FieldName="colremaining" Name="colremaining" VisibleIndex="25" 
                            Width="0px">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" Font-Underline="False" 
                                Wrap="True" HorizontalAlign="Center"/>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt" HorizontalAlign="Right">
                        ...
                        <dx:GridViewDataTextColumn Caption="PASI DELIVERY QTY" FieldName="colpasideliveryqty" 
                            Name="colpasideliveryqty" VisibleIndex="26" Width="80px">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" Font-Underline="False" 
                                Wrap="True" HorizontalAlign="Center"/>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt" HorizontalAlign="Right">
                            </CellStyle>
                        ...
                        <dx:GridViewDataTextColumn Caption="DELIVERY BY" FieldName="coldeliveryby" 
                            Name="coldeliveryby" VisibleIndex="28" Width="100px">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" Font-Underline="False" 
                                Wrap="True" HorizontalAlign="Center"/>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>   
                        <dx:GridViewDataTextColumn Caption="SURAT JALAN SUPPLIER" FieldName="HSupSJ" 
                            Name="HSupSJ" VisibleIndex="29" Width="100px">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" Font-Underline="False" 
                                Wrap="True" HorizontalAlign="Center"/>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
