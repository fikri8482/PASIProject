        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            Using sqlTran As New TransactionScope
                ...
                For iRow = 0 To e.UpdateValues.Count - 1
                    ...
                    If (CDbl(e.UpdateValues(iRow).NewValues("colremainingdelqty").ToString())) < CDbl(0) Then
                        Session("MsgDelivery") = "QTY MINUS"
                        Exit Sub
                    End If
                    'cek QTY tidak boleh Minus
        ...
        Select Case pAction
            ...
            Case "gridload"
                ...
                Else
                    ...
                    ElseIf Session("MsgDelivery") = "QTY MINUS" Then
                        Call clsMsg.DisplayMessage(lblerrmessage, "6015", clsMessage.MsgType.ErrorMessage)
                        Grid.JSProperties("cpMessage") = lblerrmessage.Text
