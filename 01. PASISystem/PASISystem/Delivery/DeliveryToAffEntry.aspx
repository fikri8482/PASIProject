<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="DeliveryToAffEntry.aspx.vb" Inherits="PASISystem.DeliveryToAffEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    <script language="javascript" type="text/javascript">
		...
		function OnBatchEditEndEditing(s, e) {
            window.setTimeout(function () {
                var colpasigoodrec = s.batchEditApi.GetCellValue(e.visibleIndex, "colpasigoodrec");
                var colpasideliveryqty = s.batchEditApi.GetCellValue(e.visibleIndex, "colpasideliveryqty");

                if (colpasigoodrec > colpasideliveryqty) {
                    alert("Qty PASI DELIVERY Can't bigger than PASI GOOG RECEIVING Qty !");
                    return;
                } 
    ...
    <table style="width: 100%;" width="100%">
        ...
        <tr>
            <td align="left">
                <dx:ASPxGridView ID="Grid" runat="server" AutoGenerateColumns="False" KeyFieldName="colno;colpono;colpartno;colkanbanno;suppsj"
...
<MaskSettings ErrorText="Please input valid value !" Mask="<0..9999999999999g>.<00..99>"
                        ...
                        <dx:GridViewDataTextColumn FieldName="suppsj" Name="suppsj"
                            VisibleIndex="18" Width="0px" Caption="SupSJ">
                        </dx:GridViewDataTextColumn>                        
                        <dx:GridViewDataTextColumn FieldName="SupplierID" Name="SupplierID" 
                            VisibleIndex="19" Width="0px">
                        </dx:GridViewDataTextColumn>
						
<dx:GridViewDataTextColumn FieldName="Price" Name="PriceDO" 
