<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="AffiliateOrderExportDetail.aspx.vb" Inherits="PASISystem.AffiliateOrderExportDetail" %>
                                ...
                                <tr>
                                    ...
                                    <td width="150px" bgcolor="#FFD2A6">
                                        <dx:ASPxLabel runat="server" Text="WEEK 1" Font-Names="Tahoma" 
                                            Font-Size="8pt" ID="ASPxLabel24"></dx:ASPxLabel>
                                    </td>
                                    <td width="150px" bgcolor="#FFD2A6">
                                ...
                                <tr>
                                    <td align="left" bgcolor="#FFFFE1">
                                        <dx:ASPxLabel runat="server" Text="ORDER NO" Font-Names="Tahoma" 
                                            Font-Size="8pt" ID="ASPxLabel22"></dx:ASPxLabel>
                                    </td>
                                ...
                                <tr>
                                    <td align="left" width="150px" bgcolor="#FFFFE1">
                                        <dx:ASPxLabel runat="server" Text="ETD VENDOR" Font-Names="Tahoma" 
                                            Font-Size="8pt" ID="ASPxLabel23"></dx:ASPxLabel>
            ...
            <td colspan="8" align="left" valign="top" height="220">
                ...
                <dx:ASPxGridView ID="grid" runat="server" Width="100%" Font-Names="Tahoma" KeyFieldName="Sort;PartNo"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewBandColumn Caption="AFFILIATE PRICE" VisibleIndex="14">
                            <Columns>
                                <dx:GridViewDataTextColumn Caption="CURR" FieldName="CurrAff" VisibleIndex="1" Width="0px">
                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="PRICE" FieldName="PriceAff" VisibleIndex="2"
                                    Width="0px">
                                ...
                                <dx:GridViewDataTextColumn Caption="AMOUNT" FieldName="AmountAff" VisibleIndex="3"
                                    Width="0px">
                                    <PropertiesTextEdit DisplayFormatString="{0:n2}">
                                        <MaskSettings Mask="<0..9999999999999g>.<00..99>" IncludeLiterals="DecimalSymbol" />
                                    </PropertiesTextEdit>
                                ...
                                <dx:GridViewDataTextColumn FieldName="CurrCodeAff" VisibleIndex="0" Width="0px">
                                </dx:GridViewDataTextColumn>
                            </Columns>
                            <HeaderStyle HorizontalAlign="Center" />
                        </dx:GridViewBandColumn>
                        <dx:GridViewBandColumn Caption="SUPPLIER PRICE" VisibleIndex="15">
                            <Columns>
                                <dx:GridViewDataTextColumn Caption="CURR" FieldName="CurrSupp" VisibleIndex="1" Width="0px">
                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="PRICE" FieldName="PriceSupp" VisibleIndex="2"
                                    Width="0px">
                                    <PropertiesTextEdit DisplayFormatString="{0:n2}">
                                        <MaskSettings Mask="<0..9999999999999g>.<00..99>" IncludeLiterals="DecimalSymbol" />
                                    </PropertiesTextEdit>
                                ...
                                <dx:GridViewDataTextColumn Caption="AMOUNT" FieldName="AmountSupp" VisibleIndex="3"
                                    Width="0px">
                                    <PropertiesTextEdit DisplayFormatString="{0:n2}">
                                        <MaskSettings Mask="<0..9999999999999g>.<00..99>" IncludeLiterals="DecimalSymbol" />
                                    </PropertiesTextEdit>
                                ...
                                <dx:GridViewDataTextColumn FieldName="CurrCodeSupp" VisibleIndex="0" Width="0px">
                                </dx:GridViewDataTextColumn>
                            </Columns>
                            <HeaderStyle HorizontalAlign="Center" />
                        </dx:GridViewBandColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="pengali" FieldName="pengali" VisibleIndex="21"
                            Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Flag" FieldName="Flag" VisibleIndex="8" Width="0px">
                        </dx:GridViewDataTextColumn>
                    </Columns>
            ...
            <td valign="top" align="right" style="width: 50px;">
                <dx:ASPxButton ID="btnSubmit" runat="server" Text="SAVE" Font-Names="Tahoma" Width="90px" ClientInstanceName="btnSubmit"
                    ...
                    <ClientSideEvents Click="function(s, e) {
                        ...
                        var pShipBy = txtShipBy.GetText();
                        lblInfo.SetText('');
                        grid.PerformCallback('save' + '|' + pDate + '|' + pAffCode + '|' + pPONo + '|' + pSuppCode + '|' + pComm + '|' + pDelBy + '|' + pKanban + '|' + pShipBy);
                    }" />
                </dx:ASPxButton>
            </td>
        </tr>
