<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="AffiliateOrderExportList.aspx.vb" Inherits="PASISystem.AffiliateOrderExportList" %>
                ...
                <dx:aspxgridview id="grid" runat="server" width="100%" font-names="Tahoma" keyfieldname="NoUrut;AffiliateID;POMarking"
                    ...
                    <Columns>
                        <dx:GridViewDataTextColumn VisibleIndex="0" Caption=" " Width="60px" FieldName="DetailPage">
                            <DataItemTemplate>
                                <a id="clickElement" href="AffiliateOrderExportDetail.aspx?id=<%#GetRowValue(Container)%>&t1=<%#GetPeriod(Container)%>&t2=<%#GetAffiliateID(Container)%>&t3=<%#GetAffiliateName(Container)%>&t4=<%#GetPO(Container)%>&t5=<%#GetDeliveryBy(Container)%>&t6=<%#GetKanban(Container)%>&Session=~/AffiliateOrderExport/AffiliateOrderExportList.aspx">
                                    <%# "DETAIL"%></a>
                            </DataItemTemplate>
                        ...
                        <dx:GridViewBandColumn Caption="AFFILIATE PRICE" VisibleIndex="11">
                            <Columns>
                                <dx:GridViewDataTextColumn Caption="CURR" FieldName="CurrAff" VisibleIndex="0" 
                                    Width="0px">
                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="AMOUNT" FieldName="AmountAff" VisibleIndex="1"
                                    Width="0px">
...
<MaskSettings ErrorText="Please input valid value !" Mask="<0..9999999999999g>.<00..99>"
                        ...
                        <dx:GridViewBandColumn Caption="SUPPLIER PRICE" VisibleIndex="12">
                            <Columns>
                                <dx:GridViewDataTextColumn Caption="AMOUNT" FieldName="AmountSupp" VisibleIndex="1"
                                    Width="0px">
                                    <PropertiesTextEdit DisplayFormatString="{0:n2}">
...
<MaskSettings ErrorText="Please input valid value !" Mask="<0..9999999999999g>.<00..99>"
                                ...
                                <dx:GridViewDataTextColumn Caption="CURR" FieldName="CurrSupp" VisibleIndex="0" 
                                    Width="0px">
                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                </dx:GridViewDataTextColumn>
                            </Columns>
