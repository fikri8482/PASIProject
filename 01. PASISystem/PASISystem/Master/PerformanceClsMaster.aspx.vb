...
Public Class PerformanceClsMaster
#Region "DECLARATION"
...
#Region "FORM EVENTS"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If (Not IsPostBack) AndAlso (Not IsCallback) Then
            Session("MenuDesc") = "PERFORMANCE CLS MASTER"
            Call bindData()
    ...
    Private Sub grid_CellEditorInitialize(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridView.ASPxGridViewEditorEventArgs) Handles grid.CellEditorInitialize
        If (e.Column.FieldName = "NoUrut" Or e.Column.FieldName = "PerformanceCls" Or e.Column.FieldName = "Description") _
    ...
    Private Sub grid_CustomCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridView.ASPxGridViewCustomCallbackEventArgs) Handles grid.CustomCallback
        Try
            ...
            Select Case pAction
                Case "save"
                    Dim pPerformanceClsCode As String = Split(e.Parameters, "|")(2)
                    Dim lb_IsUpdate As Boolean = ValidasiInput(pPerformanceClsCode)
                    Call SaveData(lb_IsUpdate, _
                                     Split(e.Parameters, "|")(2), _
                                     Split(e.Parameters, "|")(3))

                Case "delete"
                    Dim pPerformanceClsCode As String = Split(e.Parameters, "|")(1)

                    'If AlreadyUsed(pPerformanceClsCode) = False Then
                    'pSupplierID,
                    Call DeleteData(pPerformanceClsCode)
                    Call bindData()
                    'End If
                    'txtMode.Text = "new"
                Case "load"
...
#Region "PROCEDURE"
    Private Sub bindData()
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            ls_SQL = " select " & vbCrLf & _
                  " 	row_number() over (order by PerformanceCls) NoUrut, " & vbCrLf & _
                  " 	RTRIM(PerformanceCls)PerformanceCls, " & vbCrLf & _
                  " 	RTRIM(Description)Description " & vbCrLf & _
                  " from MS_PerformanceCls " & vbCrLf
    ...
    Private Sub up_GridLoadWhenEventChange()
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            ls_SQL = " select top 0  '' NoUrut, '' PerformanceCls, '' Description"
    ...
    Private Function AlreadyUsed(ByVal pPerformanceClsCode As String) As Boolean
        Try
            Dim ls_SQL As String = ""
            ...
            Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
                ...
                ls_SQL = " SELECT PerformanceCls FROM MS_PerformanceCls WHERE PerformanceCls= '" & Trim(pPerformanceClsCode) & "'"
    ...
    Private Sub DeleteData(ByVal pPerformanceClsCode As String)
        ...
        Try
            ...
            Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
                ...
                Using sqlTran As SqlTransaction = sqlConn.BeginTransaction("PerformanceCls")
                    ls_SQL = " DELETE MS_PerformanceCls " & vbCrLf & _
                                " WHERE PerformanceCls='" & pPerformanceClsCode & "' " & vbCrLf
    ...
    Private Sub SaveData(ByVal pIsNewData As Boolean, _
                         Optional ByVal pPerformanceClsCode As String = "", _
                         Optional ByVal pPerformanceClsName As String = "")
        ...
        Try
            Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
                ...
                ls_SQL = " SELECT PerformanceCls FROM MS_PerformanceCls WHERE PerformanceCls='" & pPerformanceClsCode & "' "
                Dim sqlDA As New SqlDataAdapter(ls_SQL, sqlConn)
                Dim ds As New DataSet
                sqlDA.Fill(ds)
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            Using sqlTran As SqlTransaction = sqlConn.BeginTransaction("PerformanceCls")
                ...
                If pIsNewData = True Then
                    '#INSERT NEW DATA
                    ls_SQL = " INSERT INTO MS_PerformanceCls " & _
                                "(PerformanceCls, Description)" & _
                                " VALUES ('" & txtPerformanceCls.Text & "','" & txtPerformanceCls2.Text & "')" & vbCrLf
                    ls_MsgID = "1001"
                ...
                ElseIf pIsNewData = False Then
                    '#UPDATE DATA
                    'and SupplierID = '" & pSupplierID & "'
                    ls_SQL = "UPDATE MS_PerformanceCls SET " & _
                            "Description='" & txtPerformanceCls2.Text & "' " & vbCrLf & _
                    " WHERE PerformanceCls='" & pPerformanceClsCode & "'" & vbCrLf
                    ls_MsgID = "1002"
