<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="PASIEmailMaster.aspx.vb" Inherits="PASISystem.PASIEmailMaster" %>
...
//        alert(value);
//        var TextBox = document.getElementById(txtEmailToKanban);
//        if (value == 'DOMESTIC') {
...
//        cbSetData.PerformCallback(value);
//    }
...
//    }
    ...
    function up_Insert() {
        ...
        var pPODel = '';
        AffiliateSubmit.PerformCallback('save|' + pIsUpdate + '|' + pAffiliatePOTO + '|' + pAffiliatePOCC + '|' + pAffiliatePORevisionTO + '|' + pAffiliatePORevisionCC + '|' + pKanbanTO + '|' + pKanbanCC + '|' + pSupplierDeliveryTO + '|' + pSupplierDeliveryCC + '|' + pPASIReceivingTO + '|' + pPASIReceivingCC + '|' + pAffiliateReceivingTO + '|' + pAffiliateReceivingCC + '|' + pGoodReceiveTO + '|' + pGoodReceiveCC + '|' + pInvoiceTO + '|' + pInvoiceCC + '|' + pSummaryOutstandingTO + '|' + pSummaryOutstandingCC);
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    ...
    <table style="border-width: 1pt thin thin thin; border-style: ridge; border-color:#9598A1; width:100%; height: 460px;">
        <tr>
            <td>
...
if (cbotype.GetValue() == 'DOMESTIC')
		{ txtEmailToKanban.SetEnabled(true);
		 ...
		 txtEmailCCPASIReceiving.SetEnabled(false);
	                                ...
	                                cbSetData.PerformCallback(cbotype.GetText);
                    ...
                    <tr>
                        ...
                        <td align="left" class="style1" valign="top">
                            ...
                            ClientInstanceName="txtEmailToAffiliatePO" Font-Names="Tahoma" TabIndex="1">
                            </dx:ASPxMemo>
                        </td>
                        <td align="right" valign="top">
        ...
        <tr>                        
            <td valign="top" align="left">
                <dx:ASPxButton ID="btnSubMenu" runat="server" Text="SUB MENU"                     
                    Font-Names="Tahoma"
                    Width="90px" Font-Size="8pt" ClientInstanceName="btnSubMenu" TabIndex="21">
                </dx:ASPxButton>   
                </td>                     
            ...
            <td align="right" style="width:80px;">                                   
                <dx:ASPxButton ID="btnClear" runat="server" Text="CLEAR"                    
                    ...
                    ClientInstanceName="btnClear" TabIndex="20">
        ...
        txtEmailCCSummaryOutstanding.SetText('');
            ...
            <td valign="top" align="right" style="width: 50px;">                                   
                <dx:ASPxButton ID="btnSubmit" runat="server" Text="SAVE"                    
                    Font-Names="Tahoma"
                    Width="90px" AutoPostBack="False" Font-Size="8pt" 
                    ClientInstanceName="btnSubmit" TabIndex="19">
                    <ClientSideEvents Click="function(s, e) {
                        up_Insert();
                    }" />
                </dx:ASPxButton>
