...
#Region "PROCEDURE"
    Private Sub bindData()
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            ls_SQL = " select " & vbCrLf &
                  " 	row_number() over (order by AffiliateID) as NoUrut, " & vbCrLf &
                  " 	RTRIM(AffiliateID) AffiliateID, " & vbCrLf &
                  " 	TRIM(AffiliateCode) AffiliateCode, " & vbCrLf &
    ...
    Private Sub up_GridLoadWhenEventChange()
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            ls_SQL = " select top 0  '' NoUrut, '' as AffiliateID, ''AffiliateCode, ''ConsigneeCode, ''BuyerCode, ''ConsigneeName, ''BuyerName, '' ConsigneeAddress, ''BuyerAddress, '' AffiliateName, ''Address, ''City, '' PostalCode, ''Phone1, '' Phone2, ''Fax, ''NPWP, ''KantorPabean,''IzinTPB,''BCPerson,''PODeliveryBy, ''DetailPage, '' FolderOES "
    ...
    Private Sub epplusExportExcel(ByVal pFilename As String, ByVal pSheetName As String,
        ...
        Try
            ...
            With ws
                ...
                Dim rgAll As ExcelRange = .Cells(2, 1, irow + 2, 23)
