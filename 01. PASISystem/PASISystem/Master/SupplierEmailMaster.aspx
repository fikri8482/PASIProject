<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="SupplierEmailMaster.aspx.vb" Inherits="PASISystem.SupplierEmailMaster" %>
...
<script language="javascript" type="text/javascript">
    ...
    function clear() {
        ...
        txtSupplierCode.GetInputElement().setAttribute('style', 'background:#FFFFFF;foreground:#FFFFFF;');
...
//    }
    ...
    function validasubmit() {
        ...
        if (cboSupplierCode.GetText() == "") {
            lblInfo.SetText("[6011] Please Input Supplier Code first!");
    ...
    function up_Insert() {
        var pIsUpdate = '';
        var pSupplierID = cboSupplierCode.GetText();
        ...
        AffiliateSubmit.PerformCallback('save|' + pIsUpdate + '|' + pSupplierID + '|' + pAffiliatePOTO + '|' + pAffiliatePOCC + '|' + pAffiliatePORevisionTO + '|' + pAffiliatePORevisionCC + '|' + pKanbanTO + '|' + pKanbanCC + '|' + pSupplierDeliveryTO + '|' + pSupplierDeliveryCC + '|' + pPASIReceivingTO + '|' + pPASIReceivingCC + '|' + pAffiliateReceivingTO + '|' + pAffiliateReceivingCC + '|' + pGoodReceiveTO + '|' + pGoodReceiveCC + '|' + pInvoiceTO + '|' + pInvoiceCC + '|' + pSummaryOutstandingTO + '|' + pSummaryOutstandingCC);
        
    }

    function readonly() {
        txtSupplierCode.GetInputElement().setAttribute('style', 'background:#CCCCCC;foreground:#CCCCCC;');
        txtSupplierCode.GetInputElement().readOnly = true;
        lblInfo.SetText('');
    }
...
<table style="width:100%;">
            <tr>
                <td align="left" class="style5">
                            <dx:ASPxLabel ID="ASPxLabel20" runat="server" Text="SUPPLIER CODE/NAME" 
                                Font-Names="Tahoma" font-size="8pt" >
                            </dx:ASPxLabel>
                        </td>
                <td align="left" class="style6">
                            <dx:ASPxComboBox ID="cboSupplierCode" runat="server" Height="16px"  
                                            ClientInstanceName="cboSupplierCode" Width="100px"
                                            Font-Size="8pt" 
                                            Font-Names="Tahoma" TextFormatString="{0}">
                                            <ClientSideEvents SelectedIndexChanged="function(s, e) {
                                                txtSupplierCode.SetText(cboSupplierCode.GetSelectedItem().GetColumnText(1));
                                                cbSetData.PerformCallback(cboSupplierCode.GetSelectedItem().GetColumnText(0)); 
	                                            lblInfo.SetText('');	
                                            }" />
                ...
                <td align="left" width="201px">
                            <dx:ASPxTextBox ID="txtSupplierCode" runat="server" Width="300px" 
                                Font-Names="Tahoma" font-size="8pt" ClientInstanceName="txtSupplierCode" 
		 ...
		 txtEmailCCPASIReceiving.SetEnabled(false);
                    ...
                    <tr>
                        ...
                        <td align="left" class="style1" valign="top">
                            ...
                            ClientInstanceName="txtEmailToAffiliatePO" Font-Names="Tahoma">
                            </dx:ASPxMemo>
                        </td>
                        <td align="right" valign="top">
                    ...
                    <tr>
                        ...
                        <td align="left" class="style1" valign="top">
                            ...
                            ClientInstanceName="txtEmailToAffiliatePORevision" Font-Names="Tahoma" MaxLength="2000">
                            </dx:ASPxMemo>
                        </td>
                        <td align="right" valign="top">
                        ...
                        <dx:ASPxMemo ID="txtEmailCCAffiliatePORevision" runat="server" Height="42px" Width="335px"
                            ClientInstanceName="txtEmailCCAffiliatePORevision" Font-Names="Tahoma" MaxLength="2000">
                            </dx:ASPxMemo>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <dx:ASPxMemo ID="txtEmailToSupplierDelivery" runat="server" Height="42px" Width="335px"
                            ClientInstanceName="txtEmailToSupplierDelivery" Font-Names="Tahoma" MaxLength="2000">
                            </dx:ASPxMemo>
                        </td>
                        <td align="right" valign="top">
                        ...
                        <dx:ASPxMemo ID="txtEmailCCSupplierDelivery" runat="server" Height="42px" Width="335px"
                            ClientInstanceName="txtEmailCCSupplierDelivery" Font-Names="Tahoma" MaxLength="2000">
                            </dx:ASPxMemo>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <dx:ASPxMemo ID="txtEmailToPASIReceiving" runat="server" Height="42px" Width="335px"
                            ClientInstanceName="txtEmailToPASIReceiving" Font-Names="Tahoma" MaxLength="2000">
                            </dx:ASPxMemo>
                        </td>
                        <td align="right" valign="top">
                        ...
                        <dx:ASPxMemo ID="txtEmailCCPASIReceiving" runat="server" Height="42px" Width="335px"
                            ClientInstanceName="txtEmailCCPASIReceiving" Font-Names="Tahoma" MaxLength="2000">
                            </dx:ASPxMemo>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <dx:ASPxMemo ID="txtEmailToAffiliateReceiving" runat="server" Height="42px" Width="335px"
                            ClientInstanceName="txtEmailToAffiliateReceiving" Font-Names="Tahoma" MaxLength="2000">
                            </dx:ASPxMemo>
                        </td>
                        <td align="right" valign="top">
                        ...
                        <dx:ASPxMemo ID="txtEmailCCAffiliateReceiving" runat="server" Height="42px" Width="335px"
                            ClientInstanceName="txtEmailCCAffiliateReceiving" Font-Names="Tahoma" MaxLength="2000">
                            </dx:ASPxMemo>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <dx:ASPxMemo ID="txtEmailToGoodReceive" runat="server" Height="42px" Width="335px"
                            ClientInstanceName="txtEmailToGoodReceive" Font-Names="Tahoma" MaxLength="2000">
                            </dx:ASPxMemo>
                        </td>
                        <td align="right" valign="top">
                        ...
                        <dx:ASPxMemo ID="txtEmailCCGoodReceive" runat="server" Height="42px" Width="335px"
                            ClientInstanceName="txtEmailCCGoodReceive" Font-Names="Tahoma" MaxLength="2000">
                            </dx:ASPxMemo>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <dx:ASPxMemo ID="txtEmailToSummaryOutstanding" runat="server" Height="42px" Width="335px"
                            ClientInstanceName="txtEmailToSummaryOutstanding" Font-Names="Tahoma" MaxLength="2000">
                            </dx:ASPxMemo>
                        </td>
                        <td align="right" valign="top">
                        ...
                        <dx:ASPxMemo ID="txtEmailCCSummaryOutstanding" runat="server" Height="42px" Width="335px"
                            ClientInstanceName="txtEmailCCSummaryOutstanding" Font-Names="Tahoma" MaxLength="2000">
                            </dx:ASPxMemo>
                        </td>
                    </tr>
                    </table>
