<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master"
    CodeBehind="Buyer.aspx.vb" Inherits="PASISystem.Buyer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnGridFocusedRowChanged() {
            grid.GetRowValues(grid.GetFocusedRowIndex(), "AffiliateID;DeliveryLocationCode;DeliveryLocationName;Address;City;PostalCode;Phone1;Phone2;Fax;NPWP;DefaultCls;", OnGetRowValues);
        }
        ...
        function up_Insert() {
            ...
            grid.PerformCallback('save|' + pIsUpdate + '|' + pAffiliateID + '|' + pDeliveryLoc + '|' + pDeliveryLocName + '|' + pAddress + '|' + pCity + '|' + pPostalCode + '|' + pPhone1 + '|' + pPhone2 + '|' + pFax + '|' + pNPWP + '|'  + pDefaultCls);
...
<ClientSideEvents FocusedRowChanged="function(s, e) {
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="2" Caption="BUYER CODE" FieldName="DeliveryLocationCode"
                            Width="100px" HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center" Font-Names="Tahoma" Font-Size="8pt"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="BUYER NAME" VisibleIndex="3" FieldName="DeliveryLocationName"
                            Width="150px">
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="DEFAULT CLS" VisibleIndex="11" FieldName="DefaultCls"
                            Width="80px">
                        </dx:GridViewDataTextColumn>
                    </Columns>
                ...
                <table id="Table1" style="border-width: 1pt thin thin thin; border-style: ridge;
                    ...
                    <tr>
                        ...
                        <td bgcolor="#FFD2A6" align="center" width="150px">
                            <dx:ASPxLabel ID="ASPxLabel56" runat="server" Text="BUYER CODE" Font-Names="Tahoma"
                                Font-Size="8pt" Width="110px">
                            </dx:ASPxLabel>
                        </td>
                        <td bgcolor="#FFD2A6" align="center" width="250px">
                            <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text="BUYER NAME" Font-Names="Tahoma"
