...
<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master"
    CodeBehind="FinalInvoiceCreateDetail.aspx.vb" Inherits="PASISystem.FinalInvoiceCreateDetail" %>
                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td>
                                    ...
                                    <td>
                                        <dx1:ASPxDateEdit ID="dtInvoiceDate" runat="server" ClientInstanceName="dtInvoiceDate" Font-Size="8pt"
                                            EditFormat="Custom" EditFormatString="dd MMM yyyy">
                                            <%--<ClientSideEvents TextChanged="function(s, e) {dtInvoiceDate.SetText(s.cpdtinv);}" />--%>
                                        </dx1:ASPxDateEdit>
                                    </td>
                        <td align="left">
                            &nbsp;
                    ...
                    <tr>
                        <td>
                                    ...
                                    <td>
                                        <dx1:ASPxTextBox ID="txtInvoiceNo" runat="server" Width="150px" Font-Names="Tahoma"
                                            Font-Size="8pt" BackColor="#FFFFFF" Height="16px" MaxLength="20" ClientInstanceName="txtInvoiceNo"
                                            ReadOnly="False">
                        ...
                        <td align="left">
                            <table style="width: 100%;">
                                <tr>
                                    ...
                                    <td>
                                        <dx1:ASPxComboBox ID="cboCommercial" runat="server" ClientInstanceName="cboCommercial" ReadOnly="true"
