<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="viewInvToAff.aspx.vb" Inherits="PASISystem.viewInvToAff" %>
    ...
    <tr>
        <td>               
            <dx:ASPxDocumentViewer ID="ASPxDocumentViewer1" runat="server" 
                DocumentViewerInternal="" ReportTypeName="PASISystem.rptInfoiceToAffiliate">
