...
Public Class FinalInvoiceViewReport
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim Report As New RptFinalInvoice
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            sqlConn.Open()
            ls_sql = "sp_PASI_FinalInvoiceViewReport_LoadReport"
        ...
        If Not Me.Session("PrintSJ") Is Nothing Then
            Report.Name = "Invoice " & Me.Session("PrintSJ")
        End If
    ...
    Private Sub btnsubmenu_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnsubmenu.Click
        ...
        Response.Redirect("~/Invoice/FinalInvoiceCreateDetail.aspx")
    End Sub
