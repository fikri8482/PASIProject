...
Public Class SummaryInvoiceSupplier
...
#Region "Procedures"
    ...
    Private Sub up_GridLoad()
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            '                  " 	,InvoiceNo = INVD.InvoiceNo " & vbCrLf & _
            '                  " 	,InvoiceDate = INVM.InvoiceDate " & vbCrLf & _
            '                  " 	,MPR.Price " & vbCrLf & _
            '                  " 	,TOTAL = ISNULL(PRD.GoodRecQty,0) * ISNULL(MPR.Price,0) 	 "
        ...
        Try
            ...
            Using cn As New SqlConnection(clsGlobal.ConnectionString)
                ...
                ls_sql = ls_sql + "   	,ETDSupp = ES.ETDSupplier   " & vbCrLf & _
                                  ...
                                  "  	,PASIReceiveDate = PRM.ReceiveDate   " & vbCrLf & _
                                  "   	,PASIReceivingQty = PRD.GoodRecQty  " & vbCrLf & _
                                  " 	,InvoiceNo = RTRIM(INVD.InvoiceNo) " & vbCrLf & _
                                  " 	,InvoiceDate = INVM.InvoiceDate " & vbCrLf & _
    ...
    Private Sub epplusExportExcel(ByVal pFilename As String, ByVal pSheetName As String,
        ...
        Try
            Dim tempFile As String = "TemplateSummaryInvoiceSupplier " & Format(Now, "yyyyMMdd hhmmss") & ".xlsx"
            ...
            With ws
                ...
                .Cells(8, 12, pData.Rows.Count + 7, 12).Style.Numberformat.Format = "dd-mmm-yy"
                ...
                .Cells(8, 15, pData.Rows.Count + 7, 15).Style.Numberformat.Format = "#,##0"
        ...
        Try
            ...
            Select Case pAction
                ...
                Case "excel"
                    ...
                    FileName = "TemplateSummaryInvoiceSupplier.xlsx"
