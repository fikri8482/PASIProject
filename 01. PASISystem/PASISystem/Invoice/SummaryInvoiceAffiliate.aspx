<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master"
    CodeBehind="SummaryInvoiceAffiliate.aspx.vb" Inherits="PASISystem.SummaryInvoiceAffiliate" %>
                        ...
                        <td colspan="8" height="20">
                            <table id="Table1">
                                ...
                                <tr>
                                    ...
                                    <td align="left" valign="middle">
                                        <dx:ASPxLabel ID="ASPxLabel8" runat="server" Text="PASI DELIVERY DATE" Font-Names="Tahoma"
                                            Font-Size="8pt">
                                        </dx:ASPxLabel>
                                    </td>
                                    <td align="left" valign="middle">
            ...
            <td colspan="3" align="left" valign="top" height="220">
                ...
                <dx:ASPxGridView ID="grid" runat="server" Width="100%" Font-Names="Tahoma" KeyFieldName="colNo"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="2" Caption="KANBAN NO." FieldName="PONo" Width="100px"
                            HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="10" Caption="PART NAME" FieldName="PartName"
                         ...
                         <dx:GridViewDataTextColumn Caption="NET WEIGHT" FieldName="NetWeight" 
                        ...
                        <dx:GridViewDataTextColumn Caption="GROSS WEIGHT" FieldName="GrossWeight" 
                       ...
                       <%--<dx:GridViewDataTextColumn VisibleIndex="12" Caption="PCS/BOX" FieldName="QtyBox"
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="17" Caption="SCHEDULE ETD SUPPLIER"
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="18" Caption="SCHEDULE ETA AFFILIATE"
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="19" Caption="PASI DELIVERY DATE" FieldName="PASIDeliveryDate"
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="20" Caption="PASI SURAT JALAN NO." FieldName="PASISuratJalanNo"
                            Width="100px" HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="22" Caption="PASI DELIVERY QTY" FieldName="PASIDeliveryQty"
                            Width="80px" HeaderStyle-HorizontalAlign="Center">
                            <PropertiesTextEdit DisplayFormatString="{0:n0}">
                            </PropertiesTextEdit>
                            <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="23" Caption="AFFILIATE RECEIVE DATE" FieldName="AffiliateReceiveDate"
                            Width="110px" HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
                            <PropertiesTextEdit DisplayFormatString="dd MMM yyyy">
                            </PropertiesTextEdit>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="24" Caption="AFFILIATE RECEIVE QTY" FieldName="AffiliateReceiveQty"
                            Width="80px" HeaderStyle-HorizontalAlign="Center">
                            <PropertiesTextEdit DisplayFormatString="{0:n0}">
                            </PropertiesTextEdit>
                            <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="25" Caption="INVOICE NO" FieldName="InvoiceNo"
                            Width="80px" HeaderStyle-HorizontalAlign="Center">                            
                            <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt" HorizontalAlign="Right">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="26" Caption="INVOICE DATE" FieldName="InvoiceDate"
                            Width="80px" HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
                            <PropertiesTextEdit DisplayFormatString="dd MMM yyyy">
                            </PropertiesTextEdit>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="27" Caption="PRICE/PCS" FieldName="Price"
                            Width="80px" HeaderStyle-HorizontalAlign="Center">
                            <PropertiesTextEdit DisplayFormatString="{0:n0}">
                            </PropertiesTextEdit>
                            <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="28" Caption="TOTAL AMOUNT" FieldName="TOTAL"
                            Width="80px" HeaderStyle-HorizontalAlign="Center">
                            <PropertiesTextEdit DisplayFormatString="{0:n0}">
                            </PropertiesTextEdit>
                            <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="29" Caption="REMARKS" FieldName="Remarks"
                            Width="150px" HeaderStyle-HorizontalAlign="Center">                            
                            <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt" HorizontalAlign="Center">
                            </CellStyle>
