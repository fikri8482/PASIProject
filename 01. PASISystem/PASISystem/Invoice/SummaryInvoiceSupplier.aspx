<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master"
    CodeBehind="SummaryInvoiceSupplier.aspx.vb" Inherits="PASISystem.SummaryInvoiceSupplier" %>
            ...
            <td colspan="3" align="left" valign="top" height="220">
                ...
                <dx:ASPxGridView ID="grid" runat="server" Width="100%" Font-Names="Tahoma" KeyFieldName="colNo"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="2" Caption="KANBAN NO" FieldName="KanbanNo" Width="100px"
                            HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="17" Caption="SUPPLIER DELIVERY DATE" FieldName="SupplierDeliveryDate"
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="18" Caption="SUPPLIER SURAT JALAN NO." FieldName="SupplierSuratJalanNo"
                            Width="100px" HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt" HorizontalAlign="Left">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="19" Caption="SUPPLIER DELIVERY QTY" FieldName="SupplierDeliveryQty"
                            Width="80px" HeaderStyle-HorizontalAlign="Center">
                            <PropertiesTextEdit DisplayFormatString="{0:n0}">
                            </PropertiesTextEdit>
                            <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="22" Caption="INVOICE NO" FieldName="InvoiceNo"
                            Width="80px" HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>                           
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt" HorizontalAlign="Center">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>                                               
                        <dx:GridViewDataTextColumn VisibleIndex="23" Caption="INVOICE DATE" FieldName="InvoiceDate"
                            Width="80px" HeaderStyle-HorizontalAlign="Center">
                            <PropertiesTextEdit DisplayFormatString="dd MMM yyyy">
                            </PropertiesTextEdit>
                            <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="24" Caption="PRICE/PCS" FieldName="Price"
                            Width="80px" HeaderStyle-HorizontalAlign="Center">
                            <PropertiesTextEdit DisplayFormatString="{0:n0}">
                            </PropertiesTextEdit>
                            <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="25" Caption="TOTAL AMOUNT" FieldName="TOTAL"
                            Width="80px" HeaderStyle-HorizontalAlign="Center">
                            <PropertiesTextEdit DisplayFormatString="{0:n0}">
                            </PropertiesTextEdit>
                            <HeaderStyle HorizontalAlign="Center" Wrap="True"></HeaderStyle>
