<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="PORevHistory.aspx.vb" Inherits="PASISystem.PORevHistory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    <table style="width:100%;">
                        ...
                        <td colspan="8" height="20">
                            <table id="Table1">
                                ...
                                <tr>
                                    <td style="width:5px;"></td>
                                    <td align="left" valign="middle" height="20px" width="120px">
                                        <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="Affiliate ID / NAME"
                                            Font-Names="Tahoma" Font-Size="8pt">
                                        </dx:ASPxLabel>
                                    </td>
                                    <td align="left" valign="middle" height="20px" width="180px">
                                        <dx:ASPxComboBox ID="cboAffiliateID" runat="server" 
                                            ClientInstanceName="cboAffiliateID" Width="100%"
                                            Font-Size="8pt" 
                                            Font-Names="Verdana" TextFormatString="{0}">
                                            <ClientSideEvents SelectedIndexChanged="function(s, e) {
                                                grid.PerformCallback('kosong');
                                                txtAffiliateID.SetText(cboAffiliateID.GetSelectedItem().GetColumnText(1))
	                                            lblInfo.SetText('');                                                
                                            }" />
                                    ...
                                    <td align="left" valign="middle" width="250px" class="style3">
                                        <dx:ASPxTextBox ID="txtAffiliateID" runat="server" Width="250px" 
                                            ClientInstanceName="txtAffiliateID" Font-Names="Tahoma" Font-Size="8pt"
        ...
        <tr>
            <td colspan="8" align="left" valign="top" height="220">
                ...
                <dx:ASPxGridView ID="grid" runat="server" Width="100%"
                    Font-Names="Tahoma" KeyFieldName="PartNo2;AffiliateID2;AffiliateName;PONo;NoUrut"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="4" Caption="AFFILIATE" FieldName="AffiliateID" Width="80px" HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
        ...
        <tr>
            ...
            <td valign="top" align="right" style="width: 50px;">
                <dx:ASPxButton ID="btnApprove" runat="server" Text="DOWNLOAD"
                    Font-Names="Tahoma"
