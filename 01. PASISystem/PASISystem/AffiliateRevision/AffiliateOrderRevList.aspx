<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="AffiliateOrderRevList.aspx.vb" Inherits="PASISystem.AffiliateOrderRevList" %>
                        ...
                        <td height="30">
                            <table id="Table1">
                                ...
                                <tr>
                                    <td style="width:5px;"></td>
                                    <td align="left" valign="middle" height="25px" width="105px">
                                        <dx:ASPxLabel ID="ASPxLabel18" runat="server" Text="PO REVISION NO."
                                            Font-Names="Tahoma" Font-Size="8pt">
                                        </dx:ASPxLabel>
                                    </td>
                                    <td align="left" valign="middle" height="25px" width="203px" colspan="5">
                                ...
                                <tr>
                                    <td style="width:5px;"></td>
                                    <td align="left" valign="middle" height="25px" width="105px">
                                        <dx:ASPxLabel ID="ASPxLabel19" runat="server" Text="PO NO."
                                            Font-Names="Tahoma" Font-Size="8pt">
                                        </dx:ASPxLabel>
                                    </td>
                                    <td align="left" valign="middle" height="25px" width="203px" colspan="5">
                ...
                <dx:ASPxGridView ID="grid" runat="server" Width="100%"
                    ...
                    <Columns>
                        <dx:GridViewDataTextColumn VisibleIndex="0" Caption=" " Width="50px" FieldName="DetailPage">
                            <DataItemTemplate>
                                <a id="clickElement" href="AffiliateOrderevEntry.aspx?id=<%#GetRowValue(Container)%>&t1=<%#GetPeriod(Container)%>&t2=<%#GetPORevNo(Container)%>&t3=<%#GetPONo(Container)%>&t4=<%#GetCommercial(Container)%>&t5=<%#GetAffiliateID(Container)%>&t6=<%#GetAffiliateName(Container)%>&t7=<%#GetSupplierID(Container)%>&t8=<%#GetSupplierName(Container)%>&t9=<%#GetKanban(Container)%>&t10=<%#GetShip(Container)%>>&t11=<%#GetSeq(Container)%>&Session=~/AffiliateRevision/AffiliateOrderRevList.aspx">
                                    <%# "DETAIL"%></a>
                            </DataItemTemplate>
                        ...
                        <dx:GridViewDataTextColumn Caption="AFFILIATE NAME" FieldName="AffiliateName" 
                            VisibleIndex="3" Width="200px" HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="SUPPLIER NAME" FieldName="SupplierName" 
                            VisibleIndex="8" Width="200px" HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="SeqNo" FieldName="SeqNo" 
                    ...
                    <SettingsPager Position="Top" Mode="ShowAllRecords">
