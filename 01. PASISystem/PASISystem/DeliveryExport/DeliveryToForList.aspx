<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master"
    CodeBehind="DeliveryToForList.aspx.vb" Inherits="PASISystem.DeliveryToForList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    ...
    <table style="width: 100%;" width="100%">
        <tr>
            ...
            <td align="left">
                <dx1:ASPxComboBox ID="cboForwarder" runat="server" ClientInstanceName="cboForwarder"
            ...
            <td align="left">
                <dx1:ASPxTextBox ID="txtForwarder" runat="server" Font-Names="Tahoma" Font-Size="8pt"
                    Width="170px" BackColor="Silver" ClientInstanceName="txtForwarder" 
                    ReadOnly="True">
                        ...
                        <td>
                            <dx1:ASPxButton ID="btnsearch" runat="server" Text="SEARCH" Width="85px" Font-Names="Tahoma"
                                ...
                                <ClientSideEvents Click="function(s, e) {
	                                        ...
	                                        grid.PerformCallback('gridload' + '|' + pPlandate + '|' + pSupplierDeliver + '|' + pRemaining + '|' + psj + '|' + pDateFrom + '|' + pDateTo + '|' + pAffiliate + '|' + pPartcode + '|' + pPono + '|' + '');
	                                        lblerrmessage.SetText('');
        ...
        <tr>
            <td align="left" class="style1" colspan="2">
                <dx:ASPxGridView ID="grid" runat="server" AutoGenerateColumns="False" Width="100%"
                    KeyFieldName="colno;colpono;colsuppliercode;colpartno;H_POORDER;H_AFFILIATEORDER;HSupSJ;HPasiSJ"
	...
	e.handled = true;
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="SUPPLIER DELIVERY DATE" FieldName="coldeldate"
                            Name="coldeldate" VisibleIndex="16" Width="80px">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" Font-Underline="False" Wrap="True"
                                HorizontalAlign="Center" />
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        ...
                        <dx:GridViewDataTextColumn Caption="PASI DELIVERY DATE" FieldName="colpasideliverydate"
                            Name="colpasideliverydate" VisibleIndex="18" Width="100px">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" Font-Underline="False" Wrap="True"
                                HorizontalAlign="Center" />
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        ...
                        <dx:GridViewDataTextColumn Caption="UOM" FieldName="coluom" Name="coluom" VisibleIndex="22"
                            Width="0px">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" Font-Underline="False" Wrap="True"
                                HorizontalAlign="Center" />
                        ...
                        <dx:GridViewDataTextColumn Caption="SUPPLIER DELIVERY QTY" FieldName="coldeliveryqty"
                            Name="coldeliveryqty" VisibleIndex="23" Width="0px">
                        ...
                        <dx:GridViewDataTextColumn Caption="PASI GOOD RECEIVEING QTY" FieldName="colreceiveqty"
                            Name="colreceiveqty" VisibleIndex="24" Width="0px">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" Font-Underline="False" Wrap="True"
                                HorizontalAlign="Center" />
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt" HorizontalAlign="Right">
                            </CellStyle>
                        ...
                        <dx:GridViewDataTextColumn Caption="PASI DEFECT RECEIVEING QTY" FieldName="coldefect"
                            Name="coldefect" VisibleIndex="25" Width="0px">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" Font-Underline="False" Wrap="True"
                                HorizontalAlign="Center" />
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt" HorizontalAlign="Right">
                            </CellStyle>
                        ...
                        <dx:GridViewDataTextColumn Caption="PASI REMAINING RECEIVE QTY" FieldName="colremaining"
                            Name="colremaining" VisibleIndex="26" Width="0px">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" Font-Underline="False" Wrap="True"
                                HorizontalAlign="Center" />
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt" HorizontalAlign="Right">
                            </CellStyle>
                        ...
                        <dx:GridViewDataTextColumn Caption="PASI DELIVERY QTY" FieldName="colpasideliveryqty"
                            Name="colpasideliveryqty" VisibleIndex="27" Width="0px">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" Font-Underline="False" Wrap="True"
                                HorizontalAlign="Center" />
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt" HorizontalAlign="Right">
                            </CellStyle>
                        ...
                        <dx:GridViewDataTextColumn Caption="DELIVERY BY" FieldName="coldeliveryby" Name="coldeliveryby"
                            VisibleIndex="29" Width="100px">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" Font-Underline="False" Wrap="True"
                                HorizontalAlign="Center" />
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="PALLET NO." FieldName="colPalet" 
                            Name="colPalet" VisibleIndex="12" Width="120px">
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" Font-Underline="False" Wrap="True"
                                HorizontalAlign="Center" />
                        </dx:GridViewDataTextColumn>
                    </Columns>
