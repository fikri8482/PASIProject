<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="UploadSupplierPrice.aspx.vb" Inherits="PASISystem.UploadSupplierPrice" %>
...
<ClientSideEvents RowClick="function(s, e) {
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="4" Caption="SUPPLIER NAME" FieldName="SupplierName"
                            Width="210px" HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center" Font-Names="Tahoma" Font-Size="8pt"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="5" Caption="PACKING TYPE" 
                            FieldName="PackingCls" Width="200px" 
                            HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center" Font-Names="Tahoma" Font-Size="8pt"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="6" Caption="PRICE CATEGORY" 
                            FieldName="PriceCls" Width="250px" 
                            HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center" Font-Names="Tahoma" Font-Size="8pt"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        ...
                        <dx:GridViewDataDateColumn Caption="EFFECTIVE DATE" FieldName="EntryDate" VisibleIndex="9"
                            Width="110px">
                            <PropertiesDateEdit DisplayFormatString="dd MMM yyyy" EditFormatString="dd MMM yyyy">
                            </PropertiesDateEdit>
                            <HeaderStyle Font-Names="Tahoma" Font-Size="8pt" HorizontalAlign="Center" />
                        ...
                        <dx:GridViewDataTextColumn Caption="PRICE" FieldName="Price" VisibleIndex="11" Width="130px">
                        ...
                        <dx:GridViewDataTextColumn Caption="DELIVERY NAME" FieldName="DeliveryLocation" 
                            VisibleIndex="13" Width="210px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DELIVERY ID" FieldName="DeliveryLocationID" 
                            VisibleIndex="12" Width="110px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataDateColumn Caption="xEndDate" FieldName="xEndDate" 
                            VisibleIndex="15" Width="0px">
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataDateColumn Caption="xEffectiveDate" FieldName="xEffectiveDate" 
                            VisibleIndex="17" Width="0px">
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataTextColumn Caption="xPrice" FieldName="xPrice" 
                            VisibleIndex="18" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xPackingCls" FieldName="xPackingCls" 
                            VisibleIndex="19" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xPriceCls" FieldName="xPriceCls" 
