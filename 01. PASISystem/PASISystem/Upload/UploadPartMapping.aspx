<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="UploadPartMapping.aspx.vb" Inherits="PASISystem.UploadPartMapping" %>
...
<ClientSideEvents RowClick="function(s, e) {
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="2" Caption="PART NO." FieldName="PartNo"
                            Width="100px" HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="3" Caption="PART NAME" FieldName="PartName"
                            Width="210px" HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="4" Caption="AFFILIATE CODE" FieldName="AffiliateID"
                            Width="80px" HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="5" Caption="AFFILIATE NAME" FieldName="AffiliateName"
                            Width="210px" HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="6" Caption="SUPPLIER CODE" FieldName="SupplierID"
                            Width="80px" HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="7" Caption="SUPPLIER NAME" FieldName="SupplierName"
                            Width="210px" HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="8" Caption="QUOTA (%)" FieldName="Quota"
                            Width="50px" HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="9" Caption="LOCATION" FieldName="LocationID"
                            Width="80px" HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="20" Caption="REMARK" 
                            FieldName="ErrorCls" Width="200px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="HEIGHT" VisibleIndex="19" 
                            FieldName="Height">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="PACKING GROUP" VisibleIndex="10" 
                            FieldName="PackingCls">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="GROSS WEIGHT" VisibleIndex="16" 
                            FieldName="GrossWeight">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="BOX/PALLET" VisibleIndex="14" 
                            FieldName="BoxPallet">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="QTY/BOX" VisibleIndex="13" 
                            FieldName="QtyBox">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MOQ" VisibleIndex="12" FieldName="MOQ">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="PACKING DESCRIPTION" VisibleIndex="11" 
                            FieldName="PackingDesc">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="NET WEIGHT" VisibleIndex="15" 
                            FieldName="NetWeight">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="WIDTH" VisibleIndex="18" FieldName="Width">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="LENGTH" VisibleIndex="17" 
                            FieldName="Length">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xaffiliateid" FieldName="xaffiliateid" 
                            VisibleIndex="21" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xpartno" FieldName="xpartno" 
                            VisibleIndex="22" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xsupplierid" FieldName="xsupplierid" 
                            VisibleIndex="23" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xquota" FieldName="xquota" 
                            VisibleIndex="24" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xlocationid" FieldName="xlocationid" 
                            VisibleIndex="25" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xpackingcls" FieldName="xpackingcls" 
                            VisibleIndex="26" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xmoq" FieldName="xmoq" VisibleIndex="27" 
                            Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xqtybox" FieldName="xqtybox" 
                            VisibleIndex="28" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xboxpallet" FieldName="xboxpallet" 
                            VisibleIndex="29" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xnetweight" FieldName="xnetweight" 
                            VisibleIndex="30" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xgrossweight" FieldName="xgrossweight" 
                            VisibleIndex="31" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xlength" FieldName="xlength" 
                            VisibleIndex="32" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xwidth" FieldName="xwidth" 
                            VisibleIndex="33" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xheight" FieldName="xheight" 
