...
<ClientSideEvents RowClick="function(s, e) {
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="3" Caption="AFFILIATE CODE" FieldName="AffiliateCode" Width="100px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="4" Caption="CONSIGNEE CODE" FieldName="ConsigneeCode" Width="100px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="5" Caption="BUYER CODE" FieldName="BuyerCode" Width="100px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="25" Caption="PATH OES FOLDER" 
                            FieldName="FolderOES" Width="300px" HeaderStyle-HorizontalAlign="Center">
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="24" Caption="REMARK" 
                        ...
                        <dx:GridViewDataTextColumn Caption="xConsigneeAddress" 
                            FieldName="xConsigneeAddress" VisibleIndex="28" Width="0px">
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="xCity" FieldName="xCity" VisibleIndex="34" 
                            Width="0px">
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="xPhone2" FieldName="xPhone2" 
                            VisibleIndex="37" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xFax" FieldName="xFax" VisibleIndex="38" 
                            Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xNPWP" FieldName="xNPWP" VisibleIndex="39" 
                            Width="0px">
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="xBCPerson" FieldName="xBCPerson" 
                            VisibleIndex="42" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xDestinationPort" 
                            FieldName="xDestinationPort" VisibleIndex="43" Width="0px">
                        </dx:GridViewDataTextColumn>
