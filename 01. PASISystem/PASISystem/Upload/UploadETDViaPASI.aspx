<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="UploadETDViaPASI.aspx.vb" Inherits="PASISystem.UploadETDViaPASI" %>
...
<ClientSideEvents RowClick="function(s, e) {
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="3" Caption="E.T.A PASI" 
                            FieldName="ETAPASI" Width="100px">
                            <propertiestextedit displayformatstring="dd MMM yyyy"></propertiestextedit>
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="4" Caption="E.T.D SUPPLIER" 
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="5" Caption="REMARK" FieldName="ErrorCls" Width="200px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
