<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="UploadDeliveryLocation.aspx.vb" Inherits="PASISystem.UploadDeliveryLocation" %>
...
<ClientSideEvents RowClick="function(s, e) {
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="13" Caption="REMARK" FieldName="ErrorCls" Width="200px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="xdeliverylocationcode" 
                            FieldName="xdeliverylocationcode" VisibleIndex="15" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xdeliverylocationname" 
                            FieldName="xdeliverylocationname" VisibleIndex="16" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xaddress" FieldName="xaddress" 
                            VisibleIndex="17" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xcity" FieldName="xcity" VisibleIndex="18" 
                            Width="0px">
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="xfax" FieldName="xfax" VisibleIndex="22" 
                            Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xnpwp" FieldName="xnpwp" VisibleIndex="23" 
                            Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xpodeliveryby" FieldName="xpodeliveryby" 
                            VisibleIndex="24" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xdefaultcls" FieldName="xdefaultcls" 
