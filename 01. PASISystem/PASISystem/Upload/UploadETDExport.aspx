<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="UploadETDExport.aspx.vb" Inherits="PASISystem.UploadETDExport" %>
        ...
        <tr>
            <td colspan="3" align="left" valign="top" height="220">
                <dx:ASPxGridView ID="grid" runat="server" Width="100%"
                    Font-Names="Tahoma" KeyFieldName="RowNumber;Period;AffiliateID;SupplierID;"
...
<ClientSideEvents RowClick="function(s, e) {
                    ...
                    <Columns>
                        <dx:GridViewDataTextColumn VisibleIndex="1" Caption="NO." FieldName="RowNumber" Width="30px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                         <dx:GridViewDataTextColumn VisibleIndex="2" Caption="PERIOD" 
                            FieldName="Period" Width="100px">
                            <propertiestextedit displayformatstring="MMM yyyy"></propertiestextedit>
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="3" Caption="SUPPLIER ID" FieldName="SupplierID" Width="100px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="4" Caption="AFFILIATE ID" FieldName="AffiliateID" Width="100px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="5" Caption="WEEK" FieldName="Week" Width="80px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="6" Caption="E.T.D VENDOR" 
                            FieldName="ETDVendor" Width="100px">
                            <propertiestextedit displayformatstring="dd MMM yyyy"></propertiestextedit>
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="7" Caption="E.T.A FORWARDER" 
                            FieldName="ETAForwarder" Width="100px">
                            <propertiestextedit displayformatstring="dd MMM yyyy"></propertiestextedit>
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="8" Caption="E.T.D PORT" 
                            FieldName="ETDPort" Width="100px">
                            <propertiestextedit displayformatstring="dd MMM yyyy"></propertiestextedit>
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="9" Caption="E.T.A PORT" 
                            FieldName="ETAPort" Width="100px">
                            <propertiestextedit displayformatstring="dd MMM yyyy"></propertiestextedit>
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="10" Caption="E.T.A FACTORY" 
                            FieldName="ETAFactory" Width="100px">
                            <propertiestextedit displayformatstring="dd MMM yyyy"></propertiestextedit>
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="10" Caption="CUT OF DATE" 
                            FieldName="CutOfDate" Width="100px">
                            <propertiestextedit displayformatstring="dd MMM yyyy"></propertiestextedit>
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="11" Caption="REMARK" FieldName="ErrorCls" Width="200px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataDateColumn Caption="xETDVendor" FieldName="xETDVendor" 
                            VisibleIndex="13" Width="0px">
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataDateColumn Caption="xETAForwarder" FieldName="xETAForwarder" 
                            VisibleIndex="14" Width="0px">
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataDateColumn Caption="xETDPort" FieldName="xETDPort" 
                            VisibleIndex="15" Width="0px">
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataDateColumn Caption="xETAPort" FieldName="xETAPort" 
                            VisibleIndex="16" Width="0px">
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataDateColumn Caption="xETAFactory" FieldName="xETAFactory" 
                            VisibleIndex="17" Width="0px">
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataDateColumn Caption="xCutOfDate" FieldName="xCutOfDate" 
