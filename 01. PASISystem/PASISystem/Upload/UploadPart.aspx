<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="UploadPart.aspx.vb" Inherits="PASISystem.UploadPart" %>
...
<ClientSideEvents RowClick="function(s, e) {
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="2" Caption="PART NO." FieldName="PartNo" Width="100px" HeaderStyle-HorizontalAlign="Center">
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="3" Caption="PART NAME" FieldName="PartName" Width="210px" HeaderStyle-HorizontalAlign="Center">
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        </dx:GridViewDataTextColumn>
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="5" Caption="PART NAME CAR MAKER" FieldName="PartCarName" Width="210px" HeaderStyle-HorizontalAlign="Center">
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="6" Caption="PART GROUP NAME" FieldName="PartGroupName" Width="210px" HeaderStyle-HorizontalAlign="Center">
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="7" Caption="HS CODE" FieldName="HSCode" Width="100px" HeaderStyle-HorizontalAlign="Center">
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        </dx:GridViewDataTextColumn>
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="12" Caption="PROJECT" 
                            FieldName="Project" Width="100px" HeaderStyle-HorizontalAlign="Center">
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        </dx:GridViewDataTextColumn>
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="22" Caption="REMARK" 
                        ...
                        <dx:GridViewDataTextColumn Caption="XPartName" FieldName="XPartName" 
                            VisibleIndex="24" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="XPartCarMaker" FieldName="XPartCarMaker" 
                            VisibleIndex="25" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="XPartCarName" FieldName="XPartCarName" 
                            VisibleIndex="26" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="XPartGroupName" FieldName="XPartGroupName" 
                            VisibleIndex="27" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="XHSCode" FieldName="XHSCode" 
                            VisibleIndex="28" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="XUOM" FieldName="XUOM" VisibleIndex="29" 
                            Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="XKanbanCls" FieldName="XKanbanCls" 
                            VisibleIndex="30" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="XMaker" FieldName="XMaker" 
                            VisibleIndex="31" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="XProject" FieldName="XProject" 
