...
#Region "FORM EVENTS"
    ...
    Private Sub btnSubMenu_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubMenu.Click
        Response.Redirect("~/Master/ETDSupplierMaster.aspx")
    End Sub
...
#Region "PROCEDURE"
    ...
    Private Sub bindData()
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            ls_SQL = " select  " & vbCrLf & _
                  " 	row_number() over (order by SupplierID, ETAPASI asc) as NoUrut, " & vbCrLf & _
                  " 	SupplierID, ETAPASI, ETDSupplier, ErrorCls "

            ls_SQL = ls_SQL + " from UploadETDSupplierPASI order by SupplierID, ETAPASI "
    ...
    Private Sub up_GridLoadWhenEventChange()
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            ls_SQL = " select top 0 '' NoUrut, '' SupplierID, '' ETAPASI, '' ETDSupplier , '' ErrorCls"
                ...
                Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
                    ...
                    Try
                        ...
                        If dtDetail.Rows.Count > 0 Then
                            For i = 0 To dtDetail.Rows.Count - 1
                                If IsDBNull(dtDetail.Rows(i).Item(0)) = False Then
                                    ...
                                    dtUploadDetail.ETAPASI = dtDetail.Rows(i).Item(1)
                                    'dtUploadDetail.ETDSupplier = dtDetail.Rows(i).Item(2)
                        ...
                        Using sqlTran As SqlTransaction = sqlConn.BeginTransaction("uploadPO")
                            ...
                            ls_sql = "delete UploadETDSupplierPASI"
                            ...
                            For i = 0 To dtUploadDetailList.Count - 1
                                ...
                                If IsDate(PO.ETAPASI) = False Then
                                    If ls_error = "" Then
                                ...
                                ls_sql = " INSERT INTO [dbo].[UploadETDSupplierPASI] " & vbCrLf & _
                                          "            ([SupplierID], [ETAPASI], [ETDSupplier],[ErrorCls]) " & vbCrLf & _
                                          "      VALUES " & vbCrLf & _
            ...
            Try
                ...
                For i = 0 To grid.VisibleRowCount - 1
                    If grid.GetRowValues(i, "SupplierID") <> "" Then
                        ls_Sql = " IF NOT EXISTS (select * from MS_ETD_Supplier_PASI where SupplierID = '" & grid.GetRowValues(i, "SupplierID") & "' and ETAPASI = '" & grid.GetRowValues(i, "ETAPASI") & "')" & vbCrLf & _
                                  " BEGIN" & vbCrLf & _
                                  "      INSERT INTO [dbo].[MS_ETD_Supplier_PASI] " & vbCrLf & _
                                  "            ([SupplierID] " & vbCrLf & _
                                  "            ,[ETAPASI] " & vbCrLf & _
                                  "            ,[ETDSupplier]) " & vbCrLf & _
                                  "      VALUES " & vbCrLf & _
                                  "            ('" & grid.GetRowValues(i, "SupplierID") & "' " & vbCrLf & _
                                  "            ,'" & grid.GetRowValues(i, "ETAPASI") & "' " & vbCrLf & _
                                  "            ," & IIf(IsDBNull(grid.GetRowValues(i, "ETDSupplier")), "NULL", "'" & grid.GetRowValues(i, "ETDSupplier") & "'") & ") " & vbCrLf & _
                                  " END " & vbCrLf & _
                                  " ELSE " & vbCrLf & _
                                  " BEGIN" & vbCrLf & _
                                  "      UPDATE [dbo].[MS_ETD_Supplier_PASI] SET " & vbCrLf & _
                                  "            [ETDSupplier] =" & IIf(IsDBNull(grid.GetRowValues(i, "ETDSupplier")), "NULL", "'" & grid.GetRowValues(i, "ETDSupplier") & "'") & " " & vbCrLf & _
                                  "      WHERE [SupplierID] = '" & grid.GetRowValues(i, "SupplierID") & "' and [ETAPASI] = '" & grid.GetRowValues(i, "ETAPASI") & "'" & vbCrLf & _
                                  " END"
