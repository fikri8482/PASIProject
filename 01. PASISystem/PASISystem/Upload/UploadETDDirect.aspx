<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="UploadETDDirect.aspx.vb" Inherits="PASISystem.UploadETDDirect" %>
...
<ClientSideEvents RowClick="function(s, e) {
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="2" Caption="SUPPLIER ID" FieldName="SupplierID" Width="100px">
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="3" Caption="AFFILIATE ID" FieldName="AffiliateID" Width="100px">
                            <PropertiesTextEdit DisplayFormatString="MMM yyyy">
                            </PropertiesTextEdit>
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="4" Caption="E.T.A AFFILIATE" 
                            FieldName="ETAAffiliate" Width="100px">
                            <propertiestextedit displayformatstring="dd MMM yyyy"></propertiestextedit>
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="5" Caption="E.T.D SUPPLIER" 
                            FieldName="ETDSupplier" Width="100px">
                            <propertiestextedit displayformatstring="dd MMM yyyy"></propertiestextedit>
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="6" Caption="REMARK" FieldName="ErrorCls" Width="200px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
