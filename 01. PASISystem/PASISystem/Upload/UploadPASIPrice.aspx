<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="UploadPASIPrice.aspx.vb" Inherits="PASISystem.UploadPASIPrice" %>
...
<HeaderStyle HorizontalAlign="Center" Font-Names="Tahoma" Font-Size="8pt"></HeaderStyle>
                        ...
                        <dx:GridViewDataDateColumn Caption="EFFECTIVE DATE" FieldName="EntryDate" 
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="10" Caption="CURR" 
...
<HeaderStyle HorizontalAlign="Center" Font-Names="Tahoma" Font-Size="8pt"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="12" Caption="REMARK" FieldName="ErrorCls" Width="200px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="xpackingtype" FieldName="xpackingtype" 
                            VisibleIndex="15" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xpricecategory" FieldName="xpricecategory" 
                            VisibleIndex="16" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xcurrcls" FieldName="xcurrcls" 
                            VisibleIndex="17" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xprice" FieldName="xprice" 
                            VisibleIndex="18" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xstartdate" FieldName="xstartdate" 
                            VisibleIndex="19" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xenddate" FieldName="xenddate" 
                            VisibleIndex="20" Width="0px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="xeffectivedate" FieldName="xeffectivedate" 
