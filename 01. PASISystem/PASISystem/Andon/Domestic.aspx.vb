...
#Region "Events"
    ...
    Protected Sub LegendTick_Callback(source As Object, e As DevExpress.Web.ASPxCallback.CallbackEventArgs)
        Dim ls_SQL As String = "Exec Andon_GetDataCount_ALL"
...
#Region "Functions"
    ...
    Private Sub up_GridLoad_DelayPasi()
        Dim ls_SQL As String = "Exec Andon_GetData_DelayPasi"
    ...
    Private Sub up_GridLoad_DelaySupplier()
        Dim ls_SQL As String = "Exec Andon_GetData_DelaySupplier"
    ...
    Private Sub up_GridLoad_ReceivePasi()
        Dim ls_SQL As String = "Exec Andon_GetData_PlanPenerimaanPasi"
    ...
    Private Sub up_GridLoad_DeliveryPasi()
        Dim ls_SQL As String = "Exec Andon_GetData_PlanPengirimanPasi"
