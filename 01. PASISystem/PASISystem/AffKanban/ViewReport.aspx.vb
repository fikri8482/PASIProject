...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Session("KCR-ReportCode") = "KanbanCard" Then
            ...
            'ls_sql = " SELECT  KM.KanbanNo AS kanbanNo ,  " & vbCrLf & _
            ...
            '      "  ISNULL(MDP.DeliveryLocationName,'') Location ,  " & vbCrLf & _
            '      "  KD.PONo ,  " & vbCrLf & _
            ...
            '                  "  WHERE   KD.AffiliateID = '" & Session("KCR-AffiliateCode") & "'  " & vbCrLf
            ...
            ls_sql = ls_sql + "         PartNo1 = LEFT(Rtrim(KD.PartNo),2) , " & vbCrLf &
                              ...
                              "         Qty = Replace(Rtrim(ISNULL(KD.POQtyBox,ML.QtyBox)),'.00','') , " & vbCrLf &
            ...
            ls_sql = ls_sql + "                                        AND KB.SupplierID = KD.SupplierID " & vbCrLf & _
                              "                                        AND KB.PartNo = KD.PartNo " & vbCrLf & _
                              "         LEFT JOIN MS_PartMapping ML ON KD.AffiliateID = ML.affiliateID AND ML.SupplierID = KD.SupplierID AND ML.PartNo = KD.PartNO" & vbCrLf & _
        ...
        ElseIf Session("KCR-ReportCode") = "KanbanCycle" Then
            ...
            ls_sql = ls_sql + " SELECT DISTINCT KM.KanbanNo , " & vbCrLf & _
                              ...
                              "         ISNULL(KD.POMOQ,MOQ) MOQ, " & vbCrLf & _
                              "         Unit = Description, " & vbCrLf & _
                              "         KanbanQty, " & vbCrLf & _
                              "         ISNULL(KD.POQtyBox,QtyBox) QtyBox, " & vbCrLf & _
            ...
            ls_sql = ls_sql + " FROM    dbo.Kanban_Master KM " & vbCrLf & _
                              ...
                              "         LEFT JOIN MS_ETD_Supplier_Pasi ES ON MEP.ETDPASI = ES.ETAPASI and ES.SupplierID = KM.SupplierID " & vbCrLf & _
                              "         INNER JOIN dbo.MS_Supplier MSS ON MSS.SupplierID = KD.SupplierID " & vbCrLf & _
                              "         INNER JOIN dbo.MS_Parts MSP ON MSP.PartNo = KD.PartNo " & vbCrLf & _
                              ...
                              "         INNER JOIN dbo.MS_UnitCls MUC ON MUC.UnitCls = KD.UnitCls " & vbCrLf
    ...
    Private Sub btnsubmenu_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnsubmenu.Click
        If Session("KCR-Form") = "KanbanCreate" Then
            ...
            If Not IsNothing(Session("URL-Param")) Then
                Response.Redirect(Session("URL-PARAM"))
            Else
                Response.Redirect("~/Affkanban/AffKanbanCreate.aspx")
            End If
