...
#Region "Properties"
    ...
    Public Property IPDestination As String
#End Region
...
#Region "Initialization"
    ...
    Public Sub New(Optional ByVal pConfigFile As String = "UPLOAD.ini")
        ...
        'Password
        lng = GetPrivateProfileString("Setting", "IPDestEDI", "", _
        ret6, 1500, ls_path)
        If lng <> 0 Then ret = Microsoft.VisualBasic.Left(ret6, CInt(lng))
        IPDestination = ret
        ...
        builder.ApplicationName = "Autobatch Scheduler"
