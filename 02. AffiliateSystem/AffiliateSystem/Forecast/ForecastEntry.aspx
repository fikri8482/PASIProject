<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="ForecastEntry.aspx.vb" Inherits="AffiliateSystem.ForecastEntry" %>
        ...
        <tr>
            <td colspan="2" align="left" valign="top" height="220">
                ...
                <dx:ASPxGridView ID="grid" runat="server" Width="100%"
                    Font-Names="Tahoma" KeyFieldName="PartNo"
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        ...
                        <dx:GridViewBandColumn Caption="Forecast" VisibleIndex="4">
                            <Columns>
                                <dx:GridViewDataTextColumn VisibleIndex="5" Caption="WK1" Width="80px"
                                    FieldName="Bln1" HeaderStyle-HorizontalAlign="Center">
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                ...
                                <dx:GridViewDataTextColumn VisibleIndex="6" Caption="WK2" Width="80px"
                                    FieldName="Bln2" HeaderStyle-HorizontalAlign="Center">
                                    <PropertiesTextEdit DisplayFormatString="{0:n0}">
                                        <MaskSettings ErrorText="Please input valid value !"
                                        Mask="<0..999999g>" IncludeLiterals="DecimalSymbol" AllowMouseWheel="False" />
                                        <ValidationSettings ErrorDisplayMode="None"></ValidationSettings>
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                ...
                                <dx:GridViewDataTextColumn VisibleIndex="7" Caption="WK3" Width="80px"
                                    FieldName="Bln3" HeaderStyle-HorizontalAlign="Center">
                                    <PropertiesTextEdit DisplayFormatString="{0:n0}">
                                        <MaskSettings ErrorText="Please input valid value !"
                                        Mask="<0..999999g>" IncludeLiterals="DecimalSymbol" AllowMouseWheel="False" />
                                        <ValidationSettings ErrorDisplayMode="None"></ValidationSettings>
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                ...
                                <dx:GridViewDataTextColumn VisibleIndex="8" Caption="WK4" Width="80px"
                                    FieldName="Bln4" HeaderStyle-HorizontalAlign="Center">
                                    <PropertiesTextEdit DisplayFormatString="{0:n0}">
                                        <MaskSettings ErrorText="Please input valid value !"
                                        Mask="<0..999999g>" IncludeLiterals="DecimalSymbol" AllowMouseWheel="False" />
                                        <ValidationSettings ErrorDisplayMode="None"></ValidationSettings>
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                ...
                                <dx:GridViewDataTextColumn VisibleIndex="9" Caption="WK5" Width="80px"
                                    FieldName="Bln5" HeaderStyle-HorizontalAlign="Center">
                                    <PropertiesTextEdit DisplayFormatString="{0:n0}">
                                        <MaskSettings ErrorText="Please input valid value !"
                                        Mask="<0..999999g>" IncludeLiterals="DecimalSymbol" AllowMouseWheel="False" />
                                        <ValidationSettings ErrorDisplayMode="None"></ValidationSettings>
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                ...
                                <dx:GridViewDataTextColumn VisibleIndex="10" Caption="WK6" Width="80px"
                                    FieldName="Bln6" HeaderStyle-HorizontalAlign="Center">
                                    <PropertiesTextEdit DisplayFormatString="{0:n0}">
                                        <MaskSettings ErrorText="Please input valid value !"
                                        Mask="<0..999999g>" IncludeLiterals="DecimalSymbol" AllowMouseWheel="False" />
                                        <ValidationSettings ErrorDisplayMode="None"></ValidationSettings>
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                ...
                                <dx:GridViewDataTextColumn VisibleIndex="11" Caption="WK7" Width="80px"
                                    FieldName="Bln7" HeaderStyle-HorizontalAlign="Center">
                                    <PropertiesTextEdit DisplayFormatString="{0:n0}">
                                        <MaskSettings ErrorText="Please input valid value !"
                                        Mask="<0..999999g>" IncludeLiterals="DecimalSymbol" AllowMouseWheel="False" />
                                        <ValidationSettings ErrorDisplayMode="None"></ValidationSettings>
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                ...
                                <dx:GridViewDataTextColumn VisibleIndex="12" Caption="WK8" Width="80px"
                                    FieldName="Bln8" HeaderStyle-HorizontalAlign="Center">
                                    <PropertiesTextEdit DisplayFormatString="{0:n0}">
                                        <MaskSettings ErrorText="Please input valid value !"
                                        Mask="<0..999999g>" IncludeLiterals="DecimalSymbol" AllowMouseWheel="False" />
                                        <ValidationSettings ErrorDisplayMode="None"></ValidationSettings>
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                ...
                                <dx:GridViewDataTextColumn VisibleIndex="13" Caption="WK9" Width="80px"
                                    FieldName="Bln9" HeaderStyle-HorizontalAlign="Center">
                                    <PropertiesTextEdit DisplayFormatString="{0:n0}">
                                        <MaskSettings ErrorText="Please input valid value !"
                                        Mask="<0..999999g>" IncludeLiterals="DecimalSymbol" AllowMouseWheel="False" />
                                        <ValidationSettings ErrorDisplayMode="None"></ValidationSettings>
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                ...
                                <dx:GridViewDataTextColumn VisibleIndex="14" Caption="WK10" Width="80px"
                                    FieldName="Bln10" HeaderStyle-HorizontalAlign="Center">
                                    <PropertiesTextEdit DisplayFormatString="{0:n0}">
                                        <MaskSettings ErrorText="Please input valid value !"
                                        Mask="<0..999999g>" IncludeLiterals="DecimalSymbol" AllowMouseWheel="False" />
                                        <ValidationSettings ErrorDisplayMode="None"></ValidationSettings>
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                ...
                                <dx:GridViewDataTextColumn VisibleIndex="15" Caption="WK11" Width="80px"
                                    FieldName="Bln11" HeaderStyle-HorizontalAlign="Center">
                                    <PropertiesTextEdit DisplayFormatString="{0:n0}">
                                        <MaskSettings ErrorText="Please input valid value !"
                                        Mask="<0..999999g>" IncludeLiterals="DecimalSymbol" AllowMouseWheel="False" />
                                        <ValidationSettings ErrorDisplayMode="None"></ValidationSettings>
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                ...
                                <dx:GridViewDataTextColumn VisibleIndex="16" Caption="WK12" Width="80px"
                                    FieldName="Bln12" HeaderStyle-HorizontalAlign="Center">
                                    <PropertiesTextEdit DisplayFormatString="{0:n0}">
                                        <MaskSettings ErrorText="Please input valid value !"
                                        Mask="<0..999999g>" IncludeLiterals="DecimalSymbol" AllowMouseWheel="False" />
                                        <ValidationSettings ErrorDisplayMode="None"></ValidationSettings>
