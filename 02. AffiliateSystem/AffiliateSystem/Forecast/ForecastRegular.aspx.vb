...
#Region "Procedures"
    ...
    Private Sub up_InsertDiff()
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            ls_SQL = " Select ISNULL(Max(Rev),'') Rev From ForecastDaily Where Period = '" & Format(dtPOPeriod.Value, "yyyy-MM") & "-01' "
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                If ls_rev <> "" Then
                    ls_SQL = "Delete ForecastDailyDiff Where Period = '" & Format(dtPOPeriod.Value, "yyyy-MM") & "-01' " & vbCrLf & _
                             "Exec sp_InsertDiff '" & Format(dtPOPeriod.Value, "yyyy-MM") & "-01','" & ls_rev & "' "
                End If
            End If
            ...
            With ws
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    For i = 0 To ds.Tables(0).Rows.Count - 1
                        ...
                        .Cells("F" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F1"))
                        .Cells("G" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F2"))
                        .Cells("H" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F3"))
                        .Cells("I" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F4"))
                        .Cells("J" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F5"))
                        .Cells("K" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F6"))
                        .Cells("L" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F7"))
                        .Cells("M" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F8"))
                        .Cells("N" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F9"))
                        .Cells("O" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F10"))
                        .Cells("P" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F11"))
                        .Cells("Q" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F12"))
                        .Cells("R" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F13"))
                        .Cells("S" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F14"))
                        .Cells("T" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F15"))
                        .Cells("U" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F16"))
                        .Cells("V" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F17"))
                        .Cells("W" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F18"))
                        .Cells("X" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F19"))
                        .Cells("Y" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F20"))
                        .Cells("Z" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F21"))
                        .Cells("AA" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F22"))
                        .Cells("AB" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F23"))
                        .Cells("AC" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F24"))
                        .Cells("AD" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F25"))
                        .Cells("AE" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F26"))
                        .Cells("AF" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F27"))
                        .Cells("AG" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F28"))
                        .Cells("AH" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F29"))
                        .Cells("AI" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F30"))
                        .Cells("AJ" & i + 10).Value = Trim(ds.Tables(0).Rows(i)("F31"))
                    Next
                End If
    ...
    Private Function uf_Sql() As String
        ...
        ls_SQL = ls_SQL + " Select * From IBD " & vbCrLf & _
                          ...
                          "  ,F1 = Case When ISNULL(e.F1,0) <> 0 Then case when ISNULL(a.F1,0) = 0 then 0 else ((a.F1-e.F1)/e.F1)*100 end   " & vbCrLf & _
                  "  		    When ISNULL(d.F1,0) <> 0 Then case when ISNULL(a.F1,0) = 0 then 0 else ((a.F1-d.F1)/d.F1)*100 end   " & vbCrLf & _
                  "  		    When ISNULL(c.F1,0) <> 0 Then case when ISNULL(a.F1,0) = 0 then 0 else ((a.F1-c.F1)/c.F1)*100 end   " & vbCrLf & _
                  "  		    When ISNULL(b.F1,0) <> 0 Then case when ISNULL(a.F1,0) = 0 then 0 else ((a.F1-b.F1)/b.F1)*100 end  " & vbCrLf & _
                  "  		    ELSE 0 " & vbCrLf & _
                  "  	  END  " & vbCrLf & _
                  "  ,F2 = Case When ISNULL(e.F2,0) <> 0 Then case when ISNULL(a.F2,0) = 0 then 0 else ((a.F2-e.F2)/e.F2)*100 end   " & vbCrLf & _
                  "  		    When ISNULL(d.F2,0) <> 0 Then case when ISNULL(a.F2,0) = 0 then 0 else ((a.F2-d.F2)/d.F2)*100 end   " & vbCrLf & _
                  "  		    When ISNULL(c.F2,0) <> 0 Then case when ISNULL(a.F2,0) = 0 then 0 else ((a.F2-c.F2)/c.F2)*100 end   " & vbCrLf & _
                  "  		    When ISNULL(b.F2,0) <> 0 Then case when ISNULL(a.F2,0) = 0 then 0 else ((a.F2-b.F2)/b.F2)*100 end  " & vbCrLf & _
                  "  		    ELSE 0  " & vbCrLf

        ls_SQL = ls_SQL + "  	  END " & vbCrLf & _
                          "  ,F3 = Case When ISNULL(e.F3,0) <> 0 Then case when ISNULL(a.F3,0) = 0 then 0 else ((a.F3-e.F3)/e.F3)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F3,0) <> 0 Then case when ISNULL(a.F3,0) = 0 then 0 else ((a.F3-d.F3)/d.F3)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(c.F3,0) <> 0 Then case when ISNULL(a.F3,0) = 0 then 0 else ((a.F3-c.F3)/c.F3)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(b.F3,0) <> 0 Then case when ISNULL(a.F3,0) = 0 then 0 else ((a.F3-b.F3)/b.F3)*100 end  " & vbCrLf & _
                          "  		    ELSE 0  " & vbCrLf & _
                          "  	  END  " & vbCrLf & _
                          "  ,F4 = Case When ISNULL(e.F4,0) <> 0 Then case when ISNULL(a.F4,0) = 0 then 0 else ((a.F4-e.F4)/e.F4)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F4,0) <> 0 Then case when ISNULL(a.F4,0) = 0 then 0 else ((a.F4-d.F4)/d.F4)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(c.F4,0) <> 0 Then case when ISNULL(a.F4,0) = 0 then 0 else ((a.F4-c.F4)/c.F4)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(b.F4,0) <> 0 Then case when ISNULL(a.F4,0) = 0 then 0 else ((a.F4-b.F4)/b.F4)*100 end  " & vbCrLf

        ls_SQL = ls_SQL + "  		    ELSE 0 " & vbCrLf & _
                          "  	  END  " & vbCrLf & _
                          "  ,F5 = Case When ISNULL(e.F5,0) <> 0 Then case when ISNULL(a.F5,0) = 0 then 0 else ((a.F5-e.F5)/e.F5)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F5,0) <> 0 Then case when ISNULL(a.F5,0) = 0 then 0 else ((a.F5-d.F5)/d.F5)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(c.F5,0) <> 0 Then case when ISNULL(a.F5,0) = 0 then 0 else ((a.F5-c.F5)/c.F5)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(b.F5,0) <> 0 Then case when ISNULL(a.F5,0) = 0 then 0 else ((a.F5-b.F5)/b.F5)*100 end  " & vbCrLf & _
                          "  		    ELSE 0 " & vbCrLf & _
                          "  	  END  " & vbCrLf & _
                          "  ,F6 = Case When ISNULL(e.F6,0) <> 0 Then case when ISNULL(a.F6,0) = 0 then 0 else ((a.F6-e.F6)/e.F6)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F6,0) <> 0 Then case when ISNULL(a.F6,0) = 0 then 0 else ((a.F6-d.F6)/d.F6)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(c.F6,0) <> 0 Then case when ISNULL(a.F6,0) = 0 then 0 else ((a.F6-c.F6)/c.F6)*100 end   " & vbCrLf

        ls_SQL = ls_SQL + "  		    When ISNULL(b.F6,0) <> 0 Then case when ISNULL(a.F6,0) = 0 then 0 else ((a.F6-b.F6)/b.F6)*100 end  " & vbCrLf & _
                          "  		    ELSE 0 " & vbCrLf & _
                          "  	  END  " & vbCrLf & _
                          "  ,F7 = Case When ISNULL(e.F7,0) <> 0 Then case when ISNULL(a.F7,0) = 0 then 0 else ((a.F7-e.F7)/e.F7)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F7,0) <> 0 Then case when ISNULL(a.F7,0) = 0 then 0 else ((a.F7-d.F7)/d.F7)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(c.F7,0) <> 0 Then case when ISNULL(a.F7,0) = 0 then 0 else ((a.F7-c.F7)/c.F7)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(b.F7,0) <> 0 Then case when ISNULL(a.F7,0) = 0 then 0 else ((a.F7-b.F7)/b.F7)*100 end  " & vbCrLf & _
                          "  		    ELSE 0 " & vbCrLf & _
                          "  	  END  " & vbCrLf & _
                          "  ,F8 = Case When ISNULL(e.F8,0) <> 0 Then case when ISNULL(a.F8,0) = 0 then 0 else ((a.F8-e.F8)/e.F8)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F8,0) <> 0 Then case when ISNULL(a.F8,0) = 0 then 0 else ((a.F8-d.F8)/d.F8)*100 end   " & vbCrLf

        ls_SQL = ls_SQL + "  		    When ISNULL(c.F8,0) <> 0 Then case when ISNULL(a.F8,0) = 0 then 0 else ((a.F8-c.F8)/c.F8)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(b.F8,0) <> 0 Then case when ISNULL(a.F8,0) = 0 then 0 else ((a.F8-b.F8)/b.F8)*100 end  " & vbCrLf & _
                          "  		    ELSE 0 " & vbCrLf & _
                          " 	  END " & vbCrLf & _
                          "  ,F9 = Case When ISNULL(e.F9,0) <> 0 Then case when ISNULL(a.F9,0) = 0 then 0 else ((a.F9-e.F9)/e.F9)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F9,0) <> 0 Then case when ISNULL(a.F9,0) = 0 then 0 else ((a.F9-d.F9)/d.F9)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(c.F9,0) <> 0 Then case when ISNULL(a.F9,0) = 0 then 0 else ((a.F9-c.F9)/c.F9)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(b.F9,0) <> 0 Then case when ISNULL(a.F9,0) = 0 then 0 else ((a.F9-b.F9)/b.F9)*100 end  " & vbCrLf & _
                          "  		    ELSE 0 " & vbCrLf & _
                          "  	  END " & vbCrLf & _
                          "  ,F10 = Case When ISNULL(e.F10,0) <> 0 Then case when ISNULL(a.F10,0) = 0 then 0 else ((a.F10-e.F10)/e.F10)*100 end   " & vbCrLf

        ls_SQL = ls_SQL + "  		    When ISNULL(d.F10,0) <> 0 Then case when ISNULL(a.F10,0) = 0 then 0 else ((a.F10-d.F10)/d.F10)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(c.F10,0) <> 0 Then case when ISNULL(a.F10,0) = 0 then 0 else ((a.F10-c.F10)/c.F10)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(b.F10,0) <> 0 Then case when ISNULL(a.F10,0) = 0 then 0 else ((a.F10-b.F10)/b.F10)*100 end  " & vbCrLf & _
                          "  		    ELSE 0 " & vbCrLf & _
                          "  	  END " & vbCrLf & _
                          "  ,F11 = Case When ISNULL(e.F11,0) <> 0 Then case when ISNULL(a.F11,0) = 0 then 0 else ((a.F11-e.F11)/e.F11)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F11,0) <> 0 Then case when ISNULL(a.F11,0) = 0 then 0 else ((a.F11-d.F11)/d.F11)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(c.F11,0) <> 0 Then case when ISNULL(a.F11,0) = 0 then 0 else ((a.F11-c.F11)/c.F11)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(b.F11,0) <> 0 Then case when ISNULL(a.F11,0) = 0 then 0 else ((a.F11-b.F11)/b.F11)*100 end  " & vbCrLf & _
                          "  		    ELSE 0 " & vbCrLf & _
                          "  	  END " & vbCrLf

        ls_SQL = ls_SQL + "  ,F12 = Case When ISNULL(e.F12,0) <> 0 Then case when ISNULL(a.F12,0) = 0 then 0 else ((a.F12-e.F12)/e.F12)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F12,0) <> 0 Then case when ISNULL(a.F12,0) = 0 then 0 else ((a.F12-d.F12)/d.F12)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(c.F12,0) <> 0 Then case when ISNULL(a.F12,0) = 0 then 0 else ((a.F12-c.F12)/c.F12)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(b.F12,0) <> 0 Then case when ISNULL(a.F12,0) = 0 then 0 else ((a.F12-b.F12)/b.F12)*100 end  " & vbCrLf & _
                          "  		    ELSE 0 " & vbCrLf & _
                          "  	  END " & vbCrLf & _
                          "  ,F13 = Case When ISNULL(e.F13,0) <> 0 Then case when ISNULL(a.F13,0) = 0 then 0 else ((a.F13-e.F13)/e.F13)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F13,0) <> 0 Then case when ISNULL(a.F13,0) = 0 then 0 else ((a.F13-d.F13)/d.F13)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(c.F13,0) <> 0 Then case when ISNULL(a.F13,0) = 0 then 0 else ((a.F13-c.F13)/c.F13)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(b.F13,0) <> 0 Then case when ISNULL(a.F13,0) = 0 then 0 else ((a.F13-b.F13)/b.F13)*100 end  " & vbCrLf & _
                          "  		    ELSE 0 " & vbCrLf

        ls_SQL = ls_SQL + "  	  END " & vbCrLf & _
                          "  ,F14 = Case When ISNULL(e.F14,0) <> 0 Then case when ISNULL(a.F14,0) = 0 then 0 else ((a.F14-e.F14)/e.F14)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F14,0) <> 0 Then case when ISNULL(a.F14,0) = 0 then 0 else ((a.F14-d.F14)/d.F14)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(c.F14,0) <> 0 Then case when ISNULL(a.F14,0) = 0 then 0 else ((a.F14-c.F14)/c.F14)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(b.F14,0) <> 0 Then case when ISNULL(a.F14,0) = 0 then 0 else ((a.F14-b.F14)/b.F14)*100 end  " & vbCrLf & _
                          "  		    ELSE 0 " & vbCrLf & _
                          "  	  END " & vbCrLf & _
                          "  ,F15 = Case When ISNULL(e.F15,0) <> 0 Then case when ISNULL(a.F15,0) = 0 then 0 else ((a.F15-e.F15)/e.F15)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F15,0) <> 0 Then case when ISNULL(a.F15,0) = 0 then 0 else ((a.F15-d.F15)/d.F15)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(c.F15,0) <> 0 Then case when ISNULL(a.F15,0) = 0 then 0 else ((a.F15-c.F15)/c.F15)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(b.F15,0) <> 0 Then case when ISNULL(a.F15,0) = 0 then 0 else ((a.F15-b.F15)/b.F15)*100 end  " & vbCrLf

        ls_SQL = ls_SQL + "  		    ELSE 0 " & vbCrLf & _
                          "  	  END " & vbCrLf & _
                          "  ,F16 = Case When ISNULL(e.F16,0) <> 0 Then case when ISNULL(a.F16,0) = 0 then 0 else ((a.F16-e.F16)/e.F16)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F16,0) <> 0 Then case when ISNULL(a.F16,0) = 0 then 0 else ((a.F16-d.F16)/d.F16)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(c.F16,0) <> 0 Then case when ISNULL(a.F16,0) = 0 then 0 else ((a.F16-c.F16)/c.F16)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(b.F16,0) <> 0 Then case when ISNULL(a.F16,0) = 0 then 0 else ((a.F16-b.F16)/b.F16)*100 end  " & vbCrLf & _
                          "  		    ELSE 0 " & vbCrLf & _
                          "  	  END " & vbCrLf & _
                          "  ,F17 = Case When ISNULL(e.F17,0) <> 0 Then case when ISNULL(a.F17,0) = 0 then 0 else ((a.F17-e.F17)/e.F17)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F17,0) <> 0 Then case when ISNULL(a.F17,0) = 0 then 0 else ((a.F17-d.F17)/d.F17)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(c.F17,0) <> 0 Then case when ISNULL(a.F17,0) = 0 then 0 else ((a.F17-c.F17)/c.F17)*100 end   " & vbCrLf

        ls_SQL = ls_SQL + "  		    When ISNULL(b.F17,0) <> 0 Then case when ISNULL(a.F17,0) = 0 then 0 else ((a.F17-b.F17)/b.F17)*100 end  " & vbCrLf & _
                          "  		    ELSE 0 " & vbCrLf & _
                          "  	  END " & vbCrLf & _
                          "  ,F18 = Case When ISNULL(e.F18,0) <> 0 Then case when ISNULL(a.F18,0) = 0 then 0 else ((a.F18-e.F18)/e.F18)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F18,0) <> 0 Then case when ISNULL(a.F18,0) = 0 then 0 else ((a.F18-d.F18)/d.F18)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(c.F18,0) <> 0 Then case when ISNULL(a.F18,0) = 0 then 0 else ((a.F18-c.F18)/c.F18)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(b.F18,0) <> 0 Then case when ISNULL(a.F18,0) = 0 then 0 else ((a.F18-b.F18)/b.F18)*100 end  " & vbCrLf & _
                          "  		    ELSE 0 " & vbCrLf & _
                          "  	  END " & vbCrLf & _
                          "  ,F19 = Case When ISNULL(e.F19,0) <> 0 Then case when ISNULL(a.F19,0) = 0 then 0 else ((a.F19-e.F19)/e.F19)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F19,0) <> 0 Then case when ISNULL(a.F19,0) = 0 then 0 else ((a.F19-d.F19)/d.F19)*100 end   " & vbCrLf

        ls_SQL = ls_SQL + "  		    When ISNULL(c.F19,0) <> 0 Then case when ISNULL(a.F19,0) = 0 then 0 else ((a.F19-c.F19)/c.F19)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(b.F19,0) <> 0 Then case when ISNULL(a.F19,0) = 0 then 0 else ((a.F19-b.F19)/b.F19)*100 end  " & vbCrLf & _
                          "  		    ELSE 0 " & vbCrLf & _
                          "  	  END " & vbCrLf & _
                          "  ,F20 = Case When ISNULL(e.F20,0) <> 0 Then case when ISNULL(a.F20,0) = 0 then 0 else ((a.F20-e.F20)/e.F20)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F20,0) <> 0 Then case when ISNULL(a.F20,0) = 0 then 0 else ((a.F20-d.F20)/d.F20)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(c.F20,0) <> 0 Then case when ISNULL(a.F20,0) = 0 then 0 else ((a.F20-c.F20)/c.F20)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(b.F20,0) <> 0 Then case when ISNULL(a.F20,0) = 0 then 0 else ((a.F20-b.F20)/b.F20)*100 end  " & vbCrLf & _
                          "  		    ELSE 0 " & vbCrLf & _
                          "  	  END " & vbCrLf & _
                          "  ,F21 = Case When ISNULL(e.F21,0) <> 0 Then case when ISNULL(a.F21,0) = 0 then 0 else ((a.F21-e.F21)/e.F21)*100 end   " & vbCrLf

        ls_SQL = ls_SQL + "  		    When ISNULL(d.F21,0) <> 0 Then case when ISNULL(a.F21,0) = 0 then 0 else ((a.F21-d.F21)/d.F21)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(c.F21,0) <> 0 Then case when ISNULL(a.F21,0) = 0 then 0 else ((a.F21-c.F21)/c.F21)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(b.F21,0) <> 0 Then case when ISNULL(a.F21,0) = 0 then 0 else ((a.F21-b.F21)/b.F21)*100 end  " & vbCrLf & _
                          "  		    ELSE 0 " & vbCrLf & _
                          "  	  END  " & vbCrLf & _
                          "  ,F22 = Case When ISNULL(e.F22,0) <> 0 Then case when ISNULL(a.F22,0) = 0 then 0 else ((a.F22-e.F22)/e.F22)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F22,0) <> 0 Then case when ISNULL(a.F22,0) = 0 then 0 else ((a.F22-d.F22)/d.F22)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(c.F22,0) <> 0 Then case when ISNULL(a.F22,0) = 0 then 0 else ((a.F22-c.F22)/c.F22)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(b.F22,0) <> 0 Then case when ISNULL(a.F22,0) = 0 then 0 else ((a.F22-b.F22)/b.F22)*100 end  " & vbCrLf & _
                          "  		    ELSE 0 " & vbCrLf & _
                          "  	  END " & vbCrLf

        ls_SQL = ls_SQL + "  ,F23 = Case When ISNULL(e.F23,0) <> 0 Then case when ISNULL(a.F23,0) = 0 then 0 else ((a.F23-e.F23)/e.F23)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F23,0) <> 0 Then case when ISNULL(a.F23,0) = 0 then 0 else ((a.F23-d.F23)/d.F23)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(c.F23,0) <> 0 Then case when ISNULL(a.F23,0) = 0 then 0 else ((a.F23-c.F23)/c.F23)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(b.F23,0) <> 0 Then case when ISNULL(a.F23,0) = 0 then 0 else ((a.F23-b.F23)/b.F23)*100 end  " & vbCrLf & _
                          "  		    ELSE 0 " & vbCrLf & _
                          "  	  END " & vbCrLf & _
                          "  ,F24 = Case When ISNULL(e.F24,0) <> 0 Then case when ISNULL(a.F24,0) = 0 then 0 else ((a.F24-e.F24)/e.F24)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F24,0) <> 0 Then case when ISNULL(a.F24,0) = 0 then 0 else ((a.F24-d.F24)/d.F24)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(c.F24,0) <> 0 Then case when ISNULL(a.F24,0) = 0 then 0 else ((a.F24-c.F24)/c.F24)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(b.F24,0) <> 0 Then case when ISNULL(a.F24,0) = 0 then 0 else ((a.F24-b.F24)/b.F24)*100 end  " & vbCrLf & _
                          "  		    ELSE 0 " & vbCrLf

        ls_SQL = ls_SQL + "  	  END " & vbCrLf & _
                          "  ,F25 = Case When ISNULL(e.F25,0) <> 0 Then case when ISNULL(a.F25,0) = 0 then 0 else ((a.F25-e.F25)/e.F25)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F25,0) <> 0 Then case when ISNULL(a.F25,0) = 0 then 0 else ((a.F25-d.F25)/d.F25)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(c.F25,0) <> 0 Then case when ISNULL(a.F25,0) = 0 then 0 else ((a.F25-c.F25)/c.F25)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(b.F25,0) <> 0 Then case when ISNULL(a.F25,0) = 0 then 0 else ((a.F25-b.F25)/b.F25)*100 end  " & vbCrLf & _
                          "  		    ELSE 0 " & vbCrLf & _
                          "  	  END " & vbCrLf & _
                          "  ,F26 = Case When ISNULL(e.F26,0) <> 0 Then case when ISNULL(a.F26,0) = 0 then 0 else ((a.F26-e.F26)/e.F26)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F26,0) <> 0 Then case when ISNULL(a.F26,0) = 0 then 0 else ((a.F26-d.F26)/d.F26)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(c.F26,0) <> 0 Then case when ISNULL(a.F26,0) = 0 then 0 else ((a.F26-c.F26)/c.F26)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(b.F26,0) <> 0 Then case when ISNULL(a.F26,0) = 0 then 0 else ((a.F26-b.F26)/b.F26)*100 end  " & vbCrLf

        ls_SQL = ls_SQL + "  		    ELSE 0 " & vbCrLf & _
                          "  	  END " & vbCrLf & _
                          "  ,F27 = Case When ISNULL(e.F27,0) <> 0 Then case when ISNULL(a.F27,0) = 0 then 0 else ((a.F27-e.F27)/e.F27)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F27,0) <> 0 Then case when ISNULL(a.F27,0) = 0 then 0 else ((a.F27-d.F27)/d.F27)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(c.F27,0) <> 0 Then case when ISNULL(a.F27,0) = 0 then 0 else ((a.F27-c.F27)/c.F27)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(b.F27,0) <> 0 Then case when ISNULL(a.F27,0) = 0 then 0 else ((a.F27-b.F27)/b.F27)*100 end  " & vbCrLf & _
                          "  		    ELSE 0 " & vbCrLf & _
                          "  	  END " & vbCrLf & _
                          "  ,F28 = Case When ISNULL(e.F28,0) <> 0 Then case when ISNULL(a.F28,0) = 0 then 0 else ((a.F28-e.F28)/e.F28)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F28,0) <> 0 Then case when ISNULL(a.F28,0) = 0 then 0 else ((a.F28-d.F28)/d.F28)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(c.F28,0) <> 0 Then case when ISNULL(a.F28,0) = 0 then 0 else ((a.F28-c.F28)/c.F28)*100 end   " & vbCrLf

        ls_SQL = ls_SQL + "  		    When ISNULL(b.F28,0) <> 0 Then case when ISNULL(a.F28,0) = 0 then 0 else ((a.F28-b.F28)/b.F28)*100 end  " & vbCrLf & _
                          "  		    ELSE 0 " & vbCrLf & _
                          "  	  END " & vbCrLf & _
                          "  ,F29 = Case When ISNULL(e.F29,0) <> 0 Then case when ISNULL(a.F29,0) = 0 then 0 else ((a.F29-e.F29)/e.F29)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F29,0) <> 0 Then case when ISNULL(a.F29,0) = 0 then 0 else ((a.F29-d.F29)/d.F29)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(c.F29,0) <> 0 Then case when ISNULL(a.F29,0) = 0 then 0 else ((a.F29-c.F29)/c.F29)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(b.F29,0) <> 0 Then case when ISNULL(a.F29,0) = 0 then 0 else ((a.F29-b.F29)/b.F29)*100 end  " & vbCrLf & _
                          "  		    ELSE 0 " & vbCrLf & _
                          "  	  END " & vbCrLf & _
                          "  ,F30 = Case When ISNULL(e.F30,0) <> 0 Then case when ISNULL(a.F30,0) = 0 then 0 else ((a.F30-e.F30)/e.F30)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F30,0) <> 0 Then case when ISNULL(a.F30,0) = 0 then 0 else ((a.F30-d.F30)/d.F30)*100 end   " & vbCrLf

        ls_SQL = ls_SQL + "  		    When ISNULL(c.F30,0) <> 0 Then case when ISNULL(a.F30,0) = 0 then 0 else ((a.F30-c.F30)/c.F30)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(b.F30,0) <> 0 Then case when ISNULL(a.F30,0) = 0 then 0 else ((a.F30-b.F30)/b.F30)*100 end  " & vbCrLf & _
                          "  		    ELSE 0 " & vbCrLf & _
                          "  	  END " & vbCrLf & _
                          "  ,F31 = Case When ISNULL(e.F31,0) <> 0 Then case when ISNULL(a.F31,0) = 0 then 0 else ((a.F31-e.F31)/e.F31)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(d.F31,0) <> 0 Then case when ISNULL(a.F31,0) = 0 then 0 else ((a.F31-d.F31)/d.F31)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(c.F31,0) <> 0 Then case when ISNULL(a.F31,0) = 0 then 0 else ((a.F31-c.F31)/c.F31)*100 end   " & vbCrLf & _
                          "  		    When ISNULL(b.F31,0) <> 0 Then case when ISNULL(a.F31,0) = 0 then 0 else ((a.F31-b.F31)/b.F31)*100 end  " & vbCrLf & _
                          "  		    ELSE 0 " & vbCrLf & _
                          "  	  END " & vbCrLf & _
                          "  "
