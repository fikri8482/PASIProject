<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="ReceivingUpload.aspx.vb" Inherits="AffiliateSystem.ReceivingUpload" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
            ...
            <td colspan="3" align="left" valign="top" height="220">
                <dx:ASPxGridView ID="grid" runat="server" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="2" Caption="SURAT JALAN NO." FieldName="SuratJalanNo" Width="120px">                            
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="3" Caption="AFFILIATE" FieldName="AffiliateID" Width="90px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="4" Caption="SUPPLIER" FieldName="SupplierID" Width="0px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="6" Caption="KANBAN NO." FieldName="KanbanNo" Width="100px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="7" Caption="PART NO." FieldName="PartNo" Width="90px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="8" Caption="PART NAME" FieldName="PartName" Width="180px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>                        
                        <dx:GridViewDataTextColumn VisibleIndex="9" Caption="GOOD RECEIVING QTY" FieldName="RecQty" Width="80px">
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="10" Caption="DEFECT QTY" FieldName="DefectQty" Width="80px">
                            <PropertiesTextEdit DisplayFormatString="{0:n0}">
                            </PropertiesTextEdit>
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="49" Caption="Remarks" FieldName="ErrorCls" Width="380px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>                        
    ...
    <dx:ASPxPopupControl ID="popUp2" runat="server" CloseAction="CloseButton" Modal="True"
        ...
        HeaderText="[I01] UPLOAD RECEIVING CONFIRMATION" AllowDragging="True" 
        ...
        <table style="width:100%">
            <tr>
                <td align="left" >
                    <dx:aspxlabel ID="ASPxLabel28" runat="server" Text="This Surat Jalan No Already exists, Do you want to Replace?" Font-Names="Verdana" Width="100%" Font-Size="8pt" >
                    </dx:aspxlabel>
                </td>
                <td align="right">
                </td>
            ...
            <tr>
                <td align="right">
                    <dx:aspxbutton ID="BtnCancelPU2" runat="server" Text="Cancel" Font-Names="Tahoma"
                        ...
                        lblInfo.SetText('[99] Cancel Process Upload Successfull');
                        }" />
                    </dx:aspxbutton>
                </td>
                <td align="right">
                 <dx:ASPxButton ID="BtnDeleteUp2" runat="server" Text="ACCEPT" Font-Names="Tahoma"
                    Width="85px" Font-Size="8pt" TabIndex="2" AutoPostBack="False" UseSubmitBehavior="False" ClientInstanceName="BtnDeleteUp2" >
                      <ClientSideEvents Click="function(s, e) {
                      popUp2.Hide();
                      grid.PerformCallback('saveReplace');
                    }" />
                </dx:ASPxButton>
                </td>
            </tr>
