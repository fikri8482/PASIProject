...
#Region "Procedures"
    Private Sub up_Initialize()
        Dim script As String = _
            ...
            "   txtAffiliateName.SetText('" & Trim(Session("AffiliateID")) & "'); " & vbCrLf & _
    ...
    Private Sub up_GridLoad()
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            cboAffiliateCode.Text = Session("AffiliateID")
            ...
            'ls_SQL = ls_SQL + "   	,POM.PASISendAffiliateDate   " & vbCrLf & _
            '                  "   	,POD.PartNo   " & vbCrLf & _
            '                  "   	,MP.PartName   " & vbCrLf & _
            '                  "   	,QtyPO = ISNULL(POD.POQty,0)   " & vbCrLf & _
            '                  "  	,MPM.QtyBox  " & vbCrLf & _
            '                  "  	,MPM.BoxPallet  " & vbCrLf & _
            '                  "  	,VolumePallet = (POD.POQty/MPM.QtyBox)/MPM.BoxPallet  " & vbCrLf & _
            '                  "   	,ETDSupp = ES.ETDSupplier   " & vbCrLf & _
            '                  "   	,ETAAff = KM.KanbanDate   " & vbCrLf & _
            '                  "   	,PASIDeliveryDate = DOM.DeliveryDate   " & vbCrLf & _
            '                  "   	,PASISuratJalanNo = DOM.SuratJalanNo " & vbCrLf

            'ls_SQL = ls_SQL + " 	,PASIInvoiceNo = DOM.SuratJalanNo   " & vbCrLf & _
            ...
            '                  "  	,Remaining = (ISNULL(POD.POQty,0) -  " & vbCrLf & _
            '                  "      ( " & vbCrLf & _
            ...
            ls_SQL = "  SELECT *  " & vbCrLf & _
                     "  ,StatusPO = CASE WHEN Remaining1 > 0 THEN 'OVER'  " & vbCrLf & _
                     "  WHEN Remaining1 < 0 THEN 'OPEN'  " & vbCrLf & _
                     "  ELSE 'CLOSE' END  " & vbCrLf & _
                     "  FROM (  " & vbCrLf & _
                     "  SELECT    " & vbCrLf & _
                     "   	POM.Period   " & vbCrLf & _
            ...
            ls_SQL = ls_SQL + "   	,POM.PASISendAffiliateDate   " & vbCrLf & _
                              ...
                              "  	,MPM.BoxPallet  " & vbCrLf & _
                              "  	,VolumePallet = (POD.POQty/ISNULL(POD.POQtyBox,MPM.QtyBox))/MPM.BoxPallet  " & vbCrLf & _
                              "   	,ETDSupp = ES.ETDSupplier   " & vbCrLf & _
                              "   	,ETAAff = KM.KanbanDate   " & vbCrLf & _
                              "   	,PASIDeliveryDate = DOM.DeliveryDate   " & vbCrLf & _
                              "   	,PASISuratJalanNo = DOM.SuratJalanNo " & vbCrLf
    ...
    Private Function GetSummaryOutStanding() As DataTable
        ...
        Try
            ...
            Using cn As New SqlConnection(clsGlobal.ConnectionString)
                ...
                '                  "   	,ETAAff = KM.KanbanDate   " & vbCrLf & _
                '                  "   	,PASIDeliveryDate = DOM.DeliveryDate   " & vbCrLf & _
                '                  "   	,PASISuratJalanNo = RTRIM(DOM.SuratJalanNo) " & vbCrLf

                'ls_sql = ls_sql + " 	,PASIInvoiceNo = RTRIM(DOM.SuratJalanNo) " & vbCrLf & _
                '                  " 	,PASIDeliveryQty = DOD.DOQty " & vbCrLf & _
                '                  "     ,AffiliateReceiveDate = RM.ReceiveDate " & vbCrLf & _
                '                  "     ,AffiliateReceiveQty = ISNULL(RD.RecQty,0) " & vbCrLf & _
                '                  "  	,Remaining = (ISNULL(POD.POQty,0) -  " & vbCrLf & _
                ...
                ls_sql = "  SELECT Period,PONo,AffiliateID,SupplierID,POKanban,PASISendAffiliateDate,PartNo,PartName,QtyPO,QtyBox,BoxPallet  " & vbCrLf & _
                         " ,VolumePallet,ETDSupp,ETAAff,PASIDeliveryDate,PASISuratJalanNo,PASIInvoiceNo,PASIDeliveryQty,AffiliateReceiveDate,AffiliateReceiveQty,Remaining" & vbCrLf & _
                    "  ,StatusPO = CASE WHEN Remaining1 > 0 THEN 'OVER'  " & vbCrLf & _
                    "  WHEN Remaining1 < 0 THEN 'OPEN'  " & vbCrLf & _
                    "  ELSE 'CLOSE' END  " & vbCrLf & _
                    "  FROM (  " & vbCrLf & _
