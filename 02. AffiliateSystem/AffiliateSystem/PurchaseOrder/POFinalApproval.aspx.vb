...
#Region "PROCEDURE"
    ...
    Private Sub bindData()
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            ls_SQL = ls_SQL + " 		inner join MS_Parts c on b.PartNo = c.PartNo " & vbCrLf & _
                              ...
                              " 		where a.PONo = '" & cboPartNo.Text & "' and a.AffiliateID = '" & Session("AffiliateID") & "' and a.SupplierID = '" & Session("SupplierID") & "' --and b.POQty > 0 " & pWhereKanban & "" & vbCrLf & _
                              " 	)tb1b " & vbCrLf & _
                              " )tbl1 " & vbCrLf & _
                              " left join " & vbCrLf & _
                              " ( " & vbCrLf & _
                              ...
                              " 		f.MOQ, f.QtyBox, c.Maker, b.POQty, 0 POQtyOld, "
            ...
            ls_SQL = ls_SQL + "  		0 DeliveryD6Old, 0 DeliveryD7Old, 0 DeliveryD8Old, 0 DeliveryD9Old, 0 DeliveryD10Old,  " & vbCrLf & _
                              ...
                              " 	left join MS_PartMapping f on b.AffiliateID = f.AffiliateID and b.SupplierID = f.SupplierID and b.PartNo = f.PartNo " & vbCrLf

            ls_SQL = ls_SQL + " 	where a.PONo = '" & cboPartNo.Text & "' and a.AffiliateID = '" & Session("AffiliateID") & "' and a.SupplierID = '" & Session("SupplierID") & "' --and b.POQty > 0 " & vbCrLf & _
                              " 	union all " & vbCrLf & _
                              " 	select  " & vbCrLf & _
            ...
            ls_SQL = ls_SQL + " 		from Affiliate_Master a " & vbCrLf & _
                              ...
                              " 		'' PartNo, b.PartNo PartNo1, '' PartName, ''KanbanCls, '' UnitDesc, 0 MOQ, 0 QtyBox, c.Maker, b.POQty, b.POQtyOld, " & vbCrLf
            ...
            ls_SQL = ls_SQL + " )tbl2 on tbl2.AffiliateName = tbl1.AffiliateName and tbl1.PartNo = tbl2.PartNo1 and tbl1.NoUrutDesc = tbl2.NoUrutDesc " & vbCrLf & _
                              " " & pWhereDifference & " " & vbCrLf & _
                              " ORDER BY PartNo1, tbl1.NoUrutDesc, NoUrut"
    ...
    Private Sub uf_Approve(ByVal pKanbanCls As String)
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            Using sqlTran As SqlTransaction = sqlConn.BeginTransaction("AffiliateMaster")
                ls_sql = " Update PO_Master set FinalApproveDate = getdate(), FinalApproveUser = '" & Session("UserID") & "', CreateKanbanCls = '1'" & vbCrLf & _
                            " WHERE AffiliateID = '" & Session("AffiliateID") & "' and PONo = '" & cboPartNo.Text & "' and SupplierID = '" & Session("SupplierID") & "'" & vbCrLf
