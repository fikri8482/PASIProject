...
#Region "FORM EVENTS"
    ...
    Private Sub grid_CellEditorInitialize(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridView.ASPxGridViewEditorEventArgs) Handles grid.CellEditorInitialize
        If (e.Column.FieldName = "NoUrut" Or e.Column.FieldName = "PartNo" Or e.Column.FieldName = "PartName" _
             Or e.Column.FieldName = "UnitDesc" Or e.Column.FieldName = "MinOrderQty" _
             Or e.Column.FieldName = "KanbanCls" Or e.Column.FieldName = "POQty" Or e.Column.FieldName = "PONo" Or e.Column.FieldName = "QtyBox" _
...
EndProcedure:
    ...
    Private Sub ButtonApprove_Callback(ByVal source As Object, ByVal e As DevExpress.Web.ASPxCallback.CallbackEventArgs) Handles ButtonApprove.Callback
        ...
        '        'sendEmail()
        '        'e..Attributes.Add("onclick", "event.cancelBubble = true")
        '        ButtonApprove.Attributes.Add("onclick", "document.body.style.cursor = 'wait';")
        '        btnApprove.Text = "APPROVE"
        '        If sendEmailccPASI() = True Then
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            Using sqlTran As SqlTransaction = sqlConn.BeginTransaction("item_code")
                ...
                For iLoop = 0 To a - 1
                    ...
                    ls_Forecast1 = Trim(e.UpdateValues(iLoop).NewValues("ForecastN1").ToString())
                    ls_Forecast2 = Trim(e.UpdateValues(iLoop).NewValues("ForecastN2").ToString())
                    ls_Forecast3 = Trim(e.UpdateValues(iLoop).NewValues("ForecastN3").ToString())
                    ...
                    If Session("mode") = "New" Then
                        ...
                        ls_SQL = ls_SQL + "            ,'" & ls_POQty & "' " & vbCrLf & _
                                          "            ,'" & ls_D1 & "' " & vbCrLf & _
                                          "            ,'" & ls_D2 & "' " & vbCrLf & _
                                          "            ,'" & ls_D3 & "' "
                        ...
                        If ls_Active = "1" Then
                            ...
                            Else
                                ...
                                ls_SQL = ls_SQL + "       ,[DeliveryD26] = '" & ls_D26 & "' " & vbCrLf & _
                                                    ...
                                                    "       ,[ForecastN1] = '" & ls_Forecast1 & "' " & vbCrLf & _
                                                    "       ,[ForecastN2] = '" & ls_Forecast2 & "' " & vbCrLf & _
                                                    "       ,[ForecastN3] = '" & ls_Forecast3 & "' " & vbCrLf & _
...
#Region "PROCEDURE"
    ...
    Private Sub bindData()
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            ls_SQL = "SELECT AllowAccess, row_number() over (order by AllowAccess desc) as NoUrut, " & vbCrLf & _
                "PartNo, PartName, KanbanCls, UnitDesc, MinOrderQty, QtyBox, PONo, POQty, ForecastN1, ForecastN2, ForecastN3, " & vbCrLf & _
                ...
                "ISNULL(DeliveryD31,0) DeliveryD31, countPartNo, SupplierID, UnitCls, PODeliveryBy " & vbCrLf & _
                "FROM( " & vbCrLf & _
                "Select DISTINCT '0'AllowAccess, a.PartNo, a.PartName, " & vbCrLf & _
                "CASE a.KanbanCls WHEN '1' THEN 'YES' ELSE 'NO' END KanbanCls, " & vbCrLf & _
                "c.Description UnitDesc, b.MOQ MinOrderQty, b.QtyBox, '' PONo, 0 POQty, " & vbCrLf & _
                ...
                "NULL DeliveryD31, countPartNo, CASE countPartNo WHEN '1' THEN b.SupplierID ELSE '' END SupplierID, c.UnitCls, f.PODeliveryBy " & vbCrLf & _
                "FROM MS_Parts a " & vbCrLf & _
                "INNER JOIN MS_PartMapping b on b.PartNo = a.PartNo AND b.AffiliateID = '" & Session("AffiliateID") & "' " & vbCrLf & _
                ...
                "SELECT PartNo FROM PO_Master a " & vbCrLf & _
                "INNER JOIN PO_Detail b on a.AffiliateID = b.AffiliateID AND a.SupplierID = b.SupplierID AND a.PONo = b.PONo " & vbCrLf & _
                "WHERE a.PONo = '" & txtPONo.Text & "' AND a.AffiliateID = '" & Session("AffiliateID") & "' " & vbCrLf & _
                ")" & vbCrLf & _
                "UNION ALL " & vbCrLf & _
                "SELECT '1'AllowAccess, b.PartNo, c.PartName, " & vbCrLf & _
                "CASE b.KanbanCls WHEN '1' THEN 'YES' ELSE 'NO' END KanbanCls, " & vbCrLf & _
                "d.Description UnitDesc, e.MOQ, e.QtyBox, b.PONo, b.POQty, " & vbCrLf & _
                "ISNULL(ForecastN1,0) ForecastN1, ISNULL(ForecastN2,0) ForecastN2, ISNULL(ForecastN3,0) ForecastN3, " & vbCrLf & _
                "b.DeliveryD1 DeliveryD1, b.DeliveryD2 DeliveryD2, b.DeliveryD3 DeliveryD3, b.DeliveryD4 DeliveryD4, b.DeliveryD5 DeliveryD5, " & vbCrLf & _
                "b.DeliveryD6 DeliveryD6, b.DeliveryD7 DeliveryD7, b.DeliveryD8 DeliveryD8, b.DeliveryD9 DeliveryD9, b.DeliveryD10 DeliveryD10, " & vbCrLf & _
                ...
                "b.DeliveryD31 DeliveryD31, '1' countPartNo, a.SupplierID, d.UnitCls, f.PODeliveryBy " & vbCrLf & _
    ...
    Private Sub up_GridLoadWhenEventChange()
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            ls_SQL = " select top 0 '' AllowAccess, '' NoUrut, " & vbCrLf & _
                  " '' PartNo, '' PartName, '' KanbanCls,'' UnitDesc, '' MinOrderQty, '' QtyBox, '' PONo, 0 POQty, " & vbCrLf & _
                  ...
                  " 0 DeliveryD31, '' countPartNo, '' SupplierID, '' UnitCls, ''PODeliveryBy "
    ...
    Private Sub bindHeijunka()
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            ls_SQL = "declare @JlhHari numeric " & vbCrLf & _
                  ...
                  " 	PartNo, PartName, KanbanCls, UnitDesc, MinOrderQty, QtyBox, PONo, " & vbCrLf & _
            ...
            ls_SQL = ls_SQL + " 	ISNULL(DeliveryD31,0) DeliveryD31, countPartNo, SupplierID, UnitCls " & vbCrLf & _
                              " FROM " & vbCrLf & _
                              " ( " & vbCrLf & _
            ...
            ls_SQL = ls_SQL + " 	0 POQty,  " & vbCrLf & _
                              ...
                              " 	NULL DeliveryD21, NULL DeliveryD22, NULL DeliveryD23, NULL DeliveryD24, NULL DeliveryD25,  " & vbCrLf & _
                              " 	NULL DeliveryD26, NULL DeliveryD27, NULL DeliveryD28, NULL DeliveryD29, NULL DeliveryD30,  " & vbCrLf & _
                              " 	NULL DeliveryD31, countPartNo, case countPartNo when '1' then b.SupplierID else '' end SupplierID, c.UnitCls "
            ...
            ls_SQL = ls_SQL + "  	tgl1 DeliveryD1, tgl2 DeliveryD2, tgl3 DeliveryD3, tgl4 DeliveryD4, tgl5 DeliveryD5, " & vbCrLf & _
                              ...
                              "  	tgl31 DeliveryD31, countPartNo, case countPartNo when '1' then g.SupplierID else '' end SupplierID, d.UnitCls  " & vbCrLf & _
                              "  from  " & vbCrLf & _
                              " ( " & vbCrLf & _
    ...
    Private Sub sendEmailtoAffiliate()
        Try
            ...
            Dim EmailAddList As List(Of clsEmail) = clsEmailDB.GetEmailList(Session("AffiliateID"), "PASI", "", "0", "AffiliatePOTO", clsGlobal.ConnectionString)

            '1 CC Affiliate,'2 CC PASI,'3 CC & TO Supplier
            For iRow = 0 To EmailAddList.Count - 1
                Dim EmailAdd As clsEmail = EmailAddList(iRow)
                If EmailAdd.Flag = "AFF" Then
                    'Set From
                    fromEmail = EmailAdd.EmailFrom

                    'Set TO
                    If receiptEmail = "" Then
                        receiptEmail = EmailAdd.EmailFrom
                    Else
                        receiptEmail = receiptEmail & ";" & EmailAdd.EmailFrom
                    End If

                    'Set CC
                    If receiptCCEmail = "" Then
                        receiptCCEmail = EmailAdd.EmailCC
                    Else
                        receiptCCEmail = receiptCCEmail & ";" & EmailAdd.EmailCC
                    End If
                End If
            Next
            ...
            Dim EmailList As List(Of clsEmail) = clsEmailDB.GetSettingEmail(clsGlobal.ConnectionString)
            Dim Email As clsEmail = EmailList(0)

            mailMessage.Body = ls_Body
            mailMessage.IsBodyHtml = False
            Dim smtp As New SmtpClient
            smtp.Host = Trim(Email.smtpClient)
            If smtp.UseDefaultCredentials = True Then
                smtp.EnableSsl = True
            Else
                smtp.EnableSsl = False
                Dim myCredential As System.Net.NetworkCredential = New System.Net.NetworkCredential(Trim(Email.usernameSMTP), Trim(Email.PasswordSMTP))
                smtp.Credentials = myCredential
            End If

            smtp.Port = Trim(Email.portClient)
    ...
    'Private Function sendEmailccPASI() As Boolean
    '    Try
    '        Dim receiptEmail As String = ""
    '        Dim receiptCCEmail As String = ""
    '        Dim fromEmail As String = ""
    ...
    '        Dim ls_URl As String = "http://" & clsNotification.pub_ServerNamePASI & "/AffiliateOrder/AffiliateOrderDetail.aspx?id2=" & clsNotification.EncryptURL(txtPONo.Text.Trim) & _
    '            "&t1=" & clsNotification.EncryptURL(Session("AffiliateID")) & "&t2=" & clsNotification.EncryptURL(Session("SupplierID")) & _
    '            "&t3=" & clsNotification.EncryptURL(dtPeriodFrom.Value) & _
    ...
    '                fromEmail = EmailAdd.EmailFrom
    '            End If
    '            If EmailAdd.Flag = "PASI" Then
    '                'Set TO
    '                If receiptEmail = "" Then
    '                    receiptEmail = EmailAdd.EmailTo
    '                Else
    '                    receiptEmail = receiptEmail & ";" & EmailAdd.EmailTo
    '                End If
