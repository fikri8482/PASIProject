...
#Region "Function"
    ...
    Public Function FormatQty(ByVal pQty As String) As String
        ...
        Return FormatNumber(pQty, 0, TriState.True)
    End Function
    ...
    Public Function GetUrl(ByVal pMenuName As String) As String
        ...
        Using SqlConn As New SqlConnection(ConnectionString)
            ...
            ls_SQL = "SELECT MenuName FROM dbo.SC_UserMenu WHERE MenuDesc = '" & Trim(pMenuName) & "' and PASIMenu in ('0','2')"
    ...
    Public Function uf_Ceiling(ByVal value As Double, ByVal significance As Double) As Double
    ...
    Public Function Auth_UserUpdate(ByVal pUserID As String, ByVal pMenuID As String) As Boolean
        ...
        Using sqlConn As New SqlConnection(ConnectionString)
            ...
            Dim ls_SQL As String = "SELECT AllowUpdate FROM dbo.SC_UserPrivilege WHERE AppID = 'P01' AND UserID = '" & Trim(pUserID) & "' AND MenuID = '" & Trim(pMenuID) & "' AND UserCls = '0'"
            Dim sqlCmd As New SqlCommand(ls_SQL, sqlConn)
            Dim sqlRdr As SqlDataReader = sqlCmd.ExecuteReader()
...
#Region "Procedure"
    ...
    Public Shared Sub HideColumTanggal(ByVal pTanggal As DevExpress.Web.ASPxEditors.ASPxTimeEdit, ByVal pGrid As DevExpress.Web.ASPxGridView.ASPxGridView)
        If Month(pTanggal.Value) = "1" Or Month(pTanggal.Value) = "3" Or Month(pTanggal.Value) = "5" _
            Or Month(pTanggal.Value) = "7" Or Month(pTanggal.Value) = "8" Or Month(pTanggal.Value) = "10" _
            Or Month(pTanggal.Value) = "12" Then
            With pGrid.Columns
                .Item("28").Width = "70"
                .Item("29").Width = "70"
                .Item("30").Width = "70"
            ...
            End With
        End If
        If Month(pTanggal.Value) = "4" Or Month(pTanggal.Value) = "6" Or Month(pTanggal.Value) = "9" _
            Or Month(pTanggal.Value) = "11" Then
            With pGrid.Columns
                .Item("28").Width = "70"
                .Item("29").Width = "70"
                .Item("30").Width = "70"
            ...
            End With
        End If
        If Month(pTanggal.Value) = "2" Then
            If Year(pTanggal.Value) Mod 4 = 0 Then
                With pGrid.Columns
                    .Item("28").Width = "70"
                    .Item("29").Width = "70"
                    .Item("30").Width = "0"
    ...
    Public Shared Sub HideColumTanggal1(ByVal pTanggal As Date, ByVal pGrid As DevExpress.Web.ASPxGridView.ASPxGridView)
        If Month(pTanggal) = "1" Or Month(pTanggal) = "3" Or Month(pTanggal) = "5" _
            Or Month(pTanggal) = "7" Or Month(pTanggal) = "8" Or Month(pTanggal) = "10" _
            Or Month(pTanggal) = "12" Then
            With pGrid.Columns
                .Item("28").Width = "60"
                .Item("29").Width = "60"
                .Item("30").Width = "60"
            ...
            End With
        End If
        If Month(pTanggal) = "4" Or Month(pTanggal) = "6" Or Month(pTanggal) = "9" _
            Or Month(pTanggal) = "11" Then
            With pGrid.Columns
                .Item("28").Width = "60"
                .Item("29").Width = "60"
                .Item("30").Width = "60"
            ...
            End With
        End If
        If Month(pTanggal) = "2" Then
            If Year(pTanggal) Mod 4 = 0 Then
                With pGrid.Columns
                    .Item("28").Width = "60"
                    .Item("29").Width = "60"
                    .Item("30").Width = "0"
