...
#Region "FORM EVENTS"
    ...
    Private Sub grid_CellEditorInitialize(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridView.ASPxGridViewEditorEventArgs) Handles grid.CellEditorInitialize
        If (e.Column.FieldName = "DetailPage" Or e.Column.FieldName = "RevisePage" Or e.Column.FieldName = "Period" _
            Or e.Column.FieldName = "PONo" Or e.Column.FieldName = "CommercialCls" Or e.Column.FieldName = "ShipCls" Or e.Column.FieldName = "CurrAff" _
    ...
    Private Sub btnADD_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnADD.Click
        Session("M01Url") = "~/PurchaseOrderRevision/PORevList.aspx"
        Response.Redirect("~/PurchaseOrderRevision/PORevEntry.aspx")
    End Sub
...
#Region "PROCEDURE"
    Private Sub bindData()
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            ls_SQL = ls_SQL + " 	case ISNULL(a.EntryDate,0) when 0 then 0 else 1 end POStatus1, " & vbCrLf & _
                              ...
                              " 	case ISNULL(a.FinalApproveDate,0) when 0 then 0 else 1 end POStatus8 " & vbCrLf & _
                              " from POrev_Master a " & vbCrLf & _
                              " inner join POrev_Detail b on a.PONo = b.PONo and a.AffiliateID = b.AffiliateID and a.POReVNo = b.PORevNo and a.SupplierID = b.SupplierID" & vbCrLf & _
    ...
    Private Sub up_GridLoadWhenEventChange()
        ...
        Using sqlConn As New SqlConnection(clsGlobal.ConnectionString)
            ...
            ls_SQL = " select top 0  '' DetailPage, '' as PORevNo, '' as POMarking ,'' Period, ''PONo, ''CommercialCls, ''ShipCls, ''CurrAff, ''AmountAff, '' EntryDate, ''EntryUser, '' POStatus1, ''POStatus2, ''POStatus3, ''POStatus4, ''POStatus5, ''POStatus6, ''POStatus7, ''POStatus8"
