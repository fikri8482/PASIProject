<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="PORevFinalApprovalList.aspx.vb" Inherits="AffiliateSystem.PORevFinalApprovalList" %>
...
<script type="text/javascript">
    ...
    function OnBatchEditStartEditing(s, e) {
        ...
        if (currentColumnName == "DetailPage" || currentColumnName == "PORevNo" || currentColumnName == "Period" || currentColumnName == "PONo" || currentColumnName == "CommercialCls"
                            ...
                            <table id="Table1">
                                <tr>
                                            ...
                                            <tr>
                                                <td align="left" valign="middle" height="25px" width="100px">
                                                    <dx:ASPxTimeEdit ID="dtPeriodFrom" runat="server" ClientInstanceName="dtPeriodFrom" 
                                                        ...
                                                        EditFormatString="MMM yyyy" Font-Names="Tahoma" Font-Size="8pt" Width="100px">
                                    ...
                                    <td align="left" valign="middle" height="25PX" width="130PX">
                                        <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text="AFF. FINAL APPROVAL"
                                            Font-Names="Tahoma" Font-Size="8pt">
                                        </dx:ASPxLabel>
                                    </td>
                                    <td align="left" valign="middle" height="25px" width="170px">
                                        <table>
                                            <tr>
                                                <td>
                                ...
                                <tr>
                                    ...
                                    <td align="left" valign="middle" height="25px" width="203px">
                                        <dx:ASPxComboBox ID="cboPONoRev" runat="server" 
                                            ClientInstanceName="cboPONoRev" Width="100%"
                                            Font-Size="8pt" 
                                    ...
                                    <td style="width:25px;"></td>
                                    <td align="left" valign="middle" height="25px" width="130px">
                                        <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="COMMERCIAL"
                                            Font-Names="Tahoma" Font-Size="8pt">
                                        </dx:ASPxLabel>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td style="width:25px;"></td>
                                    <td align="left" valign="middle" height="25px" width="130px"></td>
                                    <td align="left" valign="middle" style="height:25px; width:170px;">
                                        <table style="width:100%;">
                                            <tr>
        ...
        <tr>
            <td colspan="8" align="left" valign="top" height="220">
                ...
                <dx:ASPxGridView ID="grid" runat="server" Width="100%"
                    Font-Names="Tahoma" KeyFieldName="Period;PONo;PORevNo;SupplierID"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="2" Caption="PO REVISION NO." FieldName="PORevNo" Width="220px"
                            HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="3" Caption="PO MARKING" FieldName="POMarking" Width="220px"
                            HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="4" Caption="COMMERCIAL" FieldName="CommercialCls"
                            Width="95px" HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="5" Caption="SHIP BY" FieldName="ShipCls"
                            Width="100px" HeaderStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="8" Caption="CREATED DATE" FieldName="EntryDate"
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="9" Caption="CREATED BY" FieldName="EntryUser"
                            HeaderStyle-HorizontalAlign="Center" Width="145px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewBandColumn Caption="PO STATUS" VisibleIndex="10">
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn VisibleIndex="15" Caption="SupplierID" 
                                    FieldName="SupplierID" HeaderStyle-HorizontalAlign="Center" Visible="False">
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                </dx:GridViewDataTextColumn>
                            </Columns>
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        </dx:GridViewBandColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="16" Caption="Remarks" FieldName="Remarks"
                            HeaderStyle-HorizontalAlign="Center" Width="0px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="17" Caption="DeliveryByPASICls" FieldName="DeliveryByPASICls"
                            HeaderStyle-HorizontalAlign="Center" Width="0px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
