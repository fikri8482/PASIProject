<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="POFinalApprovalList.aspx.vb" Inherits="AffiliateSystem.POFinalApprovalList" %>
                        ...
                        <td colspan="8" height="30">
                            <table id="Table1">
                                <tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <dx:ASPxTimeEdit ID="dtPeriodFrom" runat="server" ClientInstanceName="dtPeriodFrom"
                                                        ...
                                                        EditFormatString="MMM yyyy" Font-Names="Tahoma" Font-Size="8pt" Width="130px">
                                    ...
                                    <td align="left" valign="middle" style="height:25px; width:80px;">
                                ...
                                <tr>
                                    <td style="width:5px;"></td>
                                    <td align="left" valign="middle" height="25px" width="130px">
                                        <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="AFF. FINAL APPROVAL"
                                            Font-Names="Tahoma" Font-Size="8pt">
                                        </dx:ASPxLabel>
                                    </td>
                                    <td align="left" valign="middle" height="25px" width="203px">
        ...
        <tr>
            <td colspan="8" align="left" valign="top" height="220">
                ...
                <dx:ASPxGridView ID="grid" runat="server" Width="100%"
                    Font-Names="Tahoma" KeyFieldName="Period;PONo;POMarking;SupplierID"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="CREATED DATE" FieldName="EntryDate" 
                        ...
                        <dx:GridViewDataTextColumn Caption="CREATED BY" FieldName="EntryUser" 
                            VisibleIndex="10" Width="145px" CellStyle-HorizontalAlign="Center">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
