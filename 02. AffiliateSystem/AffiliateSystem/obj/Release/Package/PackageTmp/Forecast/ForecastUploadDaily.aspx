<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="ForecastUploadDaily.aspx.vb" Inherits="AffiliateSystem.ForecastUploadDaily" %>
            ...
            <td colspan="3" align="left" valign="top" height="220">
                <dx:ASPxGridView ID="grid" runat="server" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="1" Caption="PERIOD" FieldName="Period" 
                            Width="70px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="5" Caption="ForecastQty1" 
                            FieldName="ForecastQty1" Width="120px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="6" Caption="ForecastQty2" 
                            FieldName="ForecastQty2" Width="120px">
                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                            <CellStyle Font-Names="Tahoma" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="7" Caption="ForecastQty3" 
                            FieldName="ForecastQty3" Width="120px" HeaderStyle-HorizontalAlign="Center">
                            <PropertiesTextEdit DisplayFormatString="{0:n0}">
                            </PropertiesTextEdit>
                            <CellStyle Font-Names="Verdana" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="8" Caption="ForecastQty4" 
                            FieldName="ForecastQty4" Width="120px" HeaderStyle-HorizontalAlign="Center">
                            <PropertiesTextEdit DisplayFormatString="{0:n0}">
                            </PropertiesTextEdit>
                            <CellStyle Font-Names="Verdana" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewBandColumn Caption="FIRM QTY" VisibleIndex="9">
                            <Columns>
                        ...
                        <dx:GridViewBandColumn Caption="COLOR CLS" VisibleIndex="10" >
                            <Columns>
                                <dx:GridViewDataTextColumn Caption="1" FieldName="C1" VisibleIndex="1" Width="50px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="2" FieldName="C2" VisibleIndex="2" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="3" FieldName="C3" VisibleIndex="3" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="4" FieldName="C4" VisibleIndex="4" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="5" FieldName="C5" VisibleIndex="5" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="6" FieldName="C6" VisibleIndex="6" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="7" FieldName="C7" VisibleIndex="7" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="8" FieldName="C8" VisibleIndex="8" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="9" FieldName="C9" VisibleIndex="9" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="10" FieldName="C10" VisibleIndex="10" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="11" FieldName="C11" VisibleIndex="11" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="12" FieldName="C12" VisibleIndex="12" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="13" FieldName="C13" VisibleIndex="13" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="14" FieldName="C14" VisibleIndex="14" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="15" FieldName="C15" VisibleIndex="15" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="16" FieldName="C16" VisibleIndex="16" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="17" FieldName="C17" VisibleIndex="17" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="18" FieldName="C18" VisibleIndex="18" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="19" FieldName="C19" VisibleIndex="19" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="20" FieldName="C20" VisibleIndex="20" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="21" FieldName="C21" VisibleIndex="21" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="22" FieldName="C22" VisibleIndex="22" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="23" FieldName="C23" VisibleIndex="23" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="24" FieldName="C24" VisibleIndex="24" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="25" FieldName="C25" VisibleIndex="25" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="26" FieldName="C26" VisibleIndex="26" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="27" FieldName="C27" VisibleIndex="27" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="28" FieldName="C28" VisibleIndex="28" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="29" FieldName="C29" VisibleIndex="29" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="30" FieldName="C30" VisibleIndex="30" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="31" FieldName="C31" VisibleIndex="31" Width="0px">
                                    <CellStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                            </Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="10" Caption="REMARKS" 
                            FieldName="remarks" Width="170px" HeaderStyle-HorizontalAlign="Center">                            
                            <CellStyle Font-Names="Verdana" Font-Size="8pt">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                    </Columns>
