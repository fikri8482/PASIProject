<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Login.aspx.vb" Inherits="AffiliateSystem.Login" %>
        ...
        <center>            
            <div id="LoginFrame" style="width:450px; height:200px; background-image:url(Images/LoginBackgroundNew.jpg);">
                <table id="LoginTitle" width="440px">
                    <tr>
                        <td align="left">
                            <dx:ASPxLabel ID="lblTitle" runat="server" Text="LOGIN AFFILIATE - PT. AUTOCOMP SYSTEMS INDONESIA" 
