<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="PORevFinalApproval.aspx.vb" Inherits="AffiliateSystem.PORevFinalApproval" %>
                        ...
                        <td colspan="8" height="20">
                            <table id="Table1">
                                    ...
                                    <td align="left" valign="middle" height="20px" width="180px">
                                        <dx:ASPxComboBox ID="cboPartNo" runat="server" 
                                            ...
                                            <ClientSideEvents SelectedIndexChanged="function(s, e) {
                                                grid.PerformCallback('kosong');                                                
                                                clear();                                                
                                                cboPartNoRev.PerformCallback(dtPeriodFrom.GetValue().toString() + '|' + cboPartNo.GetText());                                                
	                                            lblInfo.SetText('');                                                
                                            }" />
                                ...
                                <tr>
                                    <td style="width: 5px;"></td>
                                    <td align="left" valign="middle" height="20px" width="120px">
                                        <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="PO REVISION NO."
                                            Font-Names="Tahoma" Font-Size="8pt">
                                        </dx:ASPxLabel>
                                    </td>
                                    <td align="left" valign="middle" height="20px" width="180px">
                                        <dx:ASPxComboBox ID="cboPartNoRev" runat="server" 
                                            ClientInstanceName="cboPartNoRev" Width="100%"
                                            Font-Size="8pt" 
                                            Font-Names="Verdana" TextFormatString="{0}">
                                            <ClientSideEvents SelectedIndexChanged="function(s, e) {
                                                grid.PerformCallback('kosong');
                                                clear();
                                                ButtonPartNo.PerformCallback(cboPartNo.GetText() + '|' + cboPartNoRev.GetText());
	                                            lblInfo.SetText('');                                                
                                            }" />
                                            <LoadingPanelStyle ImageSpacing="5px">
                                            </LoadingPanelStyle>
                                    ...
                                    <td align="left" valign="middle" width="135px" class="style3">
                                    </td>                                
                                ...
                                <tr>
                                    ...
                                    <td align="left" valign="middle" width="180px" class="style3">
