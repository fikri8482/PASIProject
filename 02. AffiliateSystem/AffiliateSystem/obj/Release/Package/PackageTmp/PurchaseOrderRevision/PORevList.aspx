<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master" CodeBehind="PORevList.aspx.vb" Inherits="AffiliateSystem.PORevList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
                        ...
                        <td colspan="8" height="30">
                            <table id="Table1">
                                <tr>
                                    ...
                                    <td align="left" valign="middle" height="25px" width="180px">
                                        <table>
                                            <tr>
                                                <td>
                                ...
                                <tr>
                                    ...
                                    <td style="width:25px;"></td>
                                    <td align="left" valign="middle" height="25px" width="60px"></td>
                                    <td align="right" valign="middle" style="height:25px; width:180px;">
                                        <table style="width:100%;">
                                            <tr>
    ...
    <table style="width:100%;">
        <tr>
            ...
            <td valign="top" align="right" style="width: 50px;">    
                <dx:ASPxButton ID="btnADD" runat="server" Text="CREATE PO REVISION"
                    Font-Names="Tahoma" Width="85px" AutoPostBack="False" Font-Size="8pt">                               
                </dx:ASPxButton>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="8" align="left" valign="top" height="220">
                ...
                <dx:ASPxGridView ID="grid" runat="server" Width="100%"
                    Font-Names="Tahoma" KeyFieldName="Period;PONo;PORevNo;SupplierID;POMarking"
                    ...
                    <Columns>
                        <dx:GridViewDataTextColumn VisibleIndex="0" Caption=" " Width="50px" FieldName="DetailPage">
                            <DataItemTemplate>
                                <a id="clickElement" href="PORevEntry.aspx?id=<%#GetRowValue(Container)%>&t1=<%#GetAffiliateID(Container)%>&t2=<%#GetAffiliateName(Container)%>&t3=<%#GetPeriod(Container)%>&t4=<%#GetSupplierID(Container)%>&t5=<%#GetPORevNo(Container)%>&Session=~/PurchaseOrderRevision/PORevList.aspx">
                                    <%# "DETAIL"%></a>
                            </DataItemTemplate>
                        ...
                        <dx:GridViewDataTextColumn Caption="SUPPLIER ID" FieldName="SupplierID" 
