<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteContent.Master"
    CodeBehind="InvFromPASIDetail.aspx.vb" Inherits="AffiliateSystem.InvFromPASIDetail" %>
...
<MaskSettings ErrorText="Please input valid value !" Mask="<0..9999999999999g>"
                        ...
                        <dx:GridViewDataTextColumn Caption="NET WEIGHT" FieldName="netweight" 
                            Name="netweight" VisibleIndex="13" Width="100px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <CellStyle Font-Names="Verdana">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="GROSS WEIGHT" FieldName="grossweight" 
                            Name="grossweight" VisibleIndex="14" Width="100px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <CellStyle Font-Names="Verdana">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                    ...
                    <tr>
                        ...
                        <td align="right">
                            <dx1:ASPxButton ID="btnprint" runat="server" Width="90px" Font-Names="Tahoma" Font-Size="8pt"
                                Text="PRINT" ClientInstanceName="btnprint" AutoPostBack="False">
                            </dx1:ASPxButton>
                        </td>
                        <td align="right">
                            <dx1:ASPxButton ID="btnBC40" runat="server" Width="90px" Font-Names="Tahoma" Font-Size="8pt"
                                Text="BC 40" ClientInstanceName="btnBC40" AutoPostBack="False" Visible="False">
