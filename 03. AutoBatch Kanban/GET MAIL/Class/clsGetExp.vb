...
Public Class clsGetExp
    Shared Sub up_GetEmailExp(ByVal cfg As GlobalSetting.clsConfig,
                ...
                For i As Integer = countEmail To 1 Step -1
                    ...
                    Try
                        ...
                        For Each attachment As MessagePart In eAttachments
                            ...
                            Try
                                If Split(pAttachment, ".")(1) = "xlsx" Or Split(pAttachment, ".")(1) = "xls" Or Split(pAttachment, ".")(1) = "xlsm" Then
