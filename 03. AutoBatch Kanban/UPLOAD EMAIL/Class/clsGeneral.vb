...
Public Class clsGeneral
    ...
    Shared Function getQtyBox(ByVal GB As GlobalSetting.clsGlobal, ByVal pPartNo As String, ByVal pSupplierID As String, ByVal pAffiliateID As String) As String
        Dim ls_SQL As String = ""
        ls_SQL = "select QtyBox from MS_PartMapping where PartNo = '" & pPartNo & "' and AffiliateID = '" & pAffiliateID & "' and SupplierID = '" & pSupplierID & "'"
        Dim ds As New DataSet
        ds = GB.uf_GetDataSet(ls_SQL)

        If ds.Tables(0).Rows.Count > 0 Then
            Return Trim(ds.Tables(0).Rows(0)("QtyBox"))
        Else
            Return 0
        End If
    End Function

    Shared Function getQtyWeek(ByVal GB As GlobalSetting.clsGlobal, ByVal pPartNo As String, _
                              ByVal pSupplierID As String, ByVal pAffiliateID As String, _
                              ByVal pPONo As String, ByVal pOrderNo As String) As String
        Dim ls_SQL As String = ""
        ls_SQL = "select Week1 from PO_Detail_Export where PartNo = '" & pPartNo & "' " & vbCrLf & _
                 "               and AffiliateID = '" & pAffiliateID & "' and SupplierID = '" & pSupplierID & "'" & vbCrLf & _
                 "               and PONo = '" & pPONo & "' and OrderNo1 = '" & pOrderNo & "'"

        Dim ds As New DataSet
        ds = GB.uf_GetDataSet(ls_SQL)

        If ds.Tables(0).Rows.Count > 0 Then
            Return Trim(ds.Tables(0).Rows(0)("Week1"))
        Else
            Return 0
        End If
    End Function

    Shared Function getQtyDomestic(ByVal GB As GlobalSetting.clsGlobal, ByVal pPartNo As String, _
                              ByVal pSupplierID As String, ByVal pAffiliateID As String, _
                              ByVal pPONo As String) As String
        Dim ls_SQL As String = ""
        ls_SQL = "select POQty from PO_Detail where PartNo = '" & pPartNo & "' " & vbCrLf & _
                 "               and AffiliateID = '" & pAffiliateID & "' and SupplierID = '" & pSupplierID & "'" & vbCrLf & _
                 "               and PONo = '" & pPONo & "' "
        ...
        If ds.Tables(0).Rows.Count > 0 Then
            Return Trim(ds.Tables(0).Rows(0)("POQty"))
        Else
            Return 0
        End If
    End Function

    Shared Function getApproveQtyPO(ByVal GB As GlobalSetting.clsGlobal, ByVal pPONo As String, ByVal pOrderNo As String, ByVal pSupplierID As String, ByVal pAffiliateID As String, ByVal pPartNo As String) As String
        Dim ls_SQL As String = ""
        ls_SQL = "select Week1 from PO_Detail_Export where PONo = '" & pPONo & "' and OrderNo1 = '" & pOrderNo & "' and AffiliateID = '" & pAffiliateID & "' and SupplierID = '" & pSupplierID & "' and PartNo = '" & pPartNo & "'"
        Dim ds As New DataSet
        ds = GB.uf_GetDataSet(ls_SQL)
    ...
    Shared Function getEmergencyETD(ByVal GB As GlobalSetting.clsGlobal, ByVal pPONo As String, ByVal pOrderNo As String, ByVal pSupplierID As String, ByVal pAffiliateID As String) As Date
        Dim ls_SQL As String = ""
        ls_SQL = "select ETDVendor1 from PO_Master_Export where PONo = '" & pPONo & "' and OrderNo1 = '" & pOrderNo & "' and AffiliateID = '" & pAffiliateID & "' and SupplierID = '" & pSupplierID & "'"
        Dim ds As New DataSet
        ds = GB.uf_GetDataSet(ls_SQL)

        If ds.Tables(0).Rows.Count > 0 Then
            Return Trim(ds.Tables(0).Rows(0)("ETDVendor1"))
        Else
            Return Now
        End If
    End Function

    Shared Function AffiliateConsignee(ByVal GB As GlobalSetting.clsGlobal, ByVal ls_value As String) As String
        Dim ls_SQL As String = ""
        ls_SQL = "SELECT AffiliateID FROM dbo.MS_Affiliate WHERE ConsigneeCode ='" & ls_value & "'"
        Dim ds As New DataSet
        ds = GB.uf_GetDataSet(ls_SQL)

        If ds.Tables(0).Rows.Count > 0 Then
            Return Trim(ds.Tables(0).Rows(0)("AffiliateID"))
        Else
            Return ""
        End If
    End Function
    ...
    Shared Function getEmailAddressForwarder(ByVal GB As GlobalSetting.clsGlobal, ByVal pPASI As String, ByVal pFWD As String, _
                                    ByVal pEmailCC As String, ByVal pEmailTo As String, ByVal pEmailFrom As String, ByRef ErrMsg As String) As DataSet
        Dim ls_SQL As String = ""

        Try
            ls_SQL = " SELECT 'PASI' FLAG, " & pEmailCC & " AS EmailCC, " & pEmailTo & " AS EmailTO, " & pEmailFrom & " AS EmailFrom FROM MS_EmailPASI_EXPORT WHERE AffiliateID='" & Trim(pPASI) & "' " & vbCrLf & _
                    " UNION ALL " & vbCrLf & _
    ...
    Shared Function getEmailAddressSupplier(ByVal GB As GlobalSetting.clsGlobal, ByVal pPASI As String, ByVal pSupplier As String, _
                                    ByVal pEmailCC As String, ByVal pEmailTo As String, ByVal pEmailFrom As String, ByRef ErrMsg As String) As DataSet
        Dim ls_SQL As String = ""
        ...
        Try
            ls_SQL = " SELECT 'PASI' FLAG, " & pEmailCC & " AS EmailCC, " & pEmailTo & " AS EmailTO, " & pEmailFrom & " AS EmailFrom FROM MS_EmailPASI_EXPORT WHERE AffiliateID='" & Trim(pPASI) & "' " & vbCrLf & _
                    " UNION ALL " & vbCrLf & _
                    " SELECT 'SUPP' FLAG, " & pEmailCC & " AS EmailCC, " & pEmailTo & " AS EmailTO, " & pEmailFrom & " as EmailFrom FROM MS_EmailSupplier_Export WHERE SupplierID='" & Trim(pSupplier) & "'"
            Dim ds As New DataSet
            ds = GB.uf_GetDataSet(ls_SQL)
            Return ds
        Catch ex As Exception
    ...
    Shared Function getEmailAddressSupplierDOM(ByVal GB As GlobalSetting.clsGlobal, ByVal pPASI As String, ByVal pSupplier As String, _
                                    ByVal pEmailCC As String, ByVal pEmailTo As String, ByVal pEmailFrom As String, ByRef ErrMsg As String) As DataSet
        Dim ls_SQL As String = ""

        Try
            ls_SQL = " SELECT 'PASI' FLAG, " & pEmailCC & " AS EmailCC, " & pEmailTo & " AS EmailTO, " & pEmailFrom & " AS EmailFrom FROM MS_EmailPASI WHERE AffiliateID='" & Trim(pPASI) & "' " & vbCrLf & _
                    " UNION ALL " & vbCrLf & _
                    " SELECT 'SUPP' FLAG, " & pEmailCC & " AS EmailCC, " & pEmailTo & " AS EmailTO, " & pEmailFrom & " as EmailFrom FROM MS_EmailSupplier WHERE SupplierID='" & Trim(pSupplier) & "'"
            Dim ds As New DataSet
            ds = GB.uf_GetDataSet(ls_SQL)
            Return ds
        Catch ex As Exception
    ...
    Shared Function sendEmailExport(ByVal GB As GlobalSetting.clsGlobal, ByVal pFromEmail As String, ByVal pToEmail As String, ByVal pCCEmail As String, _
        ...
        Try
            ...
            Dim mailMessage As New Mail.MailMessage()
            mailMessage.From = New MailAddress(pFromEmail)
            'mailMessage.Bcc = "pasi.purchase@gmail.com"
            Dim pBCCEmail As String = "pasi.purchase@gmail.com"
