...
Public Class clsNotification
    'Public Const pub_ServerName As String = "localhost:5832"
    'Public Const pub_ServerName As String = "10.62.212.17/AffiliateSystem"
    'Public Const pub_ServerNamePASI As String = "10.62.212.17/PASISystem"
    Public Const pub_ServerName As String = "192.168.0.5/AffiliateSystem"
    Public Const pub_ServerNamePASI As String = "192.168.0.5/PASISystem"
    ...
    Public Shared Function GetNotification(ByVal pNotificationCode As String, Optional ByVal pUrl As String = "", _
                                     ...
                                     Optional ByVal pSuratJalanNo As String = "", Optional ByVal pPORevision As String = "", _
                                     Optional ByVal pPOMarking As String = "", Optional ByVal pShippingNo As String = "", Optional ByVal pErrorMessage As String = "") As String
        ...
        Using sqlConn As New SqlConnection(cfg.ConnectionString)
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                If IsDBNull(ds.Tables(0).Rows(0)("Line3")) Then
                    ...
                    ls_Cls(2) = ""
                Else
                    ls_Line(2) = ds.Tables(0).Rows(0)("Line3")
                ...
                If IsDBNull(ds.Tables(0).Rows(0)("Line4")) Then
                    ...
                    ls_Cls(3) = ""
                Else
                    ls_Line(3) = ds.Tables(0).Rows(0)("Line4")
                ...
                If IsDBNull(ds.Tables(0).Rows(0)("Line5")) Then
                    ...
                    ls_Cls(4) = ""
                Else
                    ls_Line(4) = ds.Tables(0).Rows(0)("Line5")
                ...
                If IsDBNull(ds.Tables(0).Rows(0)("Line6")) Then
                    ...
                    ls_Cls(5) = ""
                Else
                    ls_Line(5) = ds.Tables(0).Rows(0)("Line6")
                ...
                If IsDBNull(ds.Tables(0).Rows(0)("Line7")) Then
                    ...
                    ls_Cls(6) = ""
                Else
                    ls_Line(6) = ds.Tables(0).Rows(0)("Line7")
                ...
                If IsDBNull(ds.Tables(0).Rows(0)("Line8")) Then
                    ...
                    ls_Cls(7) = ""
                Else
                    ls_Line(7) = ds.Tables(0).Rows(0)("Line8")
            ...
            For xyz = 0 To 7
                If xyz = 0 Then
                    If ls_Cls(xyz) = "05" Then
                        ls_BodyMessage = ls_BodyMessage & ls_Line(xyz) & vbCrLf
                    End If
                Else
                    If ls_Cls(xyz) = "05" Then
                ...
                If ls_Cls(xyz) <> "05" Then
                    If ls_Cls(xyz) = "01" Then 'Affiliate PO NO
                        ls_BodyMessage = ls_BodyMessage & vbCrLf
                        ls_BodyMessage = ls_BodyMessage & "PO No: " & pPONo & vbCrLf
                        'ls_BodyMessage = ls_BodyMessage & "PO Marking: " & pPOMarking & vbCrLf

                        If pErrorMessage <> "" Then
                            ls_BodyMessage = ls_BodyMessage & vbCrLf
                            ls_BodyMessage = ls_BodyMessage & "Error Description: " & pErrorMessage & vbCrLf
                        End If
                    End If
                    If ls_Cls(xyz) = "02" Then 'Affiliate PO NO Revision
                        ls_BodyMessage = ls_BodyMessage & vbCrLf
                        ls_BodyMessage = ls_BodyMessage & "PO Rev No: " & pPORevision & vbCrLf
                    End If
                    If ls_Cls(xyz) = "03" Then 'Affiliate Kanban No
                        ls_BodyMessage = ls_BodyMessage & vbCrLf
                        ls_BodyMessage = ls_BodyMessage & "Kanba No: " & pKanban & vbCrLf
                    End If
                    If ls_Cls(xyz) = "04" Then 'Surat jalan
                        ls_BodyMessage = ls_BodyMessage & vbCrLf
                        ls_BodyMessage = ls_BodyMessage & "Surat Jalan No: " & pSuratJalanNo & vbCrLf
                    ...
                    End If
                    If ls_Cls(xyz) = "07" Then 'Surat jalan
                        ls_BodyMessage = ls_BodyMessage & vbCrLf
                        ls_BodyMessage = ls_BodyMessage & "Shipping Instruction No: " & pShippingNo & vbCrLf
